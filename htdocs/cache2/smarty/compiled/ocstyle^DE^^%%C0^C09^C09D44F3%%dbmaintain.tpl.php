...
<form action="dbmaintain.php" method="post">
    <table class="table">
        ...
        <tr><td colspan="2">Sucht und behebt Inkonsistenzen in Datenbanktabellen.</td></tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['procItem'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 hat <?php echo $this->_tpl_vars['count']; ?>
 Einträge korrigiert</td></tr>
        <?php endif; ?>
        ...
        <tr>
            <td width="150px">&nbsp;</td>
            <td>
                <input type="submit" name="ok" value="Ausführen" class="formbutton" onclick="submitbutton('ok')" />
            </td>
        </tr>
    </table>
</form>