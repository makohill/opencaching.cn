...
<?php if ($this->_tpl_vars['old_msie']): ?>
    ...
    function mapLoad()
    {
        document.getElementById(\'googlemap\').innerHTML =
            "<div style=\'position:relative; top:180px; left:10px\'><p>Votre Internet Explorer est trop ancienne pour afficher la carte. S\'il vous plaît mettre à jour au moins à la version 7, mieux 8.</p></div>";
    }
    -->'; ?>
...
var msSearchHint = "'; ?>
ville, nom de cache ou waypoint<?php echo '";
...
function updateCopyrights()
{
    ...
    if (newMapType == "OSM" || newMapType == "MQ" || newMapType == "OCM")
    {
        ...
        if (newMapType == "OCM")
            copyrightDiv.innerHTML = 'Carte de données &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a> and <a href="http://www.thunderforest.com/opencyclemap/" target="_blank">OpenCycleMap</a> contributors';
        else
            copyrightDiv.innerHTML = 'Carte de données &copy;<a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a> contributors';
        if (newMapType == "MQ")
            copyrightDiv.innerHTML += ', ' + 'tiles fournies par <a href="http://www.mapquest.com/" target="_blank">MapQuest</a>' + ' <img src="http://developer.mapquest.com/content/osm/mq_logo.png" />';
        <?php echo '
    }
    else
...
function data_mapreceive(data, responseCode)
{
    ...
    if (responseCode != 200)
    {
        var sMessage = \'Erreur : Impossible de télécharger le résultat de recherche (code d\\\'erreur HTTP %1).\';
    ...
    if (oXML.documentElement.getAttribute("available") +0 == 0)
    {
        ...
        {
            // alert(\'Erreur : Impossible de télécharger le résultat de recherche. Les données étaient pas disponibles sur le serveur.\');
            error_no_data(true);
        }
        return;
    }
...
function show_cachepopup_url(sURL, sWaypoint, bAllowZoomChange)
{
    ...
    ajaxLoad(sURL, function(data, responseCode) {
        ...
        if (!oCoords)
        {
            if (sWaypoint != \'\')
            {
                var sMessage = \'Waypoint %1 non trouvé&nbsp;!\';
...
function parseXML_GetHTML(xmlobject)
{
    ...
    sHtml += "<tr><td colspan='2' style='vertical-align:top;'>par <a href=" +apos+"viewprofile.php?userid="+encodeURI(nUserId)+apos+ " target='_blank'>" + xmlentities(sUsername) + "</a></td><td align='right'><a class='nooutline' href='articles.php?page=cacheinfo#difficulty' target='_blank'><img src=" + apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-"+String(nDifficulty*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Difficulté&nbsp;: " + String(nDifficulty) + " de 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /><img src=" +apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-"+String(nTerrain*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Terrain&nbsp;: " + String(nTerrain) + " de 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /></a></td></tr>";
...
<img src='resource2/ocstyle/images/misc/is_oconly_small.png' alt='OConly' title='OConly' /></a>" : "") + "</td></tr>";
    sHtml += "<tr><td colspan='2'>" + (bIsPublishdate == true ? "Publié le&nbsp;:" : "Affiché depuis&nbsp;:") + " " + xmlentities(sListedSince) + "</td></tr>";

    sAddHtml = "";
    if (bOwner==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/misc/16x16-home.png' alt='' /> Ce cache est le vôtre</td></tr>";

    if (bFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-found.png' alt='' /> Vous avez trouvé ce cache</td></tr>";

    if (bNotFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-dnf.png' alt='' /> Vous avez pas encore trouvé ce cache</td></tr>";

    if (bAttended==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/log/16x16-attended.png' alt='' /> Vous avez assisté à cet événement&nbsp;!</td></tr>";

    if (nGeoKreties>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/gk.png' alt='' /> Ce cache stocke une Geokrety</td></tr>";

    if (nTopRating>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/rating-star.gif' alt='' /> Ce cache a %1 recommandations</td></tr>".replace(/%1/, nTopRating);
    ...
    if (oWaypoints.length)
    {
        ...
        if (oWaypoints.length > 1)
            sMsg = "Le cache possède %1 %2additional waypoints%3.";
        else
            sMsg = "Le cache possède un %2additional waypoint%3.";
...
function tmd_show(number)
{
    ...
    var sMessage = \'Il y a %1 géocaches dans la zone sélectionnée correspondant à des options de filtre. S\\\'il vous plaît faire un zoom pour afficher les caches.\';
...
function download_gpx()
{
    ...
    {
        alert('; ?>
"Entre 1 et 500 caches doivent être affichés pour le téléchargement."<?php echo ');
        return;
    }
...
function mapsearch_click()
{
    ...
    {
        alert(\'Saisissez un texte de recherche, s\\\'il vous plaît&nbsp;!\');
        return;
    }
...
<?php if ($this->_tpl_vars['opt']['template']['locale'] == 'DE'): ?>
    ...
    moGeocoder.geocode( { \'address\': sSearchText },
        function(results, status)
        {
            ...
            {
                var oTempOption = new Option("Lieux trouvés via Google :", -1);
            ...
            ajaxLoad(msURLMapPHP + "?mode=" + searchpar,
                function(data, responseCode) {
                    ...
                    if (caches.length>0)
                    {
                        var oTempOption = new Option("Géocaches trouvées, d\\\'abord la plus proche :", -1);
                        oTempOption.style.color = "gray";
                        moSearchList.options[moSearchList.length] = oTempOption;
                        ...
                        {
                            var item = new Option("     '; ?>
Quelques autres articles trouvés ...<?php echo '", -1);
                            item.style.marginLeft = "20px";
                    ...
                    if (moSearchList.length==0)
                    {
                        mapselectlist_hide();
                        alert("\'" + sSearchText + "\' '; ?>
n\'a pas été trouvée (avec les paramètres sélectionnés)<?php echo '");
                        return;
                    }
...
function filter_changed()
{
    if (!bFilterChanged)
    {
        ...
        if (heading.style.color != "#f88c00")
        {
            ...
            heading.innerHTML = "'; ?>
Carte est en cours de mise à jour<?php echo ' ...";
...
function save_filter()
{
    ...
    alert("Les paramètres de filtre actuels sont enregistré.");
    <?php echo '
}
...
').style.display = sShow;
    ...
    tas.innerHTML = (bShow ? "Moins" : "Montre tout");
    if (bFullscreen)
...
<div id="<?php if ($this->_tpl_vars['bFullscreen']): ?>fullmap<?php else: ?>smallmap<?php endif; ?>" class="mapframe">
    ...
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
            ...
            <div id="mapstat_caches" class="mapstat_fullscreen" style="z-index:5">Caches affichés : <span id="statCachesCount">0</span><span id="statLoadTime" style="display:none">0</span></div>
...
/images/misc/hint.gif" border="0" width="15" height="11" align="middle" />
                L\'affichage de la carte avec Microsoft Internet Explorer est lente et limité à <?php echo $this->_tpl_vars['maxrecords']; ?>
 géocaches. Utiliser un autre navigateur pour de meilleures performances.
            </p>
        <?php endif; ?>
    <?php endif; ?>
            ...
            <tr>
                <?php if ($this->_tpl_vars['bFullscreen']): ?>
                    ...
                    <td rowspan="2" class="maplogin">
                        <?php if ($this->_tpl_vars['username'] != ""): ?>Connecté en tant que<br /><a href="myhome.php"><b><?php echo $this->_tpl_vars['username']; ?>
...
<?php endif; ?>"><img src="resource2/ocstyle/images/action/15x13-logout.png" style="margin-bottom:2px" alt="Déconnexion" title="Déconnexion" /></a><?php else: ?><a href="login.php?target=map2.php%3Fmode%3Dfullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>%26queryid%3D<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>">Connexion...</a><?php endif; ?>
                    </td>
                    <td rowspan="2">&nbsp;&nbsp;</td>
                <?php endif; ?>
...
/images/misc/32x32-home.png" alt="Aller aux coordonnées de la maison" title="Aller aux coordonnées de la maison" /></a></td>
                <?php endif; ?>
...
/images/map/35x35-gpx-download.png" style="margin-left:5px; margin-right:5px" height="35" width="35" alt="Télécharger le fichier GPX (max. 500 caches)" title="Télécharger le fichier GPX (max. 500 caches)" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="showPermlinkBox_click()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-star.png" style="margin-left:3px; margin-right:1px" height="35" width="35" alt="Afficher un lien vers cette carte" title="Afficher un lien vers cette carte" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="toggle_settings()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-configure.png" class="mapbutton" style="margin-left:0px; margin-right:2px" height="35" width="35" alt="Paramètres" title="Paramètres" /></a></td>
...
/images/map/35x35-normalscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="Passer à petite carte" title="Passer à petite carte" /></a>
                    <?php else: ?>
                        <a class="nooutline" href="map2.php?mode=fullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>&queryid=<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-fullscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="Passer en plein écran" title="Passer en plein écran" /></a>
                    <?php endif; ?>
                </td>
        ...
        <table>
            <tr><td><img src="resource2/ocstyle/images/viewcache/link.png" alt="" height="16" width="16" /> Lien vers cette carte&nbsp;:</td><td align="right"><a href="javascript:permalinkbox_hide()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></td></tr>
            <tr><td><input id="permalink_text" type="text" value="" size="55"/></td></tr>
            <tr id="permalink_addFavorites"><td align="right"><input type="button" value="Ajouter aux Favoris ..." onclick="addFavorites_click()" /></td></tr>
        </table>
    </div>
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
        </div></div>            <?php endif; ?>
    ...
    <?php endif; ?>
            ...
            <div class="maploading">Chargement de la carte ...</div>
...
<?php endif; ?>" method="post" style="display:inline;">
                    ...
                    <table>
                        <tr><td><span style="font-size:1.2em; font-weight:bold">Paramètres</strong></td><td style="text-align:right"><a href="javascript:toggle_settings()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></tr>
                        <tr><td>L'option de menu «&nbsp;carte&nbsp;» affiches&nbsp;:</td><td><select name="opt_menumap"><option id="opt_menumap0" value="0">Petite carte</option><option id="opt_menumap1" value="1">Carte en plein écran</option></select></td></tr>
                        <tr><td>Voir la carte d'aperçu&nbsp;:</td><td><input type="checkbox" id="opt_overview" name="opt_overview" value="1" /></td></tr>
                        <tr><td>Maximum de caches sur la carte<br />(<?php echo $this->_tpl_vars['min_maxrecords']; ?>
-<?php echo $this->_tpl_vars['max_maxrecords']; ?>
, 0=automatique)&nbsp;:</td><td><input type="text" id="opt_maxcaches" name="opt_maxcaches" size="6" /></td></tr>
                        <?php if ($this->_tpl_vars['msie']): ?>
...
/images/misc/hint.gif" alt="" />
 ...
 caches peuvent être affichés avec Microsoft Internet Explorer.
                            </td></tr>
                        <?php endif; ?>
                        <tr><td>Icônes de cache&nbsp;:</td><td><select name="opt_cacheicons"><option id="opt_cacheicons1" value="1">OC classique<option id="opt_cacheicons2" value="2">Style OKAPI</option></select></td></tr>
                        <tr><td>Afficher <?php echo $this->_tpl_vars['help_previewpics']; ?>
 des images d'apercu</a><br />(% de la superficie, 0=off)&nbsp;:</td><td><input type="text" id="opt_pictures" name="opt_pictures" size="2" maxlength="2" /></td></tr>
                        <tr><td colspan="2"><?php if ($this->_tpl_vars['login']['userid'] > 0): ?><input type="button" class="formbutton" value="Annuler" onclick="toggle_settings()"/>&nbsp; <input type="submit" name="submitsettings" class="formbutton" value="OK" onclick="submitbutton('submitsettings')" /><?php else: ?><em>Vous devez être connecté pour modifier les paramètres de la carte.</em><?php endif; ?></td></tr>
                    </table>
                </form>
            </div>
...
/images/misc/32x32-search.png" style="padding:2px" alt="Options de recherche" title="Options de recherche" /></a>
            </div>
        <?php endif; ?>
...
/images/map/32x32-left.png" /></a>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td id="filterboxtitle" class="content-title-noshade-size1">Afficher seulement les géocaches avec les propriétés suivantes&nbsp;:</td>
    ...
    <?php else: ?>
        ...
        <div style="width:770px;text-align:right;"><span id="mapstat_caches">Caches affichés : <span id="statCachesCount">0</span></span>, Temps de chargement : <span id="statLoadTime">0</span> Sec.</div>
        <div style="<?php if ($this->_tpl_vars['queryid'] > 0): ?>display:none<?php endif; ?>">
        <p id="filterboxtitle" class="content-title-noshade-size1">Afficher seulement les géocaches avec les propriétés suivantes&nbsp;:</p>
        ...
        <tr>
            <td class="mapfilter pad10" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>600<?php else: ?>752<?php endif; ?>">
                <table style="width:100%">
                    <tr>
                        <td>
                            <strong>Nom&nbsp;:</strong>&nbsp; <input type="text" id="cachename" name="cachename" value="" onkeyup="filter_changed()" onchange="filter_changed()" class="input200" /></td>
                        </td>
                        <td style="text-align:right">
                            <input type="button" name="resetfilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Réinitialiser&nbsp;&nbsp;" onclick="reset_filter()" />&nbsp;
                            <input type="button" name="savefilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Sauvegarder&nbsp;&nbsp;" onclick="save_filter()" />&nbsp;
                        </td>
                    </tr>
                </table>
            </td>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheTypeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic mft_withcheckbox"><input id="all_cachesizes" type="checkbox" checked="checked" onchange="allsizes_changed()" /> <label for="all_cachesizes">Boîte</label></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <?php $_from = $this->_tpl_vars['aCacheSize']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheSizeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic">Cacher</td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userowner" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Mon propriétaire</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userfound" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>mes trouvailles</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                    ...
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_geokrets">sans Geokrets</label>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table>
                    <tr>
                        <td colspan="2" class="mapfiltertopic">Notation</td>
                    <tr><td colspan="2"><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    </tr>
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Difficulté&nbsp;:</td>
        ...
        <tr>
            <td id="attribcell" valign="top" class="mapfilter pad10" style="padding-bottom:2px" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>675<?php else: ?>752<?php endif; ?>">
                <table>
                    <tr><td class="mapfiltertopic">Attribute &nbsp; <span class="mapfiltertopic_add">[<a id="toggle_attribselection" class="jslink" onclick='toggle_attribselection(true)'>Moins</a>]</span></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td>
...
/images/attributes/safari.png" title="Liste de caches safari" /></a>
        </div>
    <?php endif; ?>
