...
/images/misc/32x32-home.png" border="0" width="32px" height="32px" style="margin-right: 10px;" />
    Hello <?php echo $this->_tpl_vars['login']['username']; ?>
...
/images/description/22x22-logs.png" width="22" height="22"  style="margin-right: 10px;" />&nbsp;
            Finds: <?php echo $this->_tpl_vars['found']; ?>
 &nbsp;
...
&amp;searchbyfinder=&amp;f_inactive=0&amp;logtype=0&amp;calledbysearch=0">Geocaches logged</a>]</span><?php endif; ?>
        ...
        <p style="line-height: 1.6em;"><b>Your latest log entries<?php if ($this->_tpl_vars['morelogs']): ?> </b>(<a class="systemlink" href="ownlogs.php">more</a>)<span></span>:<?php else: ?><span></span>:</b><?php endif; ?></p>
...
unset($_smarty_tpl_vars);
 ?>
                    by <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['logItem']['userid']; ?>
...
/images/misc/32x32-pictures.gif" width="24" height="24"  style="margin-right: 10px;" />&nbsp;
 ...
 &nbsp;
        <?php if (count($this->_tpl_vars['pictures']) > 0 && ! $this->_tpl_vars['allpics']): ?><span class="content-title-link">[<a href="myhome.php?allpics=1">Show all</a>]</span><?php endif; ?>
    </p>
</div>
...
/images/cacheicon/22x20-traditional.png" width="22" height="20"  style="margin-right: 10px;" />&nbsp;
            Geocaches hidden: <?php echo $this->_tpl_vars['hidden']; ?>
 &nbsp;
...
&amp;searchbyowner=&amp;f_inactive=1&calledbysearch=0">... only active caches</a>]<?php endif; ?></span><?php endif; ?>
    ...
    <table class="table" style="max-width:97%">
        <?php if (count($this->_tpl_vars['caches']) == 0): ?>
            <tr><td colspan="4"><p style="margin-bottom:24px">No geocaches hidden </p></td></tr>
        <?php else: ?>
...
?>
            ...
            <tr>
                <td colspan="4"><b><span style="line-height:2em">Your geocaches hidden</b><span id="toggle_archived_option" style="display:none"><?php if ($this->_tpl_vars['archived'] > 0): ?> (<a href="javascript:toggle_archived()" style="outline:none"><span id="hide_archived">hide archived</span><span id="show_archived" style="display:none">show archived</span></a>)<?php endif; ?></span><span></span>:</span></td>
...
/images/log/16x16-found.png" alt="Found" title="Found"  /></td>
                <td style="text-align:left"><span style="line-height:2em"><b>Last logs</b></span></td>
            </tr>
            <?php $_from = $this->_tpl_vars['caches']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cacheItem']):
?>
...
unset($_smarty_tpl_vars);
 ?></nobr></td>
        ...
        <?php endif; ?>
            ...
            <tr>
                <td colspan="4">
                    <p style="margin-top:16px"><b>Your pending geocaches:</b></p>
                </td>
            </tr>
