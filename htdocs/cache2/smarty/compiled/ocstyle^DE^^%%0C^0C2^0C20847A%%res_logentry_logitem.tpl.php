...
/images/log/16x16-moved.png" width="16" height="16" />
        <?php if ($this->_tpl_vars['logItem']['type']): ?>Neue Koordinaten:<?php else: ?>Ursprüngliche Koordinaten:<?php endif; ?>&nbsp;
 ...
 <?php echo $this->_tpl_vars['logItem']['newcoord']['lon']; ?>
        ...
        verlegt um <?php echo $this->_tpl_vars['logItem']['movedbym']; ?>
 Meter<?php elseif ($this->_tpl_vars['logItem']['movedbykm']): ?>,
        verlegt um <?php echo $this->_tpl_vars['logItem']['movedbykm']; ?>
 km<?php endif; ?>
    </p>
<?php endif; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['logItem']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 hat den Geocache gesperrt
        <?php elseif ($this->_tpl_vars['logItem']['type'] == 14): ?>
            <?php echo $this->_smarty_vars['capture']['username']; ?>
 hat den Geocache gesperrt und versteckt
        <?php else: ?>
            <?php echo $this->_smarty_vars['capture']['username']; ?>
...
">Bearbeiten</a>]
                [<a href="javascript:if(confirm('Willst du dieses Bild wirklich löschen?'))location.href='picture.php?action=delete&uuid=<?php echo ((is_array($_tmp=$this->_tpl_vars['pictureItem']['uuid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
'">Löschen</a>]
...
">nach oben</a>]<?php endif; ?>
        ...
        <?php if ($this->_tpl_vars['logItem']['late_modified']): ?>
            ...
            <small><em>zuletzt geändert am <?php echo ((is_array($_tmp=$this->_tpl_vars['logItem']['entry_last_modified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</em></small></p>
        <?php endif; ?>

        <?php if ($this->_tpl_vars['logItem']['deleted_by_name'] != ""): ?>
            <p><span style="color:red">gelöscht von <?php echo $this->_tpl_vars['logItem']['deleted_by_name']; ?>
,
