...
" title="Contactar"><?php echo $this->_tpl_vars['opt']['mail']['contact']; ?>
</a>.</p>
                <p>&nbsp;</p>
                <p class="center"><a class="links" href="/articles.php?page=impressum" title="Información Legal">Información Legal</a> - <a class="links" href="/articles.php?page=verein" title="Opencaching e.V.">Opencaching Deutschland e.V.</a> - <a class="links" href="/articles.php?page=contact" title="Contactar">Contactar</a></p>
