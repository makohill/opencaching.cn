...
<div class="nav4">
    <ul>
        <li class="group noicon"><a href="newcaches.php">Tous les caches</a></li>
        <li class="group noicon"><a href="newcaches.php?country=<?php echo $this->_tpl_vars['userCountryCode']; ?>
">Caches à <?php echo $this->_tpl_vars['userCountryName']; ?>
</a></li>
        <li class="group noicon selected"><a href="newcachesrest.php">Nouveaux caches sans <?php echo $this->_tpl_vars['countryName']; ?>
</a></li>
    </ul>
</div>
<p style="clear:both;" >
