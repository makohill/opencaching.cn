...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
            ...
            Benutzer, die <?php echo $this->_smarty_vars['capture']['cache']; ?>
 von <?php echo $this->_smarty_vars['capture']['user']; ?>
 empfahlen, haben auch folgende Geocaches empfohlen:
        </td>
    </tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheRatingsItem']['cacheusername'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <?php endforeach; else: ?>
                    <tr><td colspan="3">Es können keine Empfehlungen gegeben werden, da keine weiteren Bewertungen vorliegen.</td></tr>
