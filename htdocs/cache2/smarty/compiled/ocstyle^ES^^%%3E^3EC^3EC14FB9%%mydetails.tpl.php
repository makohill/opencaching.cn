...
<table class="table">
    <tr>
        <td colspan="3">
            <span class="boldtext">La siguiente información detallada se almacena en su perfil de usuario:</span>
        </td>
    </tr>
    ...
    <?php if ($this->_tpl_vars['error'] == true || $this->_tpl_vars['errorlen'] == true): ?>
        <tr>
            <td class="errormsg" colspan="3">
                Error al guardar.<br />
                <?php if ($this->_tpl_vars['error'] == true): ?>Los caracteres no validos se encuentran en<?php echo ((is_array($_tmp=$this->_tpl_vars['errormsg'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /><?php endif; ?>
                <?php if ($this->_tpl_vars['errorlen'] == true): ?>Contenido del campo demasiado largo.<?php echo ((is_array($_tmp=$this->_tpl_vars['errormsglen'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /><?php endif; ?>
                Los datos originales fueron recuperados.
            </td>
        </tr>
    <?php endif; ?>
...
" value="1"<?php if ($this->_tpl_vars['useropt']['option_visible'] == 1): ?> checked="checked"<?php endif; ?> class="checkbox" /> mostrar
                    <?php endif; ?>
                <?php else: ?>
                    <?php if ($this->_tpl_vars['useropt']['internal_use'] != 1): ?>
    ...
    <?php endforeach; else: ?>
        <tr>
            <td colspan="3">No se encontró información en los detalles del usuario.</td>
        </tr>
...
<div style="clear:both"></div></div><?php endif; ?>
            ...
            <tr>
                <td class="header-small" colspan="3">
                    <input type="submit" name="changetext" value="Cambiar" class="formbutton" onclick="flashbutton('changetext')" />
                </td>
            </tr>
        </table>
    </form>
