...
.gif" alt="Event cache" border="0" width="22" height="22" align="left" style="margin-right: 5px;" /><?php else: ?><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?> door <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['newCache']['userid']; ?>
