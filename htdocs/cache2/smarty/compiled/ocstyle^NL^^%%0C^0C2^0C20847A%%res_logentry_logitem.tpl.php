...
/images/log/16x16-moved.png" width="16" height="16" />
        <?php if ($this->_tpl_vars['logItem']['type']): ?>New coordinates:<?php else: ?>Original coordinates:<?php endif; ?>&nbsp;
 ...
 <?php echo $this->_tpl_vars['logItem']['newcoord']['lon']; ?>
        ...
        moved by <?php echo $this->_tpl_vars['logItem']['movedbym']; ?>
 meters<?php elseif ($this->_tpl_vars['logItem']['movedbykm']): ?>,
        moved by <?php echo $this->_tpl_vars['logItem']['movedbykm']; ?>
 km<?php endif; ?>
    </p>
<?php endif; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['logItem']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 heeft een notitie geschreven
        <?php elseif ($this->_tpl_vars['logItem']['type'] == 7): ?>
            <?php echo $this->_smarty_vars['capture']['username']; ?>
 heeft het event bezocht
        <?php elseif ($this->_tpl_vars['logItem']['type'] == 8): ?>
            <?php echo $this->_smarty_vars['capture']['username']; ?>
 wil het event bezoeken
 ...
 has locked the cache
        <?php elseif ($this->_tpl_vars['logItem']['type'] == 14): ?>
            <?php echo $this->_smarty_vars['capture']['username']; ?>
 has locked and hidden the cache
        <?php else: ?>
            <?php echo $this->_smarty_vars['capture']['username']; ?>
...
?>
            <?php if (($this->_foreach['pictures']['iteration'] <= 1)): ?>
                <b>Afbeeldingen voor deze log:</b><br />
            <?php endif; ?>
...
">Bewerken</a>]
                [<a href="javascript:if(confirm('Do you really want to delete this picture?'))location.href='picture.php?action=delete&uuid=<?php echo ((is_array($_tmp=$this->_tpl_vars['pictureItem']['uuid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
'">Verwijderen</a>]
...
">move up</a>]<?php endif; ?>
        ...
        <?php if ($this->_tpl_vars['logItem']['late_modified']): ?>
            ...
            <small><em>last modified on <?php echo ((is_array($_tmp=$this->_tpl_vars['logItem']['entry_last_modified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</em></small></p>
        <?php endif; ?>

        <?php if ($this->_tpl_vars['logItem']['deleted_by_name'] != ""): ?>
            <p><span style="color:red">Deleted by <?php echo $this->_tpl_vars['logItem']['deleted_by_name']; ?>
,
