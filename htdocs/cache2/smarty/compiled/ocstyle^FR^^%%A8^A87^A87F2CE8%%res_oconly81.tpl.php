...
<?php else: ?><a class="systemlink" href="oconly81.php"><?php endif; ?>OConly-81</a>&nbsp;&nbsp;&nbsp;</nobr><?php endif; ?></th>
        <th class="h1 nodatacell" colspan="11" style="line-height:1.8em">Terrain</th>
    </tr>
    <tr>
        <td></td>
...
?>
        <tr>
            <?php if (($this->_foreach['difficulty']['iteration'] <= 1)): ?>
                <th class="h1" rowspan="9">Difficulté&nbsp;&nbsp;&nbsp;</th>
            <?php endif; ?>
...
<?php endif; ?></th>
    ...
    <?php if ($this->_tpl_vars['userid'] > 0): ?>
        <tr>
            <td colspan="12" style="padding-top:0.5em"><p>L'utilisateur a trouvé <b><?php echo $this->_tpl_vars['matrixfound']; ?>
</b> de <b>81</b> théoriquement des combinaisons terrain / difficulté possibles.</p></td>
        </tr>
    <?php endif; ?>
</table>