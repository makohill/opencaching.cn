...
<?php $this->_cache_serials['/var/www/html/bin/../htdocs/cache2/smarty/compiled//ocstyle^FR^^%%0A^0A0^0A0360A0%%sys_main.tpl.inc'] = 'a9d37a1c20626755c41c5ca46074fc90'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        <div id="overall">
            <div id="langstripe">
                    ...
                    <tr>
                        ...
                        <?php endif; ?>
                        <td width="100%">
                            <?php if ($this->caching && !$this->_cache_including): echo '{nocache:a9d37a1c20626755c41c5ca46074fc90#0}'; endif;$this->_tag_stack[] = array('nocache', array()); $_block_repeat=true;smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                                &nbsp;
                                <?php if ($this->_tpl_vars['login']['userid'] == 0): ?>
                                    <b><form action="<?php echo $this->_tpl_vars['opt']['page']['login_url']; ?>
" method="post" enctype="application/x-www-form-urlencoded" name="login" dir="ltr" style="display: inline;">Utilisateur&nbsp;:&nbsp;&nbsp;<input name="email" size="10" type="text" class="textboxes" value="" />&nbsp;&nbsp;&nbsp;Mot de passe&nbsp;:&nbsp;&nbsp;<input name="password" size="10" type="password" class="textboxes" value="" />&nbsp;<input type="hidden" name="action" value="login" /><input type="hidden" name="target" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['opt']['page']['target'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /><input type="hidden" name="source" value="titlebar" />&nbsp;<input name="LogMeIn" value="Connexion" class="formbutton" style="width: 74px;" type="submit" onclick="submitbutton('LogMeIn')" /></form></b>
                                <?php else: ?>                                      <b>Connecté en tant que <a href="myhome.php" class="testing-top-left-corner-username"><?php echo ((is_array($_tmp=$this->_tpl_vars['login']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></b> - <a href="login.php?action=logout">Déconnexion</a>
                                <?php endif; ?>
                            <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:a9d37a1c20626755c41c5ca46074fc90#0}'; endif;?>
                        </td>
...
"<?php if ($this->_tpl_vars['opt']['template']['country'] == $this->_tpl_vars['countryItem']['country']): ?> selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['countryItem']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
            ...
            <div id="bg2">&nbsp;</div>
                ...
                <div id="debugoc"><font size="5" face="arial" color="red"><center>Système développeur - seulement des tests</center></font></div>
            <?php elseif (( $this->_tpl_vars['opt']['debug'] & DEBUG_TESTING ) == DEBUG_TESTING): ?>
                <div id="debugoc"><font size="5" face="arial" color="red"><center>Test - Ne vous connectez pas, s'il vous plaît</center></font></div>
            <?php endif; ?>
...
.png" class="headerimagecontent" />
                        ...
                        <div class="nav2">
                <ul>
                    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:a9d37a1c20626755c41c5ca46074fc90#1}'; endif;$this->_tag_stack[] = array('nocache', array()); $_block_repeat=true;smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
unset($_smarty_tpl_vars);
 ?>
                    <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:a9d37a1c20626755c41c5ca46074fc90#1}'; endif;?>
                </ul>
            </div> <!-- nav 2 -->
...
unset($_smarty_tpl_vars);
 ?></div>
                    <div id="suchbox"><form action="searchplugin.php" method="post"><b>Recherche de Waypoint&nbsp;:</b>&nbsp;<input type="hidden" name="sourceid" value="waypoint-search" /> <input type="text" name="userinput" size="10" class="waypoint" /> <input type="submit" name="wpsearch" class="formbutton" style="width:auto" value="&nbsp;Aller&nbsp;" onclick="submitbutton('wpsearch')" /></form></div>
                <?php endif; ?>
            </div>
...
<img src="resource2/ocstyle/images/misc/32x32-help.png" /></a></div>
            ...
            <?php endif; ?>
                ...
                <ul>
                    <li class="title">
                        <?php if ($this->_tpl_vars['submenu']['0']['parent'] == 1): ?>Nouvelles<?php else: ?>Menu<?php endif; ?>
                    </li>
                    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:a9d37a1c20626755c41c5ca46074fc90#2}'; endif;$this->_tag_stack[] = array('nocache', array()); $_block_repeat=true;smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                        <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
                    <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:a9d37a1c20626755c41c5ca46074fc90#2}'; endif;?>
                </ul>

                <p class="sidebar-maintitle">Sites du pays</p>
...
/images/nodes/oc-us.png" width="100" height="22" /></a>
                    ...
                    <p class="sidebar-maintitle">Les dons</p>
                    <div style="margin-top:16px; width:100%; text-align:center;">
                        <a href="articles.php?page=donations">
                            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/donate.gif" alt="Les dons" style="border:0px;" />
                        </a><br />
                        &nbsp;
                    </div>
                <?php endif; ?>
...
/images/media/16x16-facebook.png" width="16" height="16"  /></a></td>
                            ...
                            <tr>
                                <td class="mediumsmalltext" colspan="5" style="padding-top:0.6em; text-align:left">Rejoignez les discussions&nbsp;:</td>
                            </tr>
                        </table>
                        <table style="margin-left: auto; margin-right: auto;">
                            <tr><td><a href="http://forum.opencaching.de/"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/oclogo/16x16-oc_logo.png" /></a></td><td style="text-align: left"><a href="http://forum.opencaching.de/">Forum d'Opencaching</a></td></tr>
...
/images/media/16x16-google+.png" /></a></td><td style="text-align: left"><a href="https://plus.google.com/communities/115824614741379300945">Google+ Communauté</a></td></tr>
                            <tr><td><a href="https://www.facebook.com/groups/198752500146032/"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/media/16x16-facebook.png" /></a></td><td style="text-align: left"><a href="https://www.facebook.com/groups/198752500146032/">Groupe Facebook</a></td></tr>
                        </table>
                    </div>
                <?php endif; ?>
                ...
                <?php if ($this->_tpl_vars['license_disclaimer'] != ""): ?>
                    <!-- Datalicense -->
                    <p class="sidebar-maintitle">Licence de données</p>
                ...
                <div class="sidebar-txtbox-noshade">
                    <p class="content-txtbox-noshade-size5">
                        <small>
                            <?php if ($this->caching && !$this->_cache_including): echo '{nocache:a9d37a1c20626755c41c5ca46074fc90#3}'; endif;$this->_tag_stack[] = array('nocache', array()); $_block_repeat=true;smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                                Durée page&nbsp;: <?php echo ((is_array($_tmp=$this->_tpl_vars['sys_runtime'])) ? $this->_run_mod_handler('sprintf', true, $_tmp, "%1.3f") : smarty_modifier_sprintf($_tmp, "%1.3f")); ?>
 seconde<br />
                                <?php if (( $this->_tpl_vars['opt']['template']['caching'] == true )): ?>
                                    Page en cache&nbsp;: <?php if ($this->_tpl_vars['sys_cached'] == true): ?>Oui<?php else: ?>Non<?php endif; ?><br />
                                <?php endif; ?>
                                                            <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:a9d37a1c20626755c41c5ca46074fc90#3}'; endif;?>
                            Créé à&nbsp;: <?php echo ((is_array($_tmp='0')) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datetime']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datetime'])); ?>
...
<?php if ($this->_tpl_vars['opt']['template']['popup'] != true): ?>
                        ...
                        <div class="footer">
                <p><a href="articles.php?page=dsb">Déclaration de confidentialité</a> | <a href="articles.php?page=impressum">Conditions d'utilisation et renseignements juridiques</a> | <a href="articles.php?page=contact">Contact</a> | <a href="articles.php?page=changelog">Changement de log</a> | <a href="sitemap.php">Plan du site</a></p>
