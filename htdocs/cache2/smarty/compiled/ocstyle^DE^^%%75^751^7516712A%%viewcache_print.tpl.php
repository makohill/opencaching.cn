...
<?php else: ?>Wegpunkt: <?php endif; ?><?php echo $this->_tpl_vars['cache']['wpoc']; ?>
</font>
                    </td>
...
unset($_smarty_tpl_vars);
 ?>
                    ...
                    <td align="left" valign="top" width="99%">
                        ...
                        <span style="font-weight:400">&nbsp;von <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span><br />
...
/images/description/22x22-location.png"  width="22" height="22" border="0" alt="" title="" align="left" />&nbsp;
                        ...
                        <table class="print-cachemeta" cellspacing="0" cellpadding="0">
                            <tr><td>Gr&ouml;&szlig;e:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['sizeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /></td></tr>
                        <?php if ($this->_tpl_vars['cache']['searchtime'] > 0): ?>
                            <tr><td><nobr>Zeitaufwand:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['searchtime'])) ? $this->_run_mod_handler('format_hour', true, $_tmp) : smarty_modifier_format_hour($_tmp)); ?>

                                h<?php if ($this->_tpl_vars['cache']['waylength'] > 0): ?>, &nbsp;Wegstrecke <?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km<?php endif; ?>
                            </nobr></td>
                        <?php elseif ($this->_tpl_vars['cache']['waylength'] > 0): ?>
                            <tr><td><nobr>Strecke:</td><td><?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km</nobr></td></tr>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <tr><td>Versteckt am:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datehidden'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td><?php if ($this->_tpl_vars['cache']['is_publishdate'] == 0): ?>Gelistet seit:<?php else: ?>Veröffentlicht am:<?php endif; ?></td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datecreated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td>Letzte Änderung:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['lastmodified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>

                        <?php if ($this->_tpl_vars['cache']['wpgc'] != ''): ?>
                            <tr>
                            <td>Auch gelistet als:</td>
...
/images/log/16x16-dnf.png" width="16" height="16" border="0" /><?php if ($this->_tpl_vars['cache']['type'] == 6): ?> <?php echo $this->_tpl_vars['cache']['willattend']; ?>
 ...
 nicht gefunden<?php endif; ?></nobr><br />
                        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FEFEFE;border:solid 1px black;">
                        <tr>
                            ...
                            <td style="text-align:left; vertical-align:top">
                                Dieser Geocache liegt vermutlich in einem Naturschutzgebiet. Bitte verhalte dich entsprechend umsichtig! <font size="1">(<?php echo $this->_tpl_vars['opt']['cms']['npa']; ?>
Info</a>)</font><br />
                                <font size="2">
