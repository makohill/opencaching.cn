...
L'utilizzo degli smilies non è supportato.<?php echo '");
  }
}
...
/images/description/22x22-logs.png" style="margin-right: 10px;" width="22" height="22" alt="" />
    Aggiungi log per la cache <?php echo $this->_tpl_vars['cachelink']; ?>
...
<p class="redtext">
    Hai inviato più di <?php echo $this->_tpl_vars['masslogCount']; ?>
 logs identici. Per favore assicurati di inserire la data in cui hai visitato la cache e non la data attuale - anche quando loggi in ritardo vecchi ritrovamenti.
</p>
<p>
    Date di log errate possono confondere molte funzioni di OC come la ricerca per data di log. Inoltre il proprietario può ritenere che la cache sia stata trovata adesso (data e tipo dell'ultimo log sono visualizzate nella lista delle cache del proprietario!), cosa che può influire negativamente sul mantenimento della cache e portare ad ulteriori DNF.
</p>
<p class="spacer_before">
    <input type="checkbox" name="suppressMasslogWarning" value="1" class="checkbox" id="suppressMasslogWarning" /> <label for="suppressMasslogWarning">So quello che sto facendo, non visualizzare di nuovo questo avvertimento per oggi.</label>
</p>
<?php endif; ?>
<?php if ($this->_tpl_vars['showstatfounds'] == true): ?>
<p class="align-right">
    <b>Finora hai trovato <?php echo $this->_tpl_vars['userFound']; ?>
 cache.</b>
</p>
<?php endif; ?>
...
">commento dell'OC team</span></label>
            <?php endif; ?>
        </td>
    </tr>
    <tr><td class="spacer" colspan="2"></td></tr>
    <tr>
        <td width="180px">Data / ora:</td>
        <td>
...
" />
            ...
            <?php if ($this->_tpl_vars['validate']['dateOk'] == false): ?><br /><span class="errormsg">la data o l'ora non sono valide</span><?php endif; ?>
        </td>
    </tr>
    <tr><td class="spacer" colspan="2"></td></tr>
...
" target="_blank"><?php echo $this->_tpl_vars['gcwp']; ?>
    ...
    <tr>
        <td valign="top">Raccomandazioni:</td>
        <td valign="top">
            <?php if (( $this->_tpl_vars['ratingallowed'] == true || $this->_tpl_vars['israted'] == true )): ?><input type="hidden" name="ratingoption" value="1"><input type="checkbox" id="rating" name="rating" value="1" class="checkbox" <?php if ($this->_tpl_vars['israted'] == true): ?>checked<?php endif; ?>/>&nbsp;<label for="rating">Questa cache è una delle mie raccomandazioni.</label><br />
                Hai usato <?php echo $this->_tpl_vars['givenratings']; ?>
 raccomandazioni su <?php echo $this->_tpl_vars['maxratings']; ?>
 disponibili.
            <?php else: ?>
                Devi trovare ancora <?php echo $this->_tpl_vars['foundsuntilnextrating']; ?>
 cache per fare un' altra raccomandazione
                <?php if (( $this->_tpl_vars['givenratings'] > 0 && $this->_tpl_vars['givenratings'] == $this->_tpl_vars['maxratings'] && $this->_tpl_vars['israted'] == false )): ?><br />Opzionalmente puoi recuperare una delle <a href="mytop5.php">raccomandazioni</a> esistenti.<?php endif; ?>
            <?php endif; ?>
            <noscript><br />Puoi raccomandare questa cache solo dopo che la hai loggata come trovata!</noscript>
        </td>
    </tr>
    <?php endif; ?>
</table>
    ...
    <tr>
        <td colspan="2">
            <div class="menuBar">
                ...
                <span class="buttonSplitter">|</span>
                <span id="descText" class="buttonNormal" onclick="btnSelect(1)" onmouseover="btnMouseOver(1)" onmouseout="btnMouseOut(1)">Testo</span>
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <span id="scriptwarning" class="errormsg">JavaScript è disabilitato, è possibile inserire solo testo semplice. Per inserire HTML o usare l'editor attivare JavaScript, per favore.</span>
        </td>
    </tr>
    <tr>
        <td>
...
?><?php echo ''; ?><?php if ($this->_tpl_vars['smiley']['show']): ?><?php echo '<a href="javascript:insertSmiley(\''; ?><?php echo $this->_tpl_vars['smiley']['text']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['smileypath']; ?><?php echo ''; ?><?php echo $this->_tpl_vars['smiley']['file']; ?><?php echo '\')">'; ?><?php echo $this->_tpl_vars['smiley']['image']; ?><?php echo '</a> &nbsp;'; ?><?php endif; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo ''; ?>
    ...
    <tr>
        <td colspan="2">Parole chiave per il log:
            <input class="input100" type="text" name="log_pw" maxlength="20" value="" /> <?php if (! $this->_tpl_vars['validate']['logPw']): ?><span class="errormsg">La parola chiave non è corretta!</span><?php else: ?>(<?php if ($this->_tpl_vars['cachetype'] == 6): ?>solo per i log 'parteciper<?php else: ?>solo per i log "trovata"<?php endif; ?>)<?php endif; ?>
        </td>
    </tr>
    <tr><td class="spacer" colspan="2"></td></tr>
    <?php endif; ?>
    ...
    <tr>
        <td class="header-small" colspan="2">
            <input type="submit" name="submitform" value="Logga questa cache" class="formbutton" onclick="submitbutton('submitform')" />
        </td>
    </tr>
</table>
</form>
