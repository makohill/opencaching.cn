...
/images/description/22x22-image.png" height="22px" width="22px" alt="" /> Seleccione imagen para <?php echo ((is_array($_tmp=$this->_tpl_vars['cachename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
    </tr>
</table>
<table class="table">
...
" /></a></td>
        ...
        <?php endif; ?>
    <?php endforeach; else: ?>
        <tr><td>No hay imagen para este geocache</td></tr>
    <?php endif; unset($_from); ?>
</table>
<p><input type="checkbox" id="insertthumb" style="border:0;" /> <label for="insertthumb">Como imagen de vista previa</label></p>
<p><a href="javascript:CancelSelect();"><a href="javascript:CancelSelect();">Cancelado</a></p>