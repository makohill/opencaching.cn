...
/images/misc/32x32-watched.png" style="margin-right: 10px;" width="32" height="32" alt="" />
            Geocache osservate - impostazioni
        </div>
            ...
            <tr>
                ...
                <td>
                    <select id="interval" name="interval" onchange="intervalChanged();">
                        <option value="0" <?php if ($this->_tpl_vars['interval'] == 0): ?>selected="selected"<?php endif; ?>>Immediata</option>
                        <option value="1" <?php if ($this->_tpl_vars['interval'] == 1): ?>selected="selected"<?php endif; ?>>Giornaliera</option>
                        <option value="2" <?php if ($this->_tpl_vars['interval'] == 2): ?>selected="selected"<?php endif; ?>>Settimanale</option>
                    </select>
                </td>
            </tr>
...
/images/misc/hint.gif" border="0" width="15" height="11" /> Ora e giorno di spedizione possono essere specificati solo per invii giornalieri o settimanali.</td>
            </tr>
            <tr><td class="spacer" colspan="2"></td></tr>
            <?php if ($this->_tpl_vars['error'] == true): ?>
                <tr><td colspan="2" class="errormsg">Errore nel salvataggio delle impostazioni!</td></tr>
            <?php elseif ($this->_tpl_vars['saved'] == true): ?>
                <tr><td colspan="2" class="okmsg">Impostazioni salvate</td></tr>
            <?php endif; ?>
            <tr><td class="spacer" colspan="2"></td></tr>
            ...
            <td colspan="2">
                <table class="table">
                    <tr class="cachelistheader">
                        ...
                        <th width="50px">Stato</th>
                        <th width="350px">Nome</th>
                        <th width="100px"><nobr>Ultima trovata</nobr></th>
                        <th></th>
                    </tr>
...
" style="text-align:center">
                            ...
                            <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
"><nobr>[<a href="javascript:if(confirm('Vuoi veramente cancellare?'))location.href='mywatches.php?action=remove&cacheid=<?php echo $this->_tpl_vars['watchItem']['cacheid']; ?>
&target=mywatches.php'">do not watch</a>]</nobr></td>
                        </tr>
                    <?php endforeach; else: ?>
                        <tr><td colspan="5"><br />Nessuna geocache osservata.</td></tr>
