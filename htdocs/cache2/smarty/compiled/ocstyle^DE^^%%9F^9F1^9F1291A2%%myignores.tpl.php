...
unset($_smarty_tpl_vars);
 ?></td>
                        <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
"><nobr>[<a href="javascript:if(confirm('Möchtest du diesen Eintrag wirklich entfernen?'))location.href='ignore.php?cacheid=<?php echo $this->_tpl_vars['ignoreItem']['cacheid']; ?>
&action=removeignore&target=myignores.php'">nicht ignorieren</a>]</nobr></td>
                    </tr>
                <?php endforeach; else: ?>
                    <tr><td colspan="4"><br />Du ignorierst zurzeit keine Geocaches.</td></tr>
