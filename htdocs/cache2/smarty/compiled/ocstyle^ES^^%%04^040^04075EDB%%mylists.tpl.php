...
" class="input200" /></span><br />
            ...
            <tr>
                ...
                <td id="desc0" style="<?php if ($this->_tpl_vars['desctext'] != '' || $this->_tpl_vars['show_editor']): ?>display:none<?php endif; ?>" >
                    <input type="button" value="Añadir" onclick="javascript:showdesc()" class="formbutton" />
                </td>
...
" ><?php echo $this->_tpl_vars['desctext']; ?>
                    ...
                    <span class="smalltext">Al enviar Acepto los  <a href="articles.php?page=impressum#tos" target="_blank">los terminos de servicio de Opencaching.de</a> y la <a href="articles.php?page=impressum#datalicense" target="_blank">licencia de datos de Opencaching.de</a>.</span>
                </td>
            </tr>
            <tr><td class="separator"></td></tr>
            <tr><td class="separator"></td></tr>
...
/images/misc/hint.gif" border="0" width="15" height="11" alt="Ayuda" align="middle" /> Space-separated list of OC waypoints. <?php if ($this->_tpl_vars['edit_list']): ?>You may also add caches via "Add to list" button in cache listings.<?php else: ?>This is optional, caches may be added to the list later.<?php endif; ?></td>
            </tr>
...
unset($_smarty_tpl_vars);
 ?></td>
            ...
            <tr>
                ...
                <?php else: ?>
                    <input type="submit" name="save" value="Guardar" class="formbutton" onclick="submitbutton('save')" />
                <?php endif; ?>
            </tr>
            <tr><td>&nbsp;</td></tr>
        </table>
