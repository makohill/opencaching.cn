...
/images/oc_404.png" title="opencaching.de 404" alt="opencaching.de 404" />
                    <span class="dnf">- Pagina non trovata - DNF</span>
                </p>
            </div>
            <div id="content">
                <p class="text">Il sito web visitato <b><?php echo ((is_array($_tmp=$this->_tpl_vars['website'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b> non esiste, abbiamo trovato le seguenti pagine:</p>
...
" title="Database cache"><?php echo $this->_tpl_vars['opt404']['newcaches']['urlname']; ?>
</a>&nbsp;Qui puoi trovare molte cache individuali.</p>
                    <div>
                        <p>Le cache più recenti:</p>
...
</a>&nbsp;Qui puoi discutere, rispondere a domande o migliorare le risposte.</p>
                    <div>
                        <p>I post più recenti del forum:</p>
                                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
</a>&nbsp;Quando ci sono nuovi post li potrai trovare qui.</p>
                    <div>
                        <p>I post più recenti del blog:</p>
                                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
</a>&nbsp;Qui trovi tutorials, 'come fare' e ogni informazione su Geocaching and Opencaching.</p>
                    <div>
                        <p>Gli articoli più recenti del wiki:</p>
                                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <div id="foot">
                <p class="text">Non trovato? Contattaci usando <a class="links" href="<?php echo $this->_tpl_vars['opt']['mail']['contact']; ?>
" title="Contatti"><?php echo $this->_tpl_vars['opt']['mail']['contact']; ?>
</a>.</p>
                <p>&nbsp;</p>
                <p class="center"><a class="links" href="/articles.php?page=impressum" title="Informazioni legali">Informazioni legali</a> - <a class="links" href="/articles.php?page=verein" title="Opencaching e.V.">Opencaching Deutschland e.V.</a> - <a class="links" href="/articles.php?page=contact" title="Contatti">Contatti</a></p>
                <p class="center"><a class="links" href="/fb" title="Opencaching su Facebook">Facebook</a> - <a class="links" href="/+" title="Opencaching su Google+">Google+</a> - <a class="links" href="/t" title="Opencaching su Twitter">Twitter</a></p>
            </div>
        </div>
    </body>
</html>