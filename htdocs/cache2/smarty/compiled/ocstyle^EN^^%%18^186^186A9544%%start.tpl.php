...
/images/cacheicon/event.gif" style="margin-right: 10px;" width="24" height="24" alt="" />
        The next events in <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<p style="line-height: 1.6em;">Geocaches with most recommendations in the last <?php echo $this->_tpl_vars['toprating_days']; ?>
 days in <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
.</p>
...
" style="color: rgb(88, 144, 168); text-decoration: none;">New forum topcis (<?php echo ((is_array($_tmp=$this->_tpl_vars['phpbb_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)</a>
        </p>
    </div>
    <div id="forum">
...
" style="color:rgb(88,144,168); text-decoration: none;">Newest caches in <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>
...
<p style="line-height: 1.6em;">(<?php echo $this->_tpl_vars['count_hiddens']; ?>
 active caches and <?php echo $this->_tpl_vars['count_founds']; ?>
 founds by <?php echo $this->_tpl_vars['count_users']; ?>
 users total)</p>
<div class="content2-section-no-p">
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
