...
<table class="table">
    <tr>
        <td style="padding-bottom:20px;">
            La liste suivante est automatiquement générée par les recommandations données des utilisateurs. Vous pouvez trouver plus d'informations sur la classification régionale dans le <a href="http://wiki.opencaching.de/index.php/Empfehlungen">Wiki</a>.<br /><br />Les chiffres dans la liste ci-dessous signifie&nbsp;:<br /><img src="images/rating-star.gif" border="0" alt="Recommandations" /> Nombre d'utilisateurs qui recommandent ce cache<br /><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="Trouvé" /> Contrôles = Nombre de fois que le cache a été trouvé<br />Index tente de prendre le nombre de recommandations et fonde dans un ordre qui d'abord montrer «&nbsp;le meilleur&nbsp;» géocache.<br /><img src="images/tops-formula.png" border="0" alt="formule" />
        </td>
    </tr>
    <tr>
...
null"><i>(sans référence régionale)</i><br /></a>
                                <?php else: ?>
                                    <a href="#<?php echo ((is_array($_tmp=$this->_tpl_vars['topItem']['adm1'])) ? $this->_run_mod_handler('urlencode', true, $_tmp) : smarty_modifier_urlencode($_tmp)); ?>
...
<?php endif; ?>"></a>
        ...
        <table class="table">
            <tr>
                ...
                <td style="text-align:right"><img src="images/rating-star.gif" border="0" alt="Recommandations" /></td>
                <td style="text-align:right"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="trouvé" /></td>
                <td></td>
                <td>&nbsp;</td>
            </tr>
    <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?> par <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['topItem']['userid']; ?>
