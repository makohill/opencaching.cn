            ...
            <td colspan="2">
                <table class="table">
                    <tr class="cachelistheader">
                        ...
                        <?php if ($this->_tpl_vars['show_user']): ?><th width="<?php if ($this->_tpl_vars['show_watchers']): ?>130px<?php else: ?>160px<?php endif; ?>">di</th><?php endif; ?>
                        <?php if ($this->_tpl_vars['show_status']): ?><th width="70px">Stato</th><?php endif; ?>
                        <th width="50px">Cache</th>
                        <?php if ($this->_tpl_vars['show_watchers']): ?><th width="60px">Osservata</th><?php endif; ?>
...
'">rimuovi</a>]<?php endif; ?>
                                <?php if ($this->_tpl_vars['togglewatch']): ?><nobr>[<a href="<?php if ($this->_tpl_vars['cachelist']['watched_by_me'] && $this->_tpl_vars['removewatch_confirm']): ?>javascript:if(confirm('Vuoi veramente cancellare?'))location.href='<?php echo $this->_tpl_vars['togglewatch']; ?>
