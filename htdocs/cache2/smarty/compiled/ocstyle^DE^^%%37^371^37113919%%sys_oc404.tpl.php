...
/images/oc_404.png" title="opencaching.de 404" alt="opencaching.de 404" />
                    <span class="dnf">- Seite nicht gefunden - DNF</span>
                </p>
            </div>
            <div id="content">
                <p class="text">Die gesuchte Webseite <b><?php echo ((is_array($_tmp=$this->_tpl_vars['website'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b> existiert nicht, aber wir haben folgende Seiten gefunden:</p>
...
" title="Cache-Datenbank"><?php echo $this->_tpl_vars['opt404']['newcaches']['urlname']; ?>
</a>&nbsp;Hier findest du viele interessante Geocaches.</p>
                    <div>
                        <p>Die neuesten Caches:</p>
...
</a>&nbsp;Hier kannst du diskutieren, mitmachen oder Fragen stellen.</p>
                    <div>
                        <p>Die neuesten Forenbeiträge:</p>
                                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
</a>&nbsp;Es gibt immer wieder Neuigkeiten &ndash; hier findest du sie.</p>
                    <div>
                        <p>Die neuesten Blog-Artikel:</p>
                                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
</a>&nbsp;Hier findest du Anleitungen und Informationen über Geocaching und Opencaching.</p>
                    <div>
                        <p>Die neuesten Wiki-Artikel:</p>
                                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <div id="foot">
                <p class="text">Nichts gefunden? Kontaktiere uns unter <a class="links" href="<?php echo $this->_tpl_vars['opt']['mail']['contact']; ?>
" title="Kontakt"><?php echo $this->_tpl_vars['opt']['mail']['contact']; ?>
</a>.</p>
                <p>&nbsp;</p>
                <p class="center"><a class="links" href="/articles.php?page=impressum" title="Impressum">Impressum</a> - <a class="links" href="/articles.php?page=verein" title="Verein">Opencaching Deutschland e.V.</a> - <a class="links" href="/articles.php?page=contact" title="Kontakt">Kontakt</a></p>
                <p class="center"><a class="links" href="/fb" title="Opencaching bei Facebook">Facebook</a> - <a class="links" href="/+" title="Opencaching bei Google+">Google+</a> - <a class="links" href="/t" title="Opencaching bei Twitter">Twitter</a></p>
            </div>
        </div>
    </body>
</html>