...
<?php if ($this->_tpl_vars['deleted'] == true): ?>
    <div class="content-txtbox-noshade">
        <p style="line-height: 1.6em;"><span style="color: red">¡Su recomendación para la "<a href="viewcache.php?wp=<?php echo $this->_tpl_vars['deletedItem']['wp']; ?>
...
" style="text-align:center"><?php echo ((is_array($_tmp=$this->_tpl_vars['ratingItem']['rating_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['date']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['date'])); ?>
                        ...
                        <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
"><nobr>[<a href="javascript:if(confirm('¿Estás seguro que quieres eliminar esta recomendación?'))location.href='mytop5.php?action=delete&amp;cacheid=<?php echo $this->_tpl_vars['ratingItem']['cacheid']; ?>
'">Recomendación retirada</a>]</nobr></td>
                    </tr>
                <?php endforeach; else: ?>
                    <tr><td colspan="3"><br />Aún no ha recomendado cachés.</td></tr>
