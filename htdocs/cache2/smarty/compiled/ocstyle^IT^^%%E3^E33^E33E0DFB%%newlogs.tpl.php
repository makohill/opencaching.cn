...
/images/cacheicon/traditional.gif" style="margin-right: 10px;" width="32" height="32" alt="" />
        <?php if ($this->_tpl_vars['ownerlogs']): ?>
            <?php if ($this->_tpl_vars['ownlogs']): ?>
                Inserimenti log per le tue geocache
            <?php else: ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['ownername'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                Ultimi log per le cache di <?php echo $this->_smarty_vars['capture']['ownerlink']; ?>
...
<?php else: ?>
    ...
    <table cellspacing="0" cellpadding="0" style="width:98.1%">
        <tr>
            <td class="nav4">
                <ul>
                    <li class="group noicon <?php if ($this->_tpl_vars['countryCode'] === ''): ?>selected<?php endif; ?>"><a href="newlogs.php">Tutto nuovi logs</a></li>
...
">Nuovi logs in <?php echo $this->_tpl_vars['countryName']; ?>
</a>
                    <li class="group noicon <?php if ($this->_tpl_vars['rest']): ?>selected<?php endif; ?>"><a href="newlogsrest.php">Nuovi logs senza <?php echo $this->_tpl_vars['mainCountryName']; ?>
</a></li>
                </ul>
            </td>
            <td class="default" style="text-align:right; vertical-align:top; padding-top:0.2em">
                <select id="logselection" onchange="logSelectionChanged()" >
                    <option value="1" <?php if ($this->_tpl_vars['logselection'] == 1): ?>selected="selected"<?php endif; ?>>Current new entries</option>
                    <option value="2" <?php if ($this->_tpl_vars['logselection'] == 2): ?>selected="selected"<?php endif; ?>>All new entries</option>
                    <option value="3" <?php if ($this->_tpl_vars['logselection'] == 3): ?>selected="selected"<?php endif; ?>>... by log date</option>
                </select>
            </td>
        </tr>
    </table>
...
<?php if ($this->_tpl_vars['total_found'] + $this->_tpl_vars['total_attended'] + $this->_tpl_vars['total_dnf'] + $this->_tpl_vars['total_recommended']): ?>
  ...
  <img src="images/rating-star.gif" width="17" height="16" title="recommended" />&nbsp;
            <?php endif; ?>
            <?php if ($this->_tpl_vars['total_found']): ?>
                <?php echo $this->_tpl_vars['total_found']; ?>
 <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" alt="found" title="found"  />&nbsp;
            <?php endif; ?>
            <?php if ($this->_tpl_vars['total_dnf']): ?>
                <?php echo $this->_tpl_vars['total_dnf']; ?>
 <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-dnf.png" alt="not&nbsp;found" title="not&nbsp;found"  />&nbsp;
            <?php endif; ?>
            <?php if ($this->_tpl_vars['total_attended']): ?>
                <?php echo $this->_tpl_vars['total_attended']; ?>
 <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-attended.png" alt="attended" title="attended"  />&nbsp;
            <?php endif; ?>
        </p>
    </div>
<?php endif; ?>
 ...
 ?>
    ...
    <?php if ($this->_tpl_vars['ownerlogs'] && $this->_tpl_vars['ownlogs']): ?>
        <?php if ($this->_tpl_vars['show_own_logs']): ?>
            <a class="systemlink" href="ownerlogs.php?ownlogs=0">Nascondi miei logs</a>
        <?php else: ?>
            <a class="systemlink" href="ownerlogs.php?ownlogs=1">Visualizza miei logs</a>
        <?php endif; ?>
    <?php endif; ?>
</p>
...
/images/oclogo/oc-team-comment.png" alt="OC-Team" title="commento dell'OC team" /><?php endif; ?>
                <?php ob_start(); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['newLog']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 ha trovato <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 2): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 non ha trovato <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 3): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 ha scritto una nota per <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 7): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 ha visitato <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 8): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 vuole visitare <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 9): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 ha archiviato <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 10): ?>
                    <?php if ($this->_tpl_vars['newLog']['oc_team_comment']): ?>
                        <?php echo $this->_smarty_vars['capture']['username']; ?>
 ha attivato <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                    <?php else: ?>
                        <?php echo $this->_smarty_vars['capture']['username']; ?>
 ha fatto manutenzione a <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                    <?php endif; ?>
                <?php elseif ($this->_tpl_vars['newLog']['type'] == 11): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 ha disabilitato <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 13 || $this->_tpl_vars['newLog']['type'] == 14): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 ha bloccato <?php echo $this->_smarty_vars['capture']['cachename']; ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php endforeach; else: ?>
        <?php if ($this->_tpl_vars['ownerlogs']): ?>
            <p>Non cio sono ancora log per le tue geocache.</p>
        <?php endif; ?>
