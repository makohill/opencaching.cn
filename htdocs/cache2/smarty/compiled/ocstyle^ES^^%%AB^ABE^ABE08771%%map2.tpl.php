...
<?php if ($this->_tpl_vars['old_msie']): ?>
    ...
    function mapLoad()
    {
        document.getElementById(\'googlemap\').innerHTML =
            "<div style=\'position:relative; top:180px; left:10px\'><p>Tu Internet Explorer es demasiado viejo para visualizar el mapa. Por favor, actualice al menos a la versión 7 o mejor 8.</p></div>";
    }
    -->'; ?>
...
var msSearchHint = "'; ?>
ciudad, cache o waypoint<?php echo '";
...
function updateCopyrights()
{
    ...
    if (newMapType == "OSM" || newMapType == "MQ" || newMapType == "OCM")
    {
        ...
        if (newMapType == "OCM")
            copyrightDiv.innerHTML = 'Datos del mapa &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a> and <a href="http://www.thunderforest.com/opencyclemap/" target="_blank">OpenCycleMap</a> colaboradores';
        else
            copyrightDiv.innerHTML = 'Datos del mapa &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a> colaboradores';
        if (newMapType == "MQ")
            copyrightDiv.innerHTML += ', ' + 'capas proporcionadas por <a href="http://www.mapquest.com/" target="_blank">MapQuest</a>' + ' <img src="http://developer.mapquest.com/content/osm/mq_logo.png" />';
        <?php echo '
    }
    else
...
function data_mapreceive(data, responseCode)
{
    ...
    if (responseCode != 200)
    {
        var sMessage = \'Error: No se puede descargar los resultados de búsqueda (código de erro HTTP %1)\';
    ...
    if (oXML.documentElement.getAttribute("available") +0 == 0)
    {
        ...
        {
            // alert(\'Error: No se puede descargar los resultados de búsqueda. Los datos no están disponibles en el servidor.\');
            error_no_data(true);
        }
        return;
    }
...
function show_cachepopup_url(sURL, sWaypoint, bAllowZoomChange)
{
    ...
    ajaxLoad(sURL, function(data, responseCode) {
        ...
        if (!oCoords)
        {
            if (sWaypoint != \'\')
            {
                var sMessage = \'Waypoint %1 no encontrado!\';
...
function parseXML_GetHTML(xmlobject)
{
    ...
    sHtml += "<tr><td colspan='2' style='vertical-align:top;'>por <a href=" +apos+"viewprofile.php?userid="+encodeURI(nUserId)+apos+ " target='_blank'>" + xmlentities(sUsername) + "</a></td><td align='right'><a class='nooutline' href='articles.php?page=cacheinfo#difficulty' target='_blank'><img src=" + apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-"+String(nDifficulty*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Dificultad: " + String(nDifficulty) + " de 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /><img src=" +apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-"+String(nTerrain*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Terreno: " + String(nTerrain) + " de 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /></a></td></tr>";
...
<img src='resource2/ocstyle/images/misc/is_oconly_small.png' alt='OConly' title='OConly' /></a>" : "") + "</td></tr>";
    sHtml += "<tr><td colspan='2'>" + (bIsPublishdate == true ? "Publicado en:" : "Publicado desde:") + " " + xmlentities(sListedSince) + "</td></tr>";

    sAddHtml = "";
    if (bOwner==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/misc/16x16-home.png' alt='' /> Este cache es tuyo</td></tr>";

    if (bFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-found.png' alt='' /> Tú encontraste este cache</td></tr>";

    if (bNotFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-dnf.png' alt='' /> Tú no te has encontrado este cache</td></tr>";

    if (bAttended==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/log/16x16-attended.png' alt='' /> ¡Has participado en este evento!</td></tr>";

    if (nGeoKreties>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/gk.png' alt='' /> Este cache almacena una GeoKrety</td></tr>";

    if (nTopRating>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/rating-star.gif' alt='' /> Este cache tiene %1 recomendaciones</td></tr>".replace(/%1/, nTopRating);
    ...
    if (oWaypoints.length)
    {
        ...
        if (oWaypoints.length > 1)
            sMsg = "El cache tiene %1 %2additional waypoints%3.";
        else
            sMsg = "El cache tiene unos %2additional waypoint%3.";
...
function tmd_show(number)
{
    ...
    var sMessage = \'Hemos encontrado %1 geocache en la región seleccionada que cumplen las condiciones de filtro. Zoom para ver la cache.\';
...
function download_gpx()
{
    ...
    {
        alert('; ?>
"Entre 1 y 500 cachés se mostraran en tu descarga."<?php echo ');
        return;
    }
...
function mapsearch_click()
{
    ...
    {
        alert(\'¡Insertar una busqueda de texto, por favor!\');
        return;
    }
...
<?php if ($this->_tpl_vars['opt']['template']['locale'] == 'DE'): ?>
    ...
    moGeocoder.geocode( { \'address\': sSearchText },
        function(results, status)
        {
            ...
            {
                var oTempOption = new Option("Lugares encontrar a través de Google:", -1);
            ...
            ajaxLoad(msURLMapPHP + "?mode=" + searchpar,
                function(data, responseCode) {
                    ...
                    if (caches.length>0)
                    {
                        var oTempOption = new Option("Geocaches encontrados, más cercano en primer lugar:", -1);
                        oTempOption.style.color = "gray";
                        moSearchList.options[moSearchList.length] = oTempOption;
                        ...
                        {
                            var item = new Option("     '; ?>
Otros elementos que se encuentrados ...<?php echo '", -1);
                            item.style.marginLeft = "20px";
                    ...
                    if (moSearchList.length==0)
                    {
                        mapselectlist_hide();
                        alert("\'" + sSearchText + "\' '; ?>
no se encontró (con los ajustes seleccionados)<?php echo '");
                        return;
                    }
...
function filter_changed()
{
    if (!bFilterChanged)
    {
        ...
        if (heading.style.color != "#f88c00")
        {
            ...
            heading.innerHTML = "'; ?>
El mapa está en proceso de actualización<?php echo ' ...";
...
').style.display = sShow;
    ...
    tas.innerHTML = (bShow ? "Menor" : "Mostrar todo");
    if (bFullscreen)
...
<div id="<?php if ($this->_tpl_vars['bFullscreen']): ?>fullmap<?php else: ?>smallmap<?php endif; ?>" class="mapframe">
    ...
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
            ...
            <div id="mapstat_caches" class="mapstat_fullscreen" style="z-index:5">Visualizador de caches: <span id="statCachesCount">0</span><span id="statLoadTime" style="display:none">0</span></div>
...
/images/misc/hint.gif" border="0" width="15" height="11" align="middle" />
                Visualización del mapa con Microsoft Internet Explorer es lento y limitado a <?php echo $this->_tpl_vars['maxrecords']; ?>
 geocaches. Utilice otro navegador para un mejor rendimiento.
            </p>
        <?php endif; ?>
    <?php endif; ?>
            ...
            <tr>
                <?php if ($this->_tpl_vars['bFullscreen']): ?>
                    ...
                    <td rowspan="2" class="maplogin">
                        <?php if ($this->_tpl_vars['username'] != ""): ?>Conectado como<br /><a href="myhome.php"><b><?php echo $this->_tpl_vars['username']; ?>
...
<?php endif; ?>"><img src="resource2/ocstyle/images/action/15x13-logout.png" style="margin-bottom:2px" alt="Desconectado" title="Desconectado" /></a><?php else: ?><a href="login.php?target=map2.php%3Fmode%3Dfullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>%26queryid%3D<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>">Acceso...</a><?php endif; ?>
                    </td>
                    <td rowspan="2">&nbsp;&nbsp;</td>
                <?php endif; ?>
...
/images/misc/32x32-home.png" alt="Ir a las Coordenadas de origen" title="Ir a las Coordenadas de origen" /></a></td>
                <?php endif; ?>
...
/images/map/35x35-gpx-download.png" style="margin-left:5px; margin-right:5px" height="35" width="35" alt="Descargar fichero GPX (max. 500)" title="Descargar fichero GPX (max. 500)" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="showPermlinkBox_click()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-star.png" style="margin-left:3px; margin-right:1px" height="35" width="35" alt="Mostrar enlace en el mapa" title="Mostrar enlace en el mapa" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="toggle_settings()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-configure.png" class="mapbutton" style="margin-left:0px; margin-right:2px" height="35" width="35" alt="Configuración" title="Configuración" /></a></td>

                                <?php if ($this->_tpl_vars['help_map'] != ""): ?>
                    <td rowspan="2"><?php echo $this->_tpl_vars['help_map']; ?>
<img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/32x32-help.png" class="mapbutton" style="margin-left:2px; margin-right:4px" height="32" width="32" alt="Instrucciones" title="Instrucciones" /></a></td>
                <?php endif; ?>
...
/images/map/35x35-normalscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="Cambiar a mapa pequeño" title="Cambiar a mapa pequeño" /></a>
                    <?php else: ?>
                        <a class="nooutline" href="map2.php?mode=fullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>&queryid=<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-fullscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="Mostrar a pantalla completa" title="Mostrar a pantalla completa" /></a>
                    <?php endif; ?>
                </td>
        ...
        <table>
            <tr><td><img src="resource2/ocstyle/images/viewcache/link.png" alt="" height="16" width="16" /> Enlace a esta vista del mapa:</td><td align="right"><a href="javascript:permalinkbox_hide()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></td></tr>
            <tr><td><input id="permalink_text" type="text" value="" size="55"/></td></tr>
            <tr id="permalink_addFavorites"><td align="right"><input type="button" value="Añadir a favoritos..." onclick="addFavorites_click()" /></td></tr>
        </table>
    </div>
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
        </div></div>            <?php endif; ?>
    ...
    <?php endif; ?>
            ...
            <div class="maploading">Cargando mapa ...</div>
...
<?php endif; ?>" method="post" style="display:inline;">
                    ...
                    <table>
                        <tr><td><span style="font-size:1.2em; font-weight:bold">Configuración</strong></td><td style="text-align:right"><a href="javascript:toggle_settings()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></tr>
                        <tr><td>'Map' opción de menu:</td><td><select name="opt_menumap"><option id="opt_menumap0" value="0">pequeño mapa</option><option id="opt_menumap1" value="1">mapa en pantalla completa</option></select></td></tr>
                        <tr><td>Mostrar mapa general:</td><td><input type="checkbox" id="opt_overview" name="opt_overview" value="1" /></td></tr>
                        <tr><td>Maximo de cache en el mapa<br />(<?php echo $this->_tpl_vars['min_maxrecords']; ?>
...
/images/misc/hint.gif" alt="" />
 ...
 caches se pueden visualizar con Microsoft Internet Explorer.
                            </td></tr>
                        <?php endif; ?>
                        <tr><td>Iconos de cache:</td><td><select name="opt_cacheicons"><option id="opt_cacheicons1" value="1">OC clasico<option id="opt_cacheicons2" value="2">estilo OKAPI</option></select></td></tr>
                        <tr><td>Mostrar <?php echo $this->_tpl_vars['help_previewpics']; ?>
preview de la imagen</a><br />(% of map area, 0=off):</td><td><input type="text" id="opt_pictures" name="opt_pictures" size="2" maxlength="2" /></td></tr>
                        <tr><td colspan="2"><?php if ($this->_tpl_vars['login']['userid'] > 0): ?><input type="button" class="formbutton" value="Cancelado" onclick="toggle_settings()"/>&nbsp; <input type="submit" name="submitsettings" class="formbutton" value="OK" onclick="submitbutton('submitsettings')" /><?php else: ?><em>Debes estar conectado para cambiar la configuración del mapa.</em><?php endif; ?></td></tr>
                    </table>
                </form>
            </div>
...
/images/map/32x32-left.png" /></a>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td id="filterboxtitle" class="content-title-noshade-size1">Mostrar sólo geocaches con las siguientes propiedades:</td>
    ...
    <?php else: ?>
        ...
        <div style="width:770px;text-align:right;"><span id="mapstat_caches">Visualizador de caches: <span id="statCachesCount">0</span></span>, Tiempo de carga: <span id="statLoadTime">0</span> seg</div>
        <div style="<?php if ($this->_tpl_vars['queryid'] > 0): ?>display:none<?php endif; ?>">
        <p id="filterboxtitle" class="content-title-noshade-size1">Mostrar sólo geocaches con las siguientes propiedades:</p>
        ...
        <tr>
            <td class="mapfilter pad10" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>600<?php else: ?>752<?php endif; ?>">
                <table style="width:100%">
                    <tr>
                        <td>
                            <strong>Nombre:</strong>&nbsp; <input type="text" id="cachename" name="cachename" value="" onkeyup="filter_changed()" onchange="filter_changed()" class="input200" /></td>
                        </td>
                        <td style="text-align:right">
                            <input type="button" name="resetfilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Reset&nbsp;&nbsp;" onclick="reset_filter()" />&nbsp;
                            <input type="button" name="savefilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Guardar&nbsp;&nbsp;" onclick="save_filter()" />&nbsp;
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table>
        <tr>
                ...
                <table>
                    <tr><td colspan="3" class="mapfiltertopic mft_withcheckbox"><input id="all_cachetypes" type="checkbox" checked="checked" onchange="alltypes_changed()" /> <label for="all_cachetypes">Tipo de cache</label></td></tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheTypeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic mft_withcheckbox"><input id="all_cachesizes" type="checkbox" checked="checked" onchange="allsizes_changed()" /> <label for="all_cachesizes">Contenedor</label></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <?php $_from = $this->_tpl_vars['aCacheSize']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheSizeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic">Escondidos</td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userowner" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Mio</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userfound" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Mis Encontrados</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_ignored" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Ignorados</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            <input type="checkbox" id="f_inactive" name="f_inactive" value="1" checked="checked" onchange="filter_changed()" class="checkbox" />
                            <label for="f_inactive">archivado</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                    ...
                    <tr <?php if ($this->_tpl_vars['nongc']): ?>style='display:none'<?php endif; ?>>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_otherPlatforms">listado GC</label>
                                                    </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                ...
                <table>
                    <tr>
                        <td colspan="2" class="mapfiltertopic">Valoración</td>
                    <tr><td colspan="2"><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    </tr>
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Dificultad:</td>
        ...
        <tr>
            <td id="attribcell" valign="top" class="mapfilter pad10" style="padding-bottom:2px" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>675<?php else: ?>752<?php endif; ?>">
                <table>
                    <tr><td class="mapfiltertopic">Attribute &nbsp; <span class="mapfiltertopic_add">[<a id="toggle_attribselection" class="jslink" onclick='toggle_attribselection(true)'>Menor</a>]</span></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td>
