...
" class="input170" /></td>
                    ...
                    <tr>
                        <td colspan="2" style="text-align:right">
                            <input type="submit" name="filter" value="Cerca" class="formbutton" onclick="submitbutton('filter')" />&nbsp;
                            <input type="submit" name="reset" value="Ripristino" class="formbutton" onclick="resetfilter()" />
                        </td>
                    </tr>
                    <tr><td class="separator"></td></tr>
                    <tr><td class="separator"></td></tr>
