...
/images/misc/22x22-email.png" style="margin-right: 10px;" width="32" height="32" alt="" />
        El E-mail a $1 se ha enviado.
    </div>

    <table class="table">
        <tr>
            <td colspan="2">
                Asunto: <?php echo ((is_array($_tmp=$this->_tpl_vars['subject'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
"/>
        <div class="content2-pagetitle">
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/22x22-email.png" style="margin-right: 10px;" width="32" height="32" alt="" />
            Enviar email a <?php echo $this->_smarty_vars['capture']['userlink']; ?>
        ...
        <table class="table">
            ...
            <tr>
                <td colspan="2">Asunto:&nbsp; <input type="text" name="subject" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['subject'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" class="input500" /></td>
            </tr>
            <tr><td class="spacer" colspan="2"></td></tr>

            <?php if ($this->_tpl_vars['errorSubjectEmpty'] == true): ?>
                <tr><td colspan="2" class="errormsg">¡Tienes que insertar un tema!</td></tr>
            <?php endif; ?>
            ...
            <?php if ($this->_tpl_vars['errorBodyEmpty'] == true): ?>
                <tr><td colspan="2" class="errormsg">¡Tienes que insertar un contenido!</td></tr>
            <?php endif; ?>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <label for="l_send_emailaddress">Enviar mi dirección email con el mensaje</label>
                </td>
            </tr>
            <tr>
...
/images/misc/hint.gif" border="0" width="15" height="11" align="middle" />
                    Esto permite que el destinatario responda a su correo electrónico utilizando su cliente de correo electrónico.<br />
                    <div style="padding: 10px 0 10px 0">
                        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/hint.gif" border="0" width="15" height="11" align="middle" />
                        <span class="smalltext">Para protegerlo a usted de los abusos:</span>
                        <ul style="margin:0; line-height:1.1em">
                            <li class="smalltext">Sólo se admiten mensajes de emails sobre geocaching. ¡El spam esta prohibido!</li>
                            <li class="smalltext">Toda la información pertinente se registra (fecha y hora, emisor / receptor y la dirección IP).</li>
                            <li class="smalltext">¡Todos los datos serán confidenciales y no se revelará a terceros!</li>
                        </ul>
                    </div>
                </td>
            </tr>
            ...
            <?php if ($this->_tpl_vars['errorUnkown'] == true): ?>
                <tr><td colspan="2" class="errormsg">Un error desconocido ocurrió y el e-mail no se ha enviado.</td></tr>
            <?php endif; ?>
