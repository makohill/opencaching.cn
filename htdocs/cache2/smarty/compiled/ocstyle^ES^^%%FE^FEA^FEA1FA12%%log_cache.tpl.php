...
Smilies no son compatibles.<?php echo '");
  }
}
...
/images/description/22x22-logs.png" style="margin-right: 10px;" width="22" height="22" alt="" />
    Añadir un log para el cache <?php echo $this->_tpl_vars['cachelink']; ?>
...
" target="_blank"><?php echo $this->_tpl_vars['gcwp']; ?>
    ...
    <tr>
        <td valign="top">Recomendación:</td>
        <td valign="top">
            <?php if (( $this->_tpl_vars['ratingallowed'] == true || $this->_tpl_vars['israted'] == true )): ?><input type="hidden" name="ratingoption" value="1"><input type="checkbox" id="rating" name="rating" value="1" class="checkbox" <?php if ($this->_tpl_vars['israted'] == true): ?>checked<?php endif; ?>/>&nbsp;<label for="rating">Este cache es uno de mis recomendaciones.</label><br />
                Usted ha usado <?php echo $this->_tpl_vars['givenratings']; ?>
 recomendaciones <?php echo $this->_tpl_vars['maxratings']; ?>
 posibles.
            <?php else: ?>
                Necesitas <?php echo $this->_tpl_vars['foundsuntilnextrating']; ?>
 encuentros adicionales, para realizar otra recomendación.
                <?php if (( $this->_tpl_vars['givenratings'] > 0 && $this->_tpl_vars['givenratings'] == $this->_tpl_vars['maxratings'] && $this->_tpl_vars['israted'] == false )): ?><br />Opcionalmente puedes recuperar uno de las <a href="mytop5.php">recomendaciones</a> existente.<?php endif; ?>
            <?php endif; ?>
            <noscript><br />¡Una recomendación sólo puede hacerse dentro de un registro como encontrado!</noscript>
        </td>
    </tr>
    <?php endif; ?>
</table>
    ...
    <tr>
        <td colspan="2">
            <div class="menuBar">
                ...
                <span class="buttonSplitter">|</span>
                <span id="descText" class="buttonNormal" onclick="btnSelect(1)" onmouseover="btnMouseOver(1)" onmouseout="btnMouseOut(1)">Texto</span>
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <span id="scriptwarning" class="errormsg">JavaScript está desactivado en su navegador, puede introducir sólo texto. Para utilizar HTML, o el editor, por favor, habilite JavaScript.</span>
        </td>
    </tr>
    <tr>
        <td>
...
?><?php echo ''; ?><?php if ($this->_tpl_vars['smiley']['show']): ?><?php echo '<a href="javascript:insertSmiley(\''; ?><?php echo $this->_tpl_vars['smiley']['text']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['smileypath']; ?><?php echo ''; ?><?php echo $this->_tpl_vars['smiley']['file']; ?><?php echo '\')">'; ?><?php echo $this->_tpl_vars['smiley']['image']; ?><?php echo '</a> &nbsp;'; ?><?php endif; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo ''; ?>
    ...
    <tr>
        <td colspan="2">Palabra Calve para registro:
            <input class="input100" type="text" name="log_pw" maxlength="20" value="" /> <?php if (! $this->_tpl_vars['validate']['logPw']): ?><span class="errormsg">¡Palabra Clave incorrecta!</span><?php else: ?>(<?php if ($this->_tpl_vars['cachetype'] == 6): ?>only for 'attended' logs<?php else: ?>solo para logs de encontrados<?php endif; ?>)<?php endif; ?>
        </td>
    </tr>
    <tr><td class="spacer" colspan="2"></td></tr>
    <?php endif; ?>
    ...
    <tr>
        <td class="header-small" colspan="2">
            <input type="submit" name="submitform" value="Log de este cache" class="formbutton" onclick="submitbutton('submitform')" />
        </td>
    </tr>
</table>
</form>
