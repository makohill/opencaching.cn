        ...
        <td colspan="2">
            <table class="table">
                <tr class="cachelistheader">
                    ...
                    <th width="630px" colspan="2">Nome</th>
                    <th></th>
                </tr>
...
unset($_smarty_tpl_vars);
 ?></td>
                        <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
"><nobr>[<a href="javascript:if(confirm('Vuoi veramente cancellare?'))location.href='ignore.php?cacheid=<?php echo $this->_tpl_vars['ignoreItem']['cacheid']; ?>
&action=removeignore&target=myignores.php'">do not ignore</a>]</nobr></td>
                    </tr>
                <?php endforeach; else: ?>
                    <tr><td colspan="4"><br />Non ci sono geocache ignorate.</td></tr>
