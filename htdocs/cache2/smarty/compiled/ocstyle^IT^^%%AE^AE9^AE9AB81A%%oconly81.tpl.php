...
<div class="content-txtbox-noshade" style="padding-right: 25px;">
    <p class="article">
        <b>OConly-81</b> &egrave; una nuova sfida che prevede il ritrovamento di cache OConly in diverse condizioni, cio&egrave; con valutazioni di terreno e difficolt&agrave; differenti. Per partecipare, puoi abilitare le staticìstiche OConly-81 nellle tue <a href="mydetails.php">impostazioni profilo utente</a>.<br />
    </p>
...
/images/profile/32x22-profile.png" style="margin-right: 10px;" width="32" height="22"  />
            ...
            <?php if (! $this->_tpl_vars['showall'] && ( count($this->_tpl_vars['users']) > $this->_tpl_vars['default_maxusers'] )): ?>
                &nbsp; <span class="content-title-link">[<a href="oconly81.php?showall=1">Mostra tutto</a>]</span>
            <?php endif; ?>
        </p>
    </div>

    <p>
        Utenti con statistiche OConly-81:
    </p>
...
/images/cacheicon/22x20-traditional.png" style="margin-right: 10px;" width="22" height="20"  />
    ...
    <p>
        Distribuzione terreno e difficolt&agrave; delle cache OConly attive:
    </p>
