...
<?php if ($this->_tpl_vars['deleted'] == true): ?>
    <div class="content-txtbox-noshade">
        <p style="line-height: 1.6em;"><span style="color: red">La tua raccomandazione per "<a href="viewcache.php?wp=<?php echo $this->_tpl_vars['deletedItem']['wp']; ?>
        ...
        <td colspan="2">
            <table class="table">
                <tr class="cachelistheader">
                    ...
                    <th width="100px"><nobr>Raccomandato su</nobr></th>
                    <th></th>
                </tr>
...
" style="text-align:center"><?php echo ((is_array($_tmp=$this->_tpl_vars['ratingItem']['rating_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['date']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['date'])); ?>
                        ...
                        <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
"><nobr>[<a href="javascript:if(confirm('Vuoi veramente rimuovere questa raccomandazione?'))location.href='mytop5.php?action=delete&amp;cacheid=<?php echo $this->_tpl_vars['ratingItem']['cacheid']; ?>
'">Rimuovi raccomandazione</a>]</nobr></td>
                    </tr>
                <?php endforeach; else: ?>
                    <tr><td colspan="3"><br />Non hai raccomandato geocache.</td></tr>
