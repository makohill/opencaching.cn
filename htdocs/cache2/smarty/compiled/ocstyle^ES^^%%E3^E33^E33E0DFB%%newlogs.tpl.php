...
/images/cacheicon/traditional.gif" style="margin-right: 10px;" width="32" height="32" alt="" />
        <?php if ($this->_tpl_vars['ownerlogs']): ?>
            <?php if ($this->_tpl_vars['ownlogs']): ?>
                Log entries for your geocaches
            <?php else: ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['ownername'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                Newest log entries for caches of <?php echo $this->_smarty_vars['capture']['ownerlink']; ?>

            <?php endif; ?>
        <?php else: ?>
            Sus entradas de Logs
        <?php endif; ?>
    </div>
<?php else: ?>
    ...
    <table cellspacing="0" cellpadding="0" style="width:98.1%">
        <tr>
            <td class="nav4">
                <ul>
                    <li class="group noicon <?php if ($this->_tpl_vars['countryCode'] === ''): ?>selected<?php endif; ?>"><a href="newlogs.php">Todos los nuevo logs</a></li>
...
">Nuevo logs en <?php echo $this->_tpl_vars['countryName']; ?>
</a>
                    <li class="group noicon <?php if ($this->_tpl_vars['rest']): ?>selected<?php endif; ?>"><a href="newlogsrest.php">Nuevo logs sin <?php echo $this->_tpl_vars['mainCountryName']; ?>
</a></li>
                </ul>
            </td>
 ...
 ?>
    ...
    <?php if ($this->_tpl_vars['ownerlogs'] && $this->_tpl_vars['ownlogs']): ?>
        <?php if ($this->_tpl_vars['show_own_logs']): ?>
            <a class="systemlink" href="ownerlogs.php?ownlogs=0">Hide own logs</a>
        <?php else: ?>
            <a class="systemlink" href="ownerlogs.php?ownlogs=1">Show own logs</a>
        <?php endif; ?>
    <?php endif; ?>
</p>
...
/images/oclogo/oc-team-comment.png" alt="OC-Team" title="OC team comment" /><?php endif; ?>
                <?php ob_start(); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['newLog']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 encontrados <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 2): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 no encontrados <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 3): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 escrito una nota por <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 7): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 visitas <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 8): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 quieren visitar <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 9): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 has archived <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 10): ?>
                    <?php if ($this->_tpl_vars['newLog']['oc_team_comment']): ?>
                        <?php echo $this->_smarty_vars['capture']['username']; ?>
 has activated <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                    <?php else: ?>
                        <?php echo $this->_smarty_vars['capture']['username']; ?>
 has maintainted <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                    <?php endif; ?>
                <?php elseif ($this->_tpl_vars['newLog']['type'] == 11): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 has disabled <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 13 || $this->_tpl_vars['newLog']['type'] == 14): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 has locked <?php echo $this->_smarty_vars['capture']['cachename']; ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php endforeach; else: ?>
        <?php if ($this->_tpl_vars['ownerlogs']): ?>
            <p>There are no log entries yet for your geocaches.</p>
        <?php endif; ?>
