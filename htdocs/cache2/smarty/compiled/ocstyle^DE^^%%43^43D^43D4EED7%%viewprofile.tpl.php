...
/images/misc/32x32-home.png" style="margin-right: 10px;" width="32" height="32" />
    Benutzerprofil von <?php echo $this->_tpl_vars['username']; ?>
...
"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/16x16-email.png" width="16" height="16" border="0" alt="E-Mail senden" align="middle" /></a>&nbsp;
    [<a href="mailto.php?userid=<?php echo $this->_tpl_vars['userid']; ?>
">E-Mail senden</a>]
</div>
...
<table class="table">
    ...
    <tr>
        <td style="vertical-align:top"><b>Letzter&nbsp;Login:</b></td>
        <?php if ($this->_tpl_vars['lastlogin'] == 1): ?>
            <td>Innerhalb des letzten Monats</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 2): ?>
            <td>vor 1&ndash;6 Monaten</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 3): ?>
            <td>vor 6&ndash;12 Monaten</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 4): ?>
            <td>vor 1&ndash;2 Jahren</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 5): ?>
            <td>vor mehr als 2 Jahren</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 7): ?>
            <?php if ($this->_tpl_vars['license_actively_declined']): ?>
                <td>Das Benutzerprofil wurde deaktiviert, weil der Benutzer die <a href="articles.php?page=impressum#datalicense">Datenlizenz</a> abgelehnt hat. Cachebeschreibungen, Logtexte und Bilder des Benutzers wurden entfernt.</td>
            <?php elseif ($this->_tpl_vars['license_passively_declined']): ?>
                <td>Der Benutzeraccount wurde deaktiviert. Cachebeschreibungen, Logtexte und Bilder des Benutzers wurden entfernt, weil die Deaktivierung vor der Umstellung auf die <a href="articles.php?page=impressum#datalicense">neue Datenlizenz</a> stattfand.</td>
            <?php else: ?>
                <td>Der Benutzeraccount wurde deaktiviert.</td>
            <?php endif; ?>
        <?php else: ?>
            <td>unknown</td>
        <?php endif; ?>
...
<span></span>:</b></td>
    ...
    <?php if ($this->_tpl_vars['pmr'] == 1): ?>
        <tr>
            <td style="vertical-align:top;"><b>Sonstiges:</b></td>
            <td>
                Ich nehme ein PMR-Funkgerät auf Kanal 2 mit zum Geocaching.<br />
            </td>
        </tr>
    <?php endif; ?>
    ...
    <?php else: ?>
        <tr>
            <td valign="middle" class="header-small" style="white-space:nowrap" width="1%">
                ...
                &nbsp;<b>OConly-81-Statistik:</b>
            </td>
            <td valign="middle">
                inaktiv (<a href="oconly81.php">Info</a>)
            </td>
        </tr>
        <tr><td class="spacer"></td></tr>
        <tr><td class="spacer"></td></tr>
...
#eocl"><?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?>nicht beobachten<?php else: ?>beobachten<?php endif; ?></a>]<?php endif; ?>
                </li>
            <?php endforeach; endif; unset($_from); ?>
        </ul>
        <br id="eocl" />
