...
/images/viewcache/16x16-watch.png" title="I am watching this list." /><?php endif; ?>
            <?php if ($this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid']): ?>por <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cachelist']['user_id']; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>$&creationdate=1<?php endif; ?>">Salvar opción</a>]</span>
...
">Editar opción</a>]</span><?php endif; ?></p>
        </td>
    </tr></table>
</div>
...
unset($_smarty_tpl_vars);
 ?></td>
                        <td style="text-align:right; padding:0; margin:0">Descargar<span></span>:&nbsp;</td>
                        <td><nobr>
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Resultados de esta página</option>
...
">TXT</option>
                            ...
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Resultado <?php echo $this->_tpl_vars['startatp1']; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>&creationdate=1<?php endif; ?>">
                    ...
                    <th width="90">
                        <?php if ($this->_tpl_vars['creationdate']): ?>
                            <?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bycreated&sortorder='; ?><?php if ($this->_tpl_vars['sortby'] != 'bycreated' || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo '"><nobr>Listado desde'; ?><?php if ($this->_tpl_vars['sortby'] == 'bycreated'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>&nbsp;&nbsp;'; ?>
...
unset($_smarty_tpl_vars);
 ?></td>
    ...
    <table width="100%">
        <tr>
            <td style="text-align:right; width:50%">Descargar<span></span>:&nbsp;&nbsp;</td>
            <td align="right" style="padding-right:20px; white-space:nowrap">
                <b>Resultados en la página:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Formato .gpx">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Fichero waypoint .loc">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
" title="TOP50 Overlay .ovl">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Fichero de texto .txt">TXT</a>
                <br />
                <b>Resultado <?php echo $this->_tpl_vars['startatp1']; ?>
 a <?php echo $this->_tpl_vars['endat']; ?>
 (como zip)<span></span>:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Formato .gpx">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Fichero waypoint .loc">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
&count=max&zip=1" title="TOP50 Overlay .ovl">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Fichero de texto .txt">TXT</a>
            </td>
        </tr>
        <tr>
            <td class="help" colspan="2" align="right" style="line-height:2em;">
                Al descargar este archivo está de acuerdo con la <a href="articles.php?page=impressum#tos">condiciones de uso</a> di Opencaching.de.&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <?php endif; ?>
