...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'tops.tpl', 35, false),array('modifier', 'lower', 'tops.tpl', 35, false),array('modifier', 'urlencode', 'tops.tpl', 40, false),)), $this); ?>
...
<table class="table">
    <tr>
        <td style="padding-bottom:20px;">
            La lista se actualizará automáticamente basado en las recomendaciones de nuestros usuarios. Más información sobre la división regional se puede en el <?php echo $this->_tpl_vars['helppagelink']; ?>
Wiki</a>.<br />
<br />
...
<img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="" /> Número de hallazgos del Geocache<br />
El índice es el número dos en relación a determinar el mejor Geocache<br />
<img src="images/tops-formula.png" border="0" alt="Formel" />
        </td>
    </tr>
    <tr>
...
<?php endif; ?>"></a>
        ...
        <table class="table">
            <tr>
                <td style="text-align:right"><b>Indice</b></td>
                <td style="text-align:right"><img src="images/rating-star.gif" border="0" alt="Recomendaciones" /></td>
                <td style="text-align:right"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="encuentran" /></td>
                <td></td>
                <td>&nbsp;</td>
            </tr>
    <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?> por <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['topItem']['userid']; ?>
