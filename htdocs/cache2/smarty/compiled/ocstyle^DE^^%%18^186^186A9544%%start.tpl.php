...
/images/misc/32x32-news.png" style="margin-right: 10px;" width="24" height="24" alt="" />
                        <a href="http://blog.opencaching.de/" style="color:rgb(88,144,168); text-decoration: none;">Aktuelles</a>
                        &nbsp; <span class="content-title-link">[<a href="http://blog.opencaching.de/">mehr...</a>]</span>
                    </p>
                </td>
...
unset($_smarty_tpl_vars);
 ?>
<?php else: ?>
        <p><em>zurzeit nicht verfügbar</em></p>
<?php endif; ?>
    </div>
    <div class="buffer" style="width: 500px;">&nbsp;</div>
<?php endif; ?>
...
/images/cacheicon/event.gif" style="margin-right: 10px;" width="24" height="24" alt="" />
        Die nächsten Events in <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

        <?php if ($this->_tpl_vars['total_events'] > count($this->_tpl_vars['events'])): ?>
            &nbsp; <span class="content-title-link">[<a href="newcaches.php?cachetype=6">mehr...</a>]</span>
        <?php endif; ?>
    </p>
</div>
...
/images/misc/32x32-pictures.gif" style="margin-right: 10px;" width="24" height="24" />
        <a href="newlogpics.php" style="color:rgb(88,144,168); text-decoration: none;">Neue Logbilder</a>
    &nbsp; <span class="content-title-link">[<a href="newlogpics.php">mehr...</a>]</span>
    </p>
</div>
...
/images/misc/32x32-winner.png" style="margin-right: 10px;" width="24" height="24" alt="" />
        <a href="tops.php" style="color:rgb(88,144,168); text-decoration: none;">Aktuelle Empfehlungen</a>
    </p>
</div>
<p style="line-height: 1.6em;">Geocaches mit den meisten Empfehlungen innerhalb der letzten <?php echo $this->_tpl_vars['toprating_days']; ?>
 Tage in <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
.</p>
...
" style="color: rgb(88, 144, 168); text-decoration: none;">Aktuelle Forenthemen (<?php echo ((is_array($_tmp=$this->_tpl_vars['phpbb_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
):</a>
        </p>
    </div>
    <div id="forum">
...
" style="color:rgb(88,144,168); text-decoration: none;">Neueste Caches in <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>
    &nbsp; <span class="content-title-link">[<a href="newcaches.php">mehr...</a>]</span>
    </p>
</div>
<p style="line-height: 1.6em;">(Insgesamt <?php echo $this->_tpl_vars['count_hiddens']; ?>
 aktive Caches und <?php echo $this->_tpl_vars['count_founds']; ?>
 Funde von <?php echo $this->_tpl_vars['count_users']; ?>
 Benutzern)</p>
<div class="content2-section-no-p">
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
