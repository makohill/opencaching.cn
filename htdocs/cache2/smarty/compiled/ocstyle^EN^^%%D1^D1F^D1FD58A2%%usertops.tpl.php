...
/images/misc/<?php if ($this->_tpl_vars['oconly']): ?>is_oconly_small.png<?php else: ?>32x32-winner.png<?php endif; ?>" style="margin-right: 10px;" <?php if (! $this->_tpl_vars['oconly']): ?>width="32" height="32" alt=""<?php endif; ?> />
    Recommendations of <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['userid']; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?> by <?php echo ((is_array($_tmp=$this->_tpl_vars['ratingItem']['ownername'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
                        <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
...
unset($_smarty_tpl_vars);
 ...
 has not recommended any geocache.</td></tr>
