...
unset($_smarty_tpl_vars);
 ?>
                    ...
                    <td align="left" valign="top" width="99%">
                        ...
                        <span style="font-weight:400">&nbsp;di <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span><br />
...
/images/description/22x22-location.png"  width="22" height="22" border="0" alt="" title="" align="left" />&nbsp;
                        ...
                        <table class="print-cachemeta" cellspacing="0" cellpadding="0">
                            <tr><td>Dimensioni:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['sizeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /></td></tr>
                        <?php if ($this->_tpl_vars['cache']['searchtime'] > 0): ?>
                            <tr><td><nobr>Tempo necessario:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['searchtime'])) ? $this->_run_mod_handler('format_hour', true, $_tmp) : smarty_modifier_format_hour($_tmp)); ?>

                                h<?php if ($this->_tpl_vars['cache']['waylength'] > 0): ?>, &nbsp;Tragitto <?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km<?php endif; ?>
                            </nobr></td>
                        <?php elseif ($this->_tpl_vars['cache']['waylength'] > 0): ?>
                            <tr><td><nobr>Lunghezza percorso:</td><td><?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km</nobr></td></tr>
                        <?php endif; ?>
                        <?php if ($this->_tpl_vars['cache']['status'] != 1): ?>
                            <tr><td>Stato:</td><td><span class="errormsg"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span></td></tr>
                        <?php else: ?>
                            <tr><td>Stato:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td></tr>
                        <?php endif; ?>
                        <tr><td>Nascosta il:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datehidden'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td><?php if ($this->_tpl_vars['cache']['is_publishdate'] == 0): ?>Pubblicata dal:<?php else: ?>Pubblicata il:<?php endif; ?></td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datecreated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td>Ultimo aggiornamento:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['lastmodified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>

                        <?php if ($this->_tpl_vars['cache']['wpgc'] != ''): ?>
                            <tr>
                            <td>Anche pubblicata come:</td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FEFEFE;border:solid 1px black;">
                        <tr>
                            ...
                            <td style="text-align:left; vertical-align:top">
                                Questa geocache è probabilmente situata all'interno di un'area naturale protetta! Per favore, vedi <?php echo $this->_tpl_vars['opt']['cms']['npa']; ?>
...
<?php if (! ($this->_foreach['npaareas']['iteration'] == $this->_foreach['npaareas']['total'])): ?>,<?php endif; ?>
    ...
    <?php if (count ( $this->_tpl_vars['npaareasNoWarning'] ) > 0): ?>
        <tr>
            <td>
                <font size="2">
                    Questa geocache probabilmente è situata in una riserva naturale:
