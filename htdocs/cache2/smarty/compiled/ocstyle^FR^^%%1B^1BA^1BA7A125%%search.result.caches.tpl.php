...
<?php if ($this->_tpl_vars['cachelist'] || $this->_tpl_vars['query_name']): ?>
    <div class="content2-container cachelistinfo" style="margin-top:10px" >
        <?php if ($this->_tpl_vars['query_name']): ?>
            ...
            <a class="systemlink" href="query.php">Requête mémorisée</a> <b><?php echo ((is_array($_tmp=$this->_tpl_vars['query_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b>
            </p>
        <?php endif; ?>
        <?php if ($this->_tpl_vars['cachelist']): ?>
            ...
            <a class="systemlink" href="cachelists.php">Liste de cache</a> <b><?php echo ((is_array($_tmp=$this->_tpl_vars['cachelist']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b>
...
/images/viewcache/cache-rate.png" title="Je l'ai signet cette liste." /></a><?php endif; ?>
            <?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-watch.png" title="Je regarde cette liste." /><?php endif; ?>
            <?php if ($this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid']): ?>par <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cachelist']['user_id']; ?>
...
/images/action/18x16-offer.png" /></a><?php else: ?>privé<?php endif; ?>)<?php endif; ?>
...
'); cl.style.display = (cl.style.display=='none'?'block':'none'); getElementById('permalink_text_<?php echo $this->_tpl_vars['cachelist']['id']; ?>
').select();" >partager liste publique <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
&fromsearch=1">éditer</a>]<?php endif; ?>
            <?php if ($this->_tpl_vars['login']['userid']): ?>[<a class="systemlink" href="cachelist.php?id=<?php echo $this->_tpl_vars['cachelist']['id']; ?>
&<?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?>dont<?php endif; ?>watch"><?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?>ne regarde pas<?php else: ?>regarder<?php endif; ?></a>]<?php endif; ?>
...
&bookmark">signet</a>]<?php endif; ?>
            <?php if ($this->_tpl_vars['login']['userid'] && $this->_tpl_vars['cachelist']['bookmarked'] && $this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid']): ?>[<a class="systemlink" href="cachelist.php?id=<?php echo $this->_tpl_vars['cachelist']['id']; ?>
&unbookmark">ne pas signet</a>]<?php endif; ?>
            </p>
        <?php endif; ?>
...
&output=map2bounds&showresult=1&skipqueryid=1&expert=0&utf8=1">montrer sur la carte</a></p>
            </td>
        <?php endif; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>$&creationdate=1<?php endif; ?>">Enregistrer les options</a>]</span>
...
">Modifier les options</a>]</span><?php endif; ?></p>
        </td>
    </tr></table>
</div>
...
unset($_smarty_tpl_vars);
 ?></td>
                        <td style="text-align:right; padding:0; margin:0">Télécharger&nbsp;:&nbsp;</td>
                        <td><nobr>
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Résultats sur cette page</option>
...
">TXT</option>
                            ...
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Résultat <?php echo $this->_tpl_vars['startatp1']; ?>
 à <?php echo $this->_tpl_vars['endat']; ?>
 (comme zip)</option>
                                <option value="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>&creationdate=1<?php endif; ?>">
                    ...
                    <th width="90">
                        <?php if ($this->_tpl_vars['creationdate']): ?>
                            <?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bycreated&sortorder='; ?><?php if ($this->_tpl_vars['sortby'] != 'bycreated' || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo '"><nobr>Listé depuis'; ?><?php if ($this->_tpl_vars['sortby'] == 'bycreated'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>&nbsp;&nbsp;'; ?>
                    ...
                    <th width="90">
                        <?php echo ''; ?><?php if ($this->_tpl_vars['displayownlogs']): ?><?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bymylastlog&sortorder='; ?><?php if (( $this->_tpl_vars['sortby'] != 'bymylastlog' && $this->_tpl_vars['sortby'] != 'bylastlog' ) || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['creationdate']): ?><?php echo '&creationdate=1'; ?><?php endif; ?><?php echo '"><nobr>Logs propres'; ?><?php if ($this->_tpl_vars['sortby'] == 'bymylastlog'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>'; ?><?php else: ?><?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bylastlog&sortorder='; ?><?php if (( $this->_tpl_vars['sortby'] != 'bymylastlog' && $this->_tpl_vars['sortby'] != 'bylastlog' ) || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['creationdate']): ?><?php echo '&creationdate=1'; ?><?php endif; ?><?php echo '"><nobr>Derniers logs'; ?><?php if ($this->_tpl_vars['sortby'] == 'bylastlog'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>&nbsp;'; ?><?php endif; ?><?php echo ''; ?>
&nbsp;
                    </th>
                    </tr>
                    <tr><td></td></tr>
...
unset($_smarty_tpl_vars);
 ?></td>
    ...
    <table width="100%">
        <tr>
            <td style="text-align:right; width:50%">Télécharger&nbsp;:&nbsp;&nbsp;</td>
            <td align="right" style="padding-right:20px; white-space:nowrap">
                <b>Résultats sur cette page&nbsp;:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="GPS Exchange Format .gpx">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Fichier waypoint .loc">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
" title="TOP50-Overlay .ovl">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Fichier text .txt">TXT</a>
                <br />
                <b>Résultat <?php echo $this->_tpl_vars['startatp1']; ?>
 à <?php echo $this->_tpl_vars['endat']; ?>
 (comme zip)&nbsp;:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="GPS Exchange Format .gpx">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Fichier waypoint .loc">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
&count=max&zip=1" title="TOP50-Overlay .ovl">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Fichier text .txt">TXT</a>
            </td>
        </tr>
        <tr>
            <td class="help" colspan="2" align="right" style="line-height:2em;">
                Avec le téléchargement, vous acceptez les <a href="articles.php?page=impressum#tos">conditions d'usage</a> d'Opencaching.de.&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <?php endif; ?>
