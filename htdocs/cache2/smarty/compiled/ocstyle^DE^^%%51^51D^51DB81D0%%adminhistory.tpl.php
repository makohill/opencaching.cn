...
<form method="POST" action="adminhistory.php">
    <p>
        ...
        <input type="submit" name="submitform" value="anzeigen" class="formbutton" onclick="submitbutton('submitform')" />
    </p>
</form>
<?php endif; ?>
...
/images/misc/32x32-tools.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                <?php if ($this->_tpl_vars['reportdisplay']): ?>    Weitere Meldungen für diesen Cache<?php else: ?>Cachemeldungen<?php endif; ?>
            </p>
        </div>
...
/images/description/22x22-logs.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                Gelöschte Logs <small>seit Löschdatum Februar 2012</small>
            </p>
        </div>
...
/images/viewcache/16x16-maintenance.png" style="margin-right: 10px;" width="16" height="16" alt="" />
                Statusänderungen <small>seit Juni 2013</small>
            </p>
        </div>
...
/images/profile/32x32-adopt.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                Adoptionen <small>seit September 2012</small>
            </p>
        </div>
