...
/images/viewcache/16x16-watch.png" title="I am watching this list." /><?php endif; ?>
            <?php if ($this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid']): ?>di <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cachelist']['user_id']; ?>
...
<div class="content2-container bg-blue02" style="margin-top:20px;">
 ...
 cache <span style="<?php echo $this->_tpl_vars['showmatched']; ?>
">trovate</span>&nbsp;</p>
        </td>
...
&output=map2bounds&showresult=1&skipqueryid=1&expert=0&utf8=1">Vedi sulla mappa</a></p>
            </td>
        <?php endif; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>$&creationdate=1<?php endif; ?>">Salva opzioni</a>]</span>
...
">Modifica opzioni</a>]</span><?php endif; ?></p>
        </td>
    </tr></table>
</div>
...
unset($_smarty_tpl_vars);
 ?></td>
                        <td style="text-align:right; padding:0; margin:0">Scarica<span></span>:&nbsp;</td>
                        <td><nobr>
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Risultati su questa pagina</option>
...
">TXT</option>
                            ...
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Risultati <?php echo $this->_tpl_vars['startatp1']; ?>
 a <?php echo $this->_tpl_vars['endat']; ?>
 (come zip)</option>
                                <option value="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>&creationdate=1<?php endif; ?>">
                    ...
                    <th width="90">
                        <?php if ($this->_tpl_vars['creationdate']): ?>
                            <?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bycreated&sortorder='; ?><?php if ($this->_tpl_vars['sortby'] != 'bycreated' || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo '"><nobr>Pubblicata dal'; ?><?php if ($this->_tpl_vars['sortby'] == 'bycreated'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>&nbsp;&nbsp;'; ?>
                    ...
                    <th width="90">
                        <?php echo ''; ?><?php if ($this->_tpl_vars['displayownlogs']): ?><?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bymylastlog&sortorder='; ?><?php if (( $this->_tpl_vars['sortby'] != 'bymylastlog' && $this->_tpl_vars['sortby'] != 'bylastlog' ) || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['creationdate']): ?><?php echo '&creationdate=1'; ?><?php endif; ?><?php echo '"><nobr>Logs propri'; ?><?php if ($this->_tpl_vars['sortby'] == 'bymylastlog'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>'; ?><?php else: ?><?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bylastlog&sortorder='; ?><?php if (( $this->_tpl_vars['sortby'] != 'bymylastlog' && $this->_tpl_vars['sortby'] != 'bylastlog' ) || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['creationdate']): ?><?php echo '&creationdate=1'; ?><?php endif; ?><?php echo '"><nobr>Ultimo log'; ?><?php if ($this->_tpl_vars['sortby'] == 'bylastlog'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>&nbsp;'; ?><?php endif; ?><?php echo ''; ?>
&nbsp;
                    </th>
                    </tr>
                    <tr><td></td></tr>
...
unset($_smarty_tpl_vars);
 ?></td>
    ...
    <table width="100%">
        <tr>
            <td style="text-align:right; width:50%">Scarica<span></span>:&nbsp;&nbsp;</td>
            <td align="right" style="padding-right:20px; white-space:nowrap">
                <b>Risultati su questa pagina:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Formato di scambio GPS (.gpx)">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="File waypoint (.loc)">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
" title="TOP50 Overlay (.ovl)">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="File di testo (.txt)">TXT</a>
                <br />
                <b>Risultati <?php echo $this->_tpl_vars['startatp1']; ?>
 a <?php echo $this->_tpl_vars['endat']; ?>
 (come zip)<span></span>:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Formato di scambio GPS (.gpx)">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="File waypoint (.loc)">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
&count=max&zip=1" title="TOP50 Overlay (.ovl)">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="File di testo (.txt)">TXT</a>
            </td>
        </tr>
        <tr>
            <td class="help" colspan="2" align="right" style="line-height:2em;">
                Scaricando il file accetti le <a href="articles.php?page=impressum#tos">condizioni d'uso</a> di Opencaching.de.&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <?php endif; ?>
