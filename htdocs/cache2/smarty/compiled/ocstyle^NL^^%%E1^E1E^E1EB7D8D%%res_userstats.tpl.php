...
/images/cacheicon/22x20-traditional.png" width="22" height="20" align="middle" border="0" style="padding-right:2px" />&nbsp;<b>Gemaakte caches:</b></td>
...
&amp;searchbyowner=&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]<?php if ($this->_tpl_vars['hidden_active'] < $this->_tpl_vars['hidden']): ?>, &nbsp;<?php echo $this->_tpl_vars['hidden_active']; ?>
...
&amp;searchbyowner=&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]<?php endif; ?><?php endif; ?><?php endif; ?>
        </td>
    </tr>
...
&amp;searchbyfinder=&amp;logtype=1,7&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]<?php endif; ?>
        </td>
    </tr>
...
.gif" />
        ...
        <tr>
            ...
            <img src="resource2/ocstyle/images/log/16x16-dnf.png" />&nbsp;&nbsp;&nbsp;<b>Niet gevonden<span></span>:</b></td>
...
&amp;searchbyfinder=&amp;logtype=2&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]<?php endif; ?>
            </td>
        </tr>
        <tr>
            <td valign="middle" class="header-small" style="padding-bottom:5px;white-space:nowrap">
            <img src="resource2/ocstyle/images/log/16x16-note.png" />&nbsp;&nbsp;&nbsp;<b>Opmerkingen<span></span>:</b></td>
...
&amp;searchbyfinder=&amp;logtype=3&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]<?php endif; ?>
            </td>
        </tr>
...
&amp;searchbyfinder=&amp;logtype=9,10,11,13,14&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]
            </td>
        </tr>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <tr>
        <td valign="middle" class="header-small" style="padding-bottom:5px;white-space:nowrap">
        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/rating-star.gif" align="middle" border="0" style="padding-right:2px" />&nbsp;&nbsp;<b>Aanbevelingen<span></span>:</b></td>
        <td class="header-small" ><?php if ($this->_tpl_vars['maxrecommended'] !== null): ?><?php echo $this->_tpl_vars['recommended']; ?>
 van <?php echo $this->_tpl_vars['maxrecommended']; ?>
 mogelijkheden<?php else: ?><?php echo $this->_tpl_vars['recommended']; ?>
<?php endif; ?> <?php if ($this->_tpl_vars['recommended'] > 0): ?>&nbsp;[<a href="usertops.php?userid=<?php echo $this->_tpl_vars['userid']; ?>
<?php if ($this->_tpl_vars['oconly']): ?>&oconly=1<?php endif; ?>">Show</a>]<?php endif; ?>
        </td>
    </tr>
    ...
    <?php if ($this->_tpl_vars['show_picstat'] && $this->_tpl_vars['logpics'] !== null): ?>
        <tr>
            <td class="header-small">
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/action/16x16-addimage.png" align="middle" border="0" />&nbsp;&nbsp;&nbsp;<b>Log pictures<span></span>:</b></td>
