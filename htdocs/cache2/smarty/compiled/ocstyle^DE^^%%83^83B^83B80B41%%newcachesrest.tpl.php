...
<div class="nav4">
    <ul>
        <li class="group noicon"><a href="newcaches.php">Alle Caches</a></li>
        <li class="group noicon"><a href="newcaches.php?country=<?php echo $this->_tpl_vars['userCountryCode']; ?>
">Caches in <?php echo $this->_tpl_vars['userCountryName']; ?>
</a></li>
        <li class="group noicon selected"><a href="newcachesrest.php">Neue Caches ohne <?php echo $this->_tpl_vars['countryName']; ?>
</a></li>
    </ul>
</div>
<p style="clear:both;" >
