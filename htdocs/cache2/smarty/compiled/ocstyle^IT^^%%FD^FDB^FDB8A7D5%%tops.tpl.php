...
<table class="table">
    <tr>
        <td style="padding-bottom:20px;">
            Questa lista è generata automaticamente sulla base delle raccomandazioni degli utenti. Puoi trovare maggiori informazioni sulla classificazione regionale nell <?php echo $this->_tpl_vars['helppagelink']; ?>
Wiki</a>.<br /> <br /> I numeri nella lista qui sotto significano:<br /> <img src="images/rating-star.gif" border="0" alt="Recommendations" /> Numbero di utenti che raccomandano questa cache<br /> <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="Found" /> Checks = Numero di volte in cui la cache è stata trovata<br /> L' indice cerca di ordinare il numero di raccomandazioni e i ritrovamenti in modo da visualizzare per prime 'le migliori' geocache.<br /> <img src="images/tops-formula.png" border="0" alt="Formula" />
        </td>
    </tr>
    <tr>
...
<?php endif; ?>"></a>
        ...
        <table class="table">
            <tr>
                ...
                <td style="text-align:right"><img src="images/rating-star.gif" border="0" alt="Raccomandazioni" /></td>
                <td style="text-align:right"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="trovata" /></td>
                <td></td>
                <td>&nbsp;</td>
            </tr>
    <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?> di <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['topItem']['userid']; ?>
