...
<div class="nav4">
    <ul>
        <li class="group noicon"><a href="newcaches.php">Tutte le cache</a></li>
...
">Caches in  <?php echo $this->_tpl_vars['userCountryName']; ?>
        ...
        <li class="group noicon selected"><a href="newcachesrest.php">Nuovi caches senza <?php echo $this->_tpl_vars['countryName']; ?>
</a></li>
    </ul>
</div>
<p style="clear:both;" >
