...
"><?php echo $this->_tpl_vars['languageItem']; ?>
    ...
    <p>
        Traduzione rapida<br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=quicknone">Disabilita</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=quicknew">Abilita - nuova</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=quickall">Abilita - tutto</a><br />
        <br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=scan">Scan codice sorgente</a><br />
        <br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=listnew">Visualizza nuove traduzioni</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=listall">Visualizza tutte le traduzioni</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=listfaults">Visualizza traduzioni non più referenziate</a><br />
        <br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=verify">Show inconsistencies</a> (EN)<br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=clearcache">Pulisci la cache</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=resetids">Riordina gli ID</a> (prima di una esportazione)<br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=export">Esportazione SQL</a><br />
        <br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=xmlexport">Scarica XML</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=xmlimport">Importa XML</a><br />
        <br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=textexportnew">Scarica testo (nuova) <?php echo $this->_tpl_vars['translang']; ?>
</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=textexportall">Scarica testo (tutto) <?php echo $this->_tpl_vars['translang']; ?>
</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=textimport">Importa testo <?php echo $this->_tpl_vars['translang']; ?>
</a><br />
...
&action=copy_en">Copia EN</a><br />
    ...
    <?php if ($this->_tpl_vars['action'] == 'listnew' || $this->_tpl_vars['action'] == 'listfaults' || $this->_tpl_vars['action'] == 'listall'): ?>
        <?php if ($this->_tpl_vars['action'] == 'listnew'): ?>
            <p>Nuova traduzione:</p>
        <?php elseif ($this->_tpl_vars['action'] == 'listfaults'): ?>
            <p>Traduzioni non più referenziate:</p>
...
?>
 ...
 <?php echo $this->_tpl_vars['refItem']['line']; ?>
                ...
                <tr><td>Utilizza traduzioni esistenti:</td></tr>
                <tr>
                    <td>
                        <table class="table">
                            <?php $_from = $this->_tpl_vars['trans']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" />
            ...
            Il file XML contenete le traduzioni:<br />
            <input name="xmlfile" type="file" size="50" /><br />
            <br />
            Controlla le seguenti lingue nel file XML:<br />
            <?php $_from = $this->_tpl_vars['languages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['languageItem']):
?>
...
" />
            ...
            File di testo contenete la traduzione: <?php echo $this->_tpl_vars['translang']; ?>
<br />
...
" value="1" class="radio" />
                        ...
                        <td>
                            <?php if ($this->_tpl_vars['textItem']['type'] == 1): ?>
                                Codice sorgente modificato, testo non più utilizzato
...
</b> (vecchio) <?php echo ((is_array($_tmp=$this->_tpl_vars['textItem'][$this->_tpl_vars['languageItem']]['old'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
                                </tr>
                            <?php endif; ?>
                            <tr>
...
" />
            ...
            <a href="javascript:toggleAll()">Seleziona tutto</a><br />
            <br />
            <input type="submit" value="Conferma" class="formbuttons"/>
        </form>
...
<?php echo ';
    ...
    <?php elseif ($this->_tpl_vars['action'] == 'scan'): ?>
        <p>
            ...
            <br />File attuale: <span id="currentfile">-</span>
        </p>
