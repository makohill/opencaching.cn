...
<?php if ($this->_tpl_vars['step'] == 1): ?>
    <form method="post" action="restorecaches.php">
        ...
        <br />
        <p><input type="submit" name="find" value="Entrada" class="formbutton" onclick="javascript:submitbutton('find')" /></p>
    </form>
...
" />
                <input type="submit" class="formbutton" value="Volver" onclick="submitbutton('submit')" />
            </form>
        <?php endif; ?>
...
" target="_ocv"><?php echo $this->_tpl_vars['wp']; ?>
            ...
            <?php if ($this->_tpl_vars['disabled'] || $this->_tpl_vars['rootadmin']): ?>
                ...
                <p>
                    <input type="checkbox" name="sure" value="1" /> ¿Seguro? &nbsp;&nbsp;
