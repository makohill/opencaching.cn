...
/images/cacheicon/22x20-traditional.png" width="22" height="20" align="middle" border="0" style="padding-right:2px" />&nbsp;<b>Versteckte Geocaches:</b></td>
...
&amp;searchbyowner=&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">anzeigen</a>]<?php if ($this->_tpl_vars['hidden_active'] < $this->_tpl_vars['hidden']): ?>, &nbsp;davon <?php echo $this->_tpl_vars['hidden_active']; ?>
 aktiv <?php if ($this->_tpl_vars['hidden_active'] > 0): ?>&nbsp;[<a href="search.php?showresult=1&amp;expert=0&amp;f_inactive=1&amp;output=HTML&amp;sort=bycreated&amp;ownerid=<?php echo $this->_tpl_vars['userid']; ?>
&amp;searchbyowner=&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">anzeigen</a>]<?php endif; ?><?php endif; ?><?php endif; ?>
        </td>
    </tr>
    ...
    <?php if ($this->_tpl_vars['show_statistics'] == true): ?>
        <?php if (count($this->_tpl_vars['hidden_by_cachetype'])): ?>
            <tr>
                <td style="padding-left:34px; vertical-align:top; line-height:1.8em">... nach Cachetyp:</td>
                <td>
...
&amp;searchbyfinder=&amp;logtype=1,7&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">anzeigen</a>]<?php endif; ?>
        </td>
    </tr>
...
.gif" />
        ...
        <tr>
            ...
            <img src="resource2/ocstyle/images/log/16x16-dnf.png" />&nbsp;&nbsp;&nbsp;<b>nicht gefunden<span></span>:</b></td>
...
&amp;searchbyfinder=&amp;logtype=2&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">anzeigen</a>]<?php endif; ?>
            </td>
        </tr>
        <tr>
            <td valign="middle" class="header-small" style="padding-bottom:5px;white-space:nowrap">
            <img src="resource2/ocstyle/images/log/16x16-note.png" />&nbsp;&nbsp;&nbsp;<b>Bemerkungen<span></span>:</b></td>
...
&amp;searchbyfinder=&amp;logtype=3&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">anzeigen</a>]<?php endif; ?>
            </td>
        </tr>
        <?php if ($this->_tpl_vars['maintainence'] > 0): ?>
        <tr>
            <td valign="middle" class="header-small" style="padding-bottom:5px;white-space:nowrap">
            <img src="resource2/ocstyle/images/viewcache/16x16-maintenance.png" />&nbsp;&nbsp;&nbsp;<b>Wartungslogs<span></span>:</b></td>
...
&amp;searchbyfinder=&amp;logtype=9,10,11,13,14&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">anzeigen</a>]
            </td>
        </tr>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <tr>
        <td valign="middle" class="header-small" style="padding-bottom:5px;white-space:nowrap">
        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/rating-star.gif" align="middle" border="0" style="padding-right:2px" />&nbsp;&nbsp;<b>Empfehlungen<span></span>:</b></td>
        <td class="header-small" ><?php if ($this->_tpl_vars['maxrecommended'] !== null): ?><?php echo $this->_tpl_vars['recommended']; ?>
 von <?php echo $this->_tpl_vars['maxrecommended']; ?>
 möglichen<?php else: ?><?php echo $this->_tpl_vars['recommended']; ?>
<?php endif; ?> <?php if ($this->_tpl_vars['recommended'] > 0): ?>&nbsp;[<a href="usertops.php?userid=<?php echo $this->_tpl_vars['userid']; ?>
<?php if ($this->_tpl_vars['oconly']): ?>&oconly=1<?php endif; ?>">anzeigen</a>]<?php endif; ?>
        </td>
    </tr>
    ...
    <?php if ($this->_tpl_vars['show_picstat'] && $this->_tpl_vars['logpics'] !== null): ?>
        <tr>
            <td class="header-small">
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/action/16x16-addimage.png" align="middle" border="0" />&nbsp;&nbsp;&nbsp;<b>Logbilder<span></span>:</b></td>
...
&allpics=1">anzeigen</a>]<?php endif; ?>
            </td>
        </tr>
    <?php endif; ?>