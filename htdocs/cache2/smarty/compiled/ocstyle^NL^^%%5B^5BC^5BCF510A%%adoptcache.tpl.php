...
" size="40" /></td>
            ...
            <?php if ($this->_tpl_vars['error'] == 'userunknown'): ?>
                <tr><td>&nbsp;</td><td colspan="2"><span class="errormsg">Gebruikersnaam onbekend</span></td></tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="2">
                    <input type="submit" value="Versturen" class="formbutton" onclick="submitbutton('submit')" />
                </td>
            </tr>
        </table>
    </form>
...
, <strong><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <p style="line-height: 1.6em;">
            <br />
            <input type="checkbox" name="tou" value="1" />
            <label for="tou">Ja, ik heb de <a href="articles.php?page=impressum#tos">gebruikersovereenkomst</a> van Opencaching.nl gelezen en accepteren</label>
        </p>
        ...
        <?php endif; ?>
        <p style="line-height: 1.6em;"><input type="submit" value="Versturen" class="formbutton" onclick="submitbutton('submit')" /></p>
    </form>
<?php endif; ?>