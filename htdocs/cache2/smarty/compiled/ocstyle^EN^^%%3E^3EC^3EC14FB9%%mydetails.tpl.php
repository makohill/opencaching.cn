    ...
    <?php if ($this->_tpl_vars['error'] == true || $this->_tpl_vars['errorlen'] == true): ?>
        <tr>
            <td class="errormsg" colspan="3">
                ...
                <?php if ($this->_tpl_vars['error'] == true): ?>Illegal characters found in<?php echo ((is_array($_tmp=$this->_tpl_vars['errormsg'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /><?php endif; ?>
                <?php if ($this->_tpl_vars['errorlen'] == true): ?>Field values too long in<?php echo ((is_array($_tmp=$this->_tpl_vars['errormsglen'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /><?php endif; ?>
...
" value="1"<?php if ($this->_tpl_vars['useropt']['option_visible'] == 1): ?> checked="checked"<?php endif; ?> class="checkbox" /> show
                ...
                <?php else: ?>
                    <?php if ($this->_tpl_vars['useropt']['internal_use'] != 1): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <!-- <span style="color:#666666;">internal</span> -->
                    <?php endif; ?>
                <?php endif; ?>
            </td>
        </tr>
...
<div style="clear:both"></div></div><?php endif; ?>
            ...
            <tr>
                <td class="header-small" colspan="3">
                    <input type="submit" name="changetext" value="Change" class="formbutton" onclick="flashbutton('changetext')" />
                </td>
            </tr>
        </table>
    </form>
