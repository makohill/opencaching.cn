...
/images/misc/32x32-home.png" border="0" width="32px" height="32px" style="margin-right: 10px;" />
    Ciao <?php echo $this->_tpl_vars['login']['username']; ?>
...
/images/description/22x22-logs.png" width="22" height="22"  style="margin-right: 10px;" />&nbsp;
            Trovate: <?php echo $this->_tpl_vars['found']; ?>
 &nbsp;
...
&amp;searchbyfinder=&amp;f_inactive=0&amp;logtype=1,7&amp;calledbysearch=0">Geocaches trovate</a>]&nbsp; [<a href="search.php?showresult=1&amp;expert=0&amp;output=HTML&amp;sort=bymylastlog&amp;finderid=<?php echo $this->_tpl_vars['login']['userid']; ?>
&amp;searchbyfinder=&amp;f_inactive=0&amp;logtype=0&amp;calledbysearch=0">Geocaches loggate</a>]</span><?php endif; ?>
        </p>
    </div>

        <p style="line-height: 1.6em;"><b>I tuoi ultimi log<?php if ($this->_tpl_vars['morelogs']): ?> </b>(<a class="systemlink" href="ownlogs.php">altre</a>)<span></span>:<?php else: ?><span></span>:</b><?php endif; ?></p>
...
unset($_smarty_tpl_vars);
 ?>
                    di <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['logItem']['userid']; ?>
...
/images/misc/32x32-pictures.gif" width="24" height="24"  style="margin-right: 10px;" />&nbsp;
        Log immagini: <?php echo $this->_tpl_vars['total_pictures']; ?>
 &nbsp;
        <?php if (count($this->_tpl_vars['pictures']) > 0 && ! $this->_tpl_vars['allpics']): ?><span class="content-title-link">[<a href="myhome.php?allpics=1">Mostra tutto</a>]</span><?php endif; ?>
    </p>
</div>

<?php if (count($this->_tpl_vars['pictures']) == 0): ?>
    <p>Non hai ancora caricato nessuna immagine di log.</p>
    <br />
<?php else: ?>
    <p style="line-height: 1.6em;">
        <?php if (! $this->_tpl_vars['allpics']): ?>
             <b>Le tue ultime immagini di log:</b></p>
            <?php $this->assign('maxlines', 1); ?>
        <?php else: ?>
            <?php $this->assign('subtitle', "Le tue immagini di log:"); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if ($this->_tpl_vars['allpics']): ?>
        <p>Nelle tue <a href="mydetails.php">impostazioni profilo</a> puoi scegliere se le immagine di stato e la galleria sono visibili ad altri utenti.</p>
    <?php endif; ?>
<?php endif; ?>
...
/images/cacheicon/22x20-traditional.png" width="22" height="20"  style="margin-right: 10px;" />&nbsp;
            Geocaches nascoste: <?php echo $this->_tpl_vars['hidden']; ?>
 &nbsp;
...
&amp;searchbyowner=&amp;f_inactive=0&calledbysearch=0">Vedi dettagli</a><?php if ($this->_tpl_vars['active'] < $this->_tpl_vars['hidden']): ?>]&nbsp; [<a href="search.php?showresult=1&amp;expert=0&amp;output=HTML&amp;sort=bycreated&amp;ownerid=<?php echo $this->_tpl_vars['login']['userid']; ?>
&amp;searchbyowner=&amp;f_inactive=1&calledbysearch=0">... solo cache attive</a>]<?php endif; ?></span><?php endif; ?>
        </p>
    </div>

    <table class="table" style="max-width:97%">
        <?php if (count($this->_tpl_vars['caches']) == 0): ?>
            <tr><td colspan="4"><p style="margin-bottom:24px">Nessuna geocache nascosta</p></td></tr>
        <?php else: ?>
...
?>
            ...
            <tr>
                <td colspan="4"><b><span style="line-height:2em">Le tue geocaches nascoste</b><span id="toggle_archived_option" style="display:none"><?php if ($this->_tpl_vars['archived'] > 0): ?> (<a href="javascript:toggle_archived()" style="outline:none"><span id="hide_archived">nascondi archiviate</span><span id="show_archived" style="display:none">vedi archiviate</span></a>)<?php endif; ?></span><span></span>:</span></td>
                <td style="text-align:right"><span style="line-height:2em"><img src="images/rating-star.gif" width="17" height="16" title="con raccomandazione" /></td>
                <td style="text-align:right"><span style="line-height:2em"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" alt="trovata" title="trovata"  /></td>
                <td style="text-align:left"><span style="line-height:2em"><b>Ultimo log</b></span></td>
            </tr>
            <?php $_from = $this->_tpl_vars['caches']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cacheItem']):
?>
...
unset($_smarty_tpl_vars);
 ?></nobr></td>
            ...
            <tr><td colspan="3"><a class="systemlink" href="ownerlogs.php">Vedi log storico</a></td></tr>
        <?php endif; ?>

                <?php if (count($this->_tpl_vars['notpublished'])): ?>
            <tr>
                <td colspan="4">
                    <p style="margin-top:16px"><b>Le tue geocache in attesa di pubblicazione</b></p>
                </td>
            </tr>
