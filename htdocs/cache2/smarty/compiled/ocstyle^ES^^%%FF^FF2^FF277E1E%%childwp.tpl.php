...
/images/description/20x20-compass.png" style="margin-right: 10px;" alt="" title="Waypoit Adicionales" />
...
" /></td><td><?php echo $this->_tpl_vars['typeName']; ?>
  ...
  <table class="table">
    <tr>
      <td valign="top">Tipo de Waypoint:</td>
      <td>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr>
      <td></td>
      <td>
        <input type="submit" name="back" value="Cancelado" class="formbutton" onclick="submitbutton('back')" />&nbsp;&nbsp;
