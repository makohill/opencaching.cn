...
<p>
    <div style="margin-top:4px;">
        ...
        <p style="color: 5890a8">am <?php echo ((is_array($_tmp=$this->_tpl_vars['event_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['date']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['date'])); ?>
</font><br />
        von <?php echo ((is_array($_tmp=$this->_tpl_vars['owner'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</p>
    </div>
    <div style="margin-top:16px;">
        <p style="color: 5890a8"><b>möchte teilnehmen</b></p>
        <p style="color: 5890a8">(insgesamt: <?php echo smarty_function_count(array('array' => $this->_tpl_vars['willattend']), $this);?>
)</p>
...
<br />
    ...
    <div style="margin-top:16px;">
        <p style="color: 5890a8"><b>teilgenommen</b></p>
        <p style="color: 5890a8">(insgesamt: <?php echo smarty_function_count(array('array' => $this->_tpl_vars['attended']), $this);?>
)</p>
