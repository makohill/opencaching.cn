...
/images/misc/32x32-watched.png" style="margin-right: 10px;" width="32" height="32" alt="" />
            Géocaches regardées - Paramètres
        </div>
            ...
            <tr>
                ...
                <td>
                    <select id="interval" name="interval" onchange="intervalChanged();">
                        <option value="0" <?php if ($this->_tpl_vars['interval'] == 0): ?>selected="selected"<?php endif; ?>>Immédiat</option>
                        <option value="1" <?php if ($this->_tpl_vars['interval'] == 1): ?>selected="selected"<?php endif; ?>>Tous les jours</option>
                        <option value="2" <?php if ($this->_tpl_vars['interval'] == 2): ?>selected="selected"<?php endif; ?>>Hebdomadaire</option>
                    </select>
                </td>
            </tr>
...
/images/misc/hint.gif" border="0" width="15" height="11" /> L'heure et le jour envoyé est utilisé uniquement avec livraison quotidienne ou hebdomadaire.</td>
            </tr>
            <tr><td class="spacer" colspan="2"></td></tr>
            <?php if ($this->_tpl_vars['error'] == true): ?>
                <tr><td colspan="2" class="errormsg">Erreur en essayant de sauver&nbsp; les paramètres!</td></tr>
            <?php elseif ($this->_tpl_vars['saved'] == true): ?>
                <tr><td colspan="2" class="okmsg">Les paramètres ont été enregistrés.</td></tr>
            <?php endif; ?>
            <tr><td class="spacer" colspan="2"></td></tr>
            ...
            <td colspan="2">
                <table class="table">
                    <tr class="cachelistheader">
                        ...
                        <th width="350px">Nom</th>
                        <th width="100px"><nobr>Dernière trouvé</nobr></th>
                        <th></th>
                    </tr>
...
" style="text-align:center">
                            ...
                            <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
"><nobr>[<a href="javascript:if(confirm('Voulez-vous vraiment supprimer cette entrée ?'))location.href='mywatches.php?action=remove&cacheid=<?php echo $this->_tpl_vars['watchItem']['cacheid']; ?>
&target=mywatches.php'">ne regarde pas</a>]</nobr></td>
                        </tr>
                    <?php endforeach; else: ?>
                        <tr><td colspan="5"><br />Aucunes géocaches regardées.</td></tr>
