...
unset($_smarty_tpl_vars);
 ?></nobr></td>
    <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
" colspan="2"><?php if ($this->_tpl_vars['cache']['isnew']): ?><b class="newsymbol">&nbsp;NEW&nbsp;</b>&nbsp; <?php endif; ?><span style="<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
</span></a></span> &nbsp;por <a href="viewprofile.php?userid=<?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['user_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
</a> por <a href="viewprofile.php?userid=<?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['user_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a> --></td>
...
deg.png" title="Cardinal direction: <?php echo $this->_tpl_vars['cache']['direction_txt']; ?>
" />&nbsp;<?php endif; ?></td>
    <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
" colspan="2" valign="top">
    <p class="truncate">
        <?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] < 4): ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 0): ?><?php echo '<img src="images/rating-star.gif" title="Recomendaciones" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 1): ?><?php echo '<img src="images/rating-star.gif" title="Recomendaciones" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 2): ?><?php echo '<img src="images/rating-star.gif" title="Recomendaciones" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 3): ?><?php echo '<b><span class="txtblack" style="color:#02c602; font-size: 13px;">'; ?><?php echo $this->_tpl_vars['cache']['topratings']; ?><?php echo 'x</span></b><img src="images/rating-star.gif" title="Recomendaciones" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?>
