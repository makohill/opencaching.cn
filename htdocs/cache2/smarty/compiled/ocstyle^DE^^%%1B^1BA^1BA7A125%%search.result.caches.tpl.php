...
<?php if ($this->_tpl_vars['cachelist'] || $this->_tpl_vars['query_name']): ?>
    <div class="content2-container cachelistinfo" style="margin-top:10px" >
        <?php if ($this->_tpl_vars['query_name']): ?>
            ...
            <a class="systemlink" href="query.php">Gespeicherte Suche</a> <b><?php echo ((is_array($_tmp=$this->_tpl_vars['query_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b>
            </p>
        <?php endif; ?>
        <?php if ($this->_tpl_vars['cachelist']): ?>
            ...
            <a class="systemlink" href="cachelists.php">Cacheliste</a> <b><?php echo ((is_array($_tmp=$this->_tpl_vars['cachelist']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b>
...
/images/viewcache/cache-rate.png" title="Diese Liste gehört zu meinen Favoriten." /></a><?php endif; ?>
            <?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-watch.png" title="Ich beobachte diese Liste." /><?php endif; ?>
            <?php if ($this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid']): ?>von <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cachelist']['user_id']; ?>
...
').select();" <?php if ($this->_tpl_vars['cachelist']['user_id'] == $this->_tpl_vars['login']['userid']): ?>title="Liste mit Kennwort; kicke hier, um sie zu teilen."<?php endif; ?> >privat <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/action/18x16-offer.png" /></a><?php else: ?>privat<?php endif; ?>)<?php endif; ?>
...
'); cl.style.display = (cl.style.display=='none'?'block':'none'); getElementById('permalink_text_<?php echo $this->_tpl_vars['cachelist']['id']; ?>
').select();" >öffentliche Liste teilen <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
&fromsearch=1">bearbeiten</a>]<?php endif; ?>
            <?php if ($this->_tpl_vars['login']['userid']): ?>[<a class="systemlink" href="cachelist.php?id=<?php echo $this->_tpl_vars['cachelist']['id']; ?>
&<?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?>dont<?php endif; ?>watch"><?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?>nicht beobachten<?php else: ?>beobachten<?php endif; ?></a>]<?php endif; ?>
...
&bookmark">merken</a>]<?php endif; ?>
            <?php if ($this->_tpl_vars['login']['userid'] && $this->_tpl_vars['cachelist']['bookmarked'] && $this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid']): ?>[<a class="systemlink" href="cachelist.php?id=<?php echo $this->_tpl_vars['cachelist']['id']; ?>
&unbookmark">entmerken</a>]<?php endif; ?>
            </p>
        <?php endif; ?>
        <div id="sharelist_<?php echo $this->_tpl_vars['cachelist']['id']; ?>
" class="cachelist-popup mapboxframe mapboxshadow" style="display:none" >
            <table>
                <tr><td><img src="resource2/ocstyle/images/viewcache/link.png" alt="" height="16" width="16" /> Link zum Teilen dieser Cacheliste:</td><td align="right"><a class="jslink" onclick="getElementById('sharelist_<?php echo $this->_tpl_vars['cachelist']['id']; ?>
...
&output=map2bounds&showresult=1&skipqueryid=1&expert=0&utf8=1">auf Karte anzeigen</a></p>
            </td>
        <?php endif; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>$&creationdate=1<?php endif; ?>">Optionen speichern</a>]</span>
...
">Optionen bearbeiten</a>]</span><?php endif; ?></p>
        </td>
    </tr></table>
</div>
 ...
 ?></td>
                        ...
                        <td><nobr>
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Ergebnisse auf dieser Seite</option>
...
">TXT</option>
                            ...
                            <select class="exportlist" onChange="location.href=this.options[this.selectedIndex].value">
                                <option value="#">Einträge <?php echo $this->_tpl_vars['startatp1']; ?>
 bis <?php echo $this->_tpl_vars['endat']; ?>
 (als zip)</option>
                                <option value="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['creationdate']): ?>&creationdate=1<?php endif; ?>">
                    ...
                    <th width="90">
                        <?php if ($this->_tpl_vars['creationdate']): ?>
                            <?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bycreated&sortorder='; ?><?php if ($this->_tpl_vars['sortby'] != 'bycreated' || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo '"><nobr>Gelistet seit'; ?><?php if ($this->_tpl_vars['sortby'] == 'bycreated'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>&nbsp;&nbsp;'; ?>
                    ...
                    <th width="90">
                        <?php echo ''; ?><?php if ($this->_tpl_vars['displayownlogs']): ?><?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bymylastlog&sortorder='; ?><?php if (( $this->_tpl_vars['sortby'] != 'bymylastlog' && $this->_tpl_vars['sortby'] != 'bylastlog' ) || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['creationdate']): ?><?php echo '&creationdate=1'; ?><?php endif; ?><?php echo '"><nobr>Eigene Logs'; ?><?php if ($this->_tpl_vars['sortby'] == 'bymylastlog'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>'; ?><?php else: ?><?php echo '<a href="search.php?queryid='; ?><?php echo $this->_tpl_vars['queryid']; ?><?php echo '&showresult=1&sortby=bylastlog&sortorder='; ?><?php if (( $this->_tpl_vars['sortby'] != 'bymylastlog' && $this->_tpl_vars['sortby'] != 'bylastlog' ) || $this->_tpl_vars['sortorder'] == 'asc'): ?><?php echo 'desc'; ?><?php else: ?><?php echo 'asc'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['startat']): ?><?php echo '&startat='; ?><?php echo $this->_tpl_vars['startat']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['creationdate']): ?><?php echo '&creationdate=1'; ?><?php endif; ?><?php echo '"><nobr>Letzte Logs'; ?><?php if ($this->_tpl_vars['sortby'] == 'bylastlog'): ?><?php echo '&nbsp;'; ?><?php if ($this->_tpl_vars['sortorder'] == 'desc' || $this->_tpl_vars['sortorder'] == ''): ?><?php echo '&#x25B2;'; ?><?php else: ?><?php echo '&#x25BC;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</nobr></a>&nbsp;'; ?><?php endif; ?><?php echo ''; ?>
&nbsp;
                    </th>
                    </tr>
                    <tr><td></td></tr>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right" style="padding-right:20px; white-space:nowrap">
                <b>Einträge auf dieser Seite:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="GPS Exchange Format .gpx">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Wegpunktdatei .loc">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
" title="TOP50-Overlay .ovl">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
" title="Textdatei .txt">TXT</a>
                <br />
                <b>Einträge <?php echo $this->_tpl_vars['startatp1']; ?>
 bis <?php echo $this->_tpl_vars['endat']; ?>
 (als zip)<span></span>:</b>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=gpx&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="GPS Exchange Format .gpx">GPX</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=loc&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Wegpunktdatei .loc">LOC</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=kml&startat=<?php echo $this->_tpl_vars['startat']; ?>
...
&count=max&zip=1" title="TOP50-Overlay .ovl">OVL</a>
                <a href="search.php?queryid=<?php echo $this->_tpl_vars['queryid']; ?>
&output=txt&startat=<?php echo $this->_tpl_vars['startat']; ?>
&count=max&zip=1" title="Textdatei .txt">TXT</a>
            </td>
        </tr>
        <tr>
