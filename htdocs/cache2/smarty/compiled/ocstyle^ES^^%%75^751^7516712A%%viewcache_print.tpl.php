...
unset($_smarty_tpl_vars);
 ?>
                    ...
                    <td align="left" valign="top" width="99%">
                        ...
                        <span style="font-weight:400">&nbsp;por <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span><br />
...
/images/description/22x22-location.png"  width="22" height="22" border="0" alt="" title="" align="left" />&nbsp;
                        ...
                        <table class="print-cachemeta" cellspacing="0" cellpadding="0">
                            <tr><td>Tamaño:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['sizeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /></td></tr>
                        <?php if ($this->_tpl_vars['cache']['searchtime'] > 0): ?>
                            <tr><td><nobr>Tiempo requerido:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['searchtime'])) ? $this->_run_mod_handler('format_hour', true, $_tmp) : smarty_modifier_format_hour($_tmp)); ?>

                                h<?php if ($this->_tpl_vars['cache']['waylength'] > 0): ?>, &nbsp;Distancia <?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km<?php endif; ?>
                            </nobr></td>
                        <?php elseif ($this->_tpl_vars['cache']['waylength'] > 0): ?>
                            <tr><td><nobr>Distancia del camino:</td><td><?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km</nobr></td></tr>
                        <?php endif; ?>
                        <?php if ($this->_tpl_vars['cache']['status'] != 1): ?>
                            <tr><td>Estado:</td><td><span class="errormsg"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span></td></tr>
                        <?php else: ?>
                            <tr><td>Estado:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td></tr>
                        <?php endif; ?>
                        <tr><td>Ocultos en:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datehidden'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td><?php if ($this->_tpl_vars['cache']['is_publishdate'] == 0): ?>Publicado desde:<?php else: ?>Publicado en:<?php endif; ?></td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datecreated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td>Última actualización:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['lastmodified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>

                        <?php if ($this->_tpl_vars['cache']['wpgc'] != ''): ?>
                            <tr>
                            <td>Also listed as:</td>
...
/images/log/16x16-dnf.png" width="16" height="16" border="0" /><?php if ($this->_tpl_vars['cache']['type'] == 6): ?> <?php echo $this->_tpl_vars['cache']['willattend']; ?>
 ...
 no encontrado<?php endif; ?></nobr><br />
                        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FEFEFE;border:solid 1px black;">
                        <tr>
                            ...
                            <td style="text-align:left; vertical-align:top">
                                ¡Este geocache está probablemente situado dentro de una zona de protección de la naturaleza! Mira <?php echo $this->_tpl_vars['opt']['cms']['npa']; ?>
...
<?php if (! ($this->_foreach['npaareas']['iteration'] == $this->_foreach['npaareas']['total'])): ?>,<?php endif; ?>
    ...
    <?php if (count ( $this->_tpl_vars['npaareasNoWarning'] ) > 0): ?>
        <tr>
            <td>
                <font size="2">
                    Este geocache está probablemente en las siguientes áreas protegidas:
