...
/images/cacheicon/22x20-traditional.png" width="22" height="20" align="middle" border="0" style="padding-right:2px" />&nbsp;<b>Caches hidden:</b></td>
...
.gif" />
        ...
        <tr>
            ...
            <img src="resource2/ocstyle/images/log/16x16-dnf.png" />&nbsp;&nbsp;&nbsp;<b>Not found<span></span>:</b></td>
...
&amp;searchbyfinder=&amp;logtype=2&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]<?php endif; ?>
        ...
        <tr>
            ...
            <img src="resource2/ocstyle/images/log/16x16-note.png" />&nbsp;&nbsp;&nbsp;<b>Notes<span></span>:</b></td>
...
&amp;searchbyfinder=&amp;logtype=9,10,11,13,14&amp;calledbysearch=0<?php if ($this->_tpl_vars['oconly']): ?>&amp;cache_attribs=6<?php endif; ?>">Show</a>]
    ...
    <tr>
        <td valign="middle" class="header-small" style="padding-bottom:5px;white-space:nowrap">
        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/rating-star.gif" align="middle" border="0" style="padding-right:2px" />&nbsp;&nbsp;<b>Recommendations<span></span>:</b></td>
        <td class="header-small" ><?php if ($this->_tpl_vars['maxrecommended'] !== null): ?><?php echo $this->_tpl_vars['recommended']; ?>
 of <?php echo $this->_tpl_vars['maxrecommended']; ?>
 possible<?php else: ?><?php echo $this->_tpl_vars['recommended']; ?>
