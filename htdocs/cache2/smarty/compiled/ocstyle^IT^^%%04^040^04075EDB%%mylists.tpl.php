...
" class="input500" /></td>
            ...
            <tr><td class="separator"></td></tr>
            <tr>
                <td style="vertical-align:top">Stato:</td>
...
" class="input200" /></span><br />
            ...
            <tr id="desc1" style="<?php if ($this->_tpl_vars['desctext'] == '' && ! $this->_tpl_vars['show_editor']): ?>display:none<?php endif; ?>" >
                <td></td>
                <td><span id="scriptwarning" class="errormsg">JavaScript è disabilitato sul tuo browser, puoi inserire solo testo (HTML). Per usare l'editor per favore abilita JavaScript.</span></td>
            </tr>
            <tr>
                ...
                <td id="desc0" style="<?php if ($this->_tpl_vars['desctext'] != '' || $this->_tpl_vars['show_editor']): ?>display:none<?php endif; ?>" >
                    <input type="button" value="Aggiungere" onclick="javascript:showdesc()" class="formbutton" />
                </td>
...
" ><?php echo $this->_tpl_vars['desctext']; ?>
                    ...
                    <span class="smalltext">Inviando accetto i <a href="articles.php?page=impressum#tos" target="_blank">Termini del Servizio Opencaching.de</a> e la <a href="articles.php?page=impressum#datalicense" target="_blank">Lecenza dati Opencaching.de</a>.</span>
                </td>
            </tr>
            <tr><td class="separator"></td></tr>
            <tr><td class="separator"></td></tr>
            <tr>
                <td style="vertical-align:top; white-space:nowrap"><?php if ($this->_tpl_vars['edit_list']): ?>Add caches:<?php else: ?>Cache:<?php endif; ?></td>
...
/images/misc/hint.gif" border="0" width="15" height="11" alt="Suggerimento" align="middle" /> Space-separated list of OC waypoints. <?php if ($this->_tpl_vars['edit_list']): ?>You may also add caches via "Add to list" button in cache listings.<?php else: ?>This is optional, caches may be added to the list later.<?php endif; ?></td>
            </tr>
...
unset($_smarty_tpl_vars);
 ?></td>
            ...
            <tr>
                ...
                <?php else: ?>
                    <input type="submit" name="save" value="Salva" class="formbutton" onclick="submitbutton('save')" />
                <?php endif; ?>
            </tr>
            <tr><td>&nbsp;</td></tr>
        </table>
