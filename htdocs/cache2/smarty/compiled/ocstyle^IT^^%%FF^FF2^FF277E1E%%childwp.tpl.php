...
/images/description/20x20-compass.png" style="margin-right: 10px;" alt="" title="Punto intermedio" />
...
" /></td><td><?php echo $this->_tpl_vars['typeName']; ?>
  ...
  <table class="table">
    <tr>
      <td valign="top">Tipo di punto:</td>
      <td>
        <select name="wp_type" <?php if ($this->_tpl_vars['disabled']): ?>disabled=""<?php endif; ?>>
          <option value="0">Per favore seleziona il tipo</option>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr>
      <td></td>
      <td>
        <input type="submit" name="back" value="Cancella" class="formbutton" onclick="submitbutton('back')" />&nbsp;&nbsp;
