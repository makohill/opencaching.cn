...
<form method="POST" action="adminhistory.php">
    <p>
        ...
        <input type="submit" name="submitform" value="affichier" class="formbutton" onclick="submitbutton('submitform')" />
    </p>
</form>
<?php endif; ?>
...
/images/misc/32x32-tools.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                <?php if ($this->_tpl_vars['reportdisplay']): ?>    Autres rapports pour cette cache<?php else: ?>Rapports de cache<?php endif; ?>
            </p>
        </div>
...
/images/description/22x22-logs.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                Logs supprimés <small>depuis la date de suppression en Février 2012</small>
            </p>
        </div>
...
/images/viewcache/16x16-maintenance.png" style="margin-right: 10px;" width="16" height="16" alt="" />
                Les changements d'état <small>depuis Juin 2013</small>
            </p>
        </div>
...
/images/profile/32x32-adopt.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                Adoptions <small>depuis Septembre 2012</small>
            </p>
        </div>
        ...
        <?php if (count($this->_tpl_vars['adoptions'])): ?>
            <tr>
                <th>Date</th>
                <th>De Propriétaire</th>
                <th></th>
                <th>Pour Propriétaire</th>
            </tr>
