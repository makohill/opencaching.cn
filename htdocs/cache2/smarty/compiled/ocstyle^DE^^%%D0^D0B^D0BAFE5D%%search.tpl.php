...
function _radio_click(){
        ...
        {
            alert("'; ?>
Die maximale Entfernung muss eine Zahl sein!<?php echo '");
        ...
        {
            alert("'; ?>
Zulässiger Wert für max. Entfernung: 0 - 9999<?php echo '");
            resetbutton(\'submit_dist\');
            return false;
        }
        ...
        if (document.getElementById(\'sbortplz\').checked) {
            ...
            alert("Bitte wähle einen Suchbutton aus!");
            resetbutton(\'submit_dist\');
            return false;
        }
}
...
function _sbn_click()
{
    ...
    {
        alert("'; ?>
Bitte im Namensfeld etwas eingeben!<?php echo '");
...
function _sbft_click()
{
    ...
    {
        alert("'; ?>
Bitte im Textfeld etwas eingeben!<?php echo '");
    ...
    {
        alert("'; ?>
Es muss mindestens ein Feld angekreuzt sein!<?php echo '");
        resetbutton(\'submit_ft\');
        return false;
    }
...
function _sbd_click()
{
    ...
    {
        alert("'; ?>
Der Längengrad muss eine Zahl sein!\nFormat: hh° mm.mmm<?php echo '");
        resetbutton(\'submit_dist\');
        return false;
    }
    ...
    {
        alert("'; ?>
Der Breitengrad muss eine Zahl sein!\nFormat: hh° mm.mmm<?php echo '");
        resetbutton(\'submit_dist\');
        return false;
    }
    return true;
...
function _sbortplz_click()
{
    ...
    {
        alert("'; ?>
Gebe bitte eine Stadt oder PLZ ein.<?php echo '");
        resetbutton(\'submit_dist\');
        return false;
    }
    return true;
...
function _sbwaypoint_click()
{
    ...
    {
        alert("'; ?>
Gebe bitte einen gültigen Wegpunkt ein.<?php echo '");
        resetbutton(\'submit_dist\');
        return false;
    }
    ...
    {
        alert("'; ?>
Gebe bitte einen gültigen Wegpunkt ein.\nFormat: OCxxxx(x) / GCx(xxxx)<?php echo '");
        resetbutton(\'submit_dist\');
        return false;
    }
    return true;
...
function _sbo_click()
{
    ...
    {
        alert("'; ?>
Bitte im Feld für Besitzer etwas eingeben!<?php echo '");
...
function _sbf_click()
{
    ...
    {
        alert("'; ?>
Bitte im Feld für Finder etwas eingeben!<?php echo '");
...
<div class="content2-pagetitle"><img src="resource2/ocstyle/images/misc/32x32-search.png" style="margin-right: 10px;" width="32" height="32" alt="" />Cachesuche</div>
...
<div class="searchdiv2">
    <table class="table">
        <tr>
            <td class="formlabel">Caches ausblenden:</td>
            <td colspan="4">
                <input type="checkbox" name="f_userowner" value="1" id="l_userowner" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userowner_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userowner" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>eigene</label> &nbsp;
                <input type="checkbox" name="f_userfound" value="1" id="l_userfound" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userfound_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userfound" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>gefundene</label> &nbsp;
                <input type="checkbox" name="f_ignored" value="1" id="l_ignored" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_ignored_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_ignored" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>ignorierte</label> &nbsp;
                <input type="checkbox" name="f_disabled" value="1" id="l_disabled" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_disabled_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_disabled">deaktivierte</label> &nbsp;
                <nobr><input type="checkbox" name="f_inactive" value="1" id="l_inactive" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_inactive_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_inactive">archivierte</label></nobr> &nbsp;
                <br />
                <nobr><input type="checkbox" name="f_otherPlatforms" value="1" id="l_otherPlatforms" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_otherPlatforms_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_otherPlatforms">auch bei GC.com veröffentlichte</label></nobr> &nbsp;
                <nobr><input type="checkbox" name="f_geokrets" value="1" id="l_geokrets" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_geokrets_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_geokrets">ohne Geokrets</label></nobr>
            </td>
        </tr>
        ...
        <tr>
            <td class="formlabel">Cacheart:</td>
            <td>
                <?php $_from = $this->_tpl_vars['cachetypes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ct']):
?>
...
unset($_smarty_tpl_vars);
 ?>&nbsp;
                <?php endforeach; endif; unset($_from); ?>
                &nbsp;&nbsp;<a href="javascript:alltypes(true)">alle</a>
                &nbsp;&nbsp;<a href="javascript:alltypes(false)">keine</a>
            </td>
        </tr>
        ...
        <tr>
            <td class="formlabel">Cachegröße:</td>
            <td colspan="4">
                ...
                <input type="checkbox" id="cachesize2" name="cachesize2" value="2" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['2']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize2" style="font-size:0.86em">mikro</label> &nbsp;
                <input type="checkbox" id="cachesize3" name="cachesize3" value="3" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['3']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize3" style="font-size:1.0em">klein</label> &nbsp;
                ...
                <input type="checkbox" id="cachesize5" name="cachesize5" value="5" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['5']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize5" style="font-size:1.28em">groß</label> &nbsp;
                <nobr><input type="checkbox" id="cachesize6" name="cachesize6" value="6" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['6']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize6" style="font-size:1.42em">extrem groß</label></nobr>
                <br />
                <input type="checkbox" id="cachesize1" name="cachesize1" value="1" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['1']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize1">andere Größe</label> &nbsp; <input type="checkbox" id="cachesize7" name="cachesize7" value="7" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['7']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize7">kein Behälter</label>
                &nbsp;
                &nbsp;&nbsp;<a href="javascript:allsizes(true)">alle</a>
                &nbsp;&nbsp;<a href="javascript:allsizes(false)">keine</a>
            </td>
        </tr>
        ...
        <tr>
            <td class="formlabel">Schwierigkeit:</td>
            <td colspan="4">
...
<?php endif; ?></option>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;
                <span class="formlabel">Gel&auml;nde:</span> &nbsp;
...
<?php endif; ?></option>
        ...
        <tr>
            <td class="formlabel">Land:&nbsp;&nbsp;</td>
            <td>
                <select name="country" onchange="sync_options(this)">
                    <option value="" <?php if ($this->_tpl_vars['all_countries']): ?>selected="selected"<?php endif; ?>>Alle Länder</option>
...
" <?php if ($this->_tpl_vars['countryoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['countryoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;
                <span class="formlabel">Sprache:&nbsp;&nbsp;</span>
                <select name="language" onchange="sync_options(this)">
                    <option value="" <?php if ($this->_tpl_vars['all_languages']): ?>selected="selected"<?php endif; ?>>Alle Sprachen</option>
...
" <?php if ($this->_tpl_vars['languageoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['languageoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <tr>
            <td valign="top">
                <span class="formlabel">Cacheattribute:</span>&nbsp;<br />
                (<a href="javascript:switchAttributeCat2()"><span id="toggleAttributesCaption" style="white-space:nowrap">alle anzeigen</span></a>)
            </td>
...
<div class="searchdiv2">
    <table class="table">
        <tr>
            <td class="formlabel" rowspan="2">Ausgabe<br />sortieren nach:</td>
            <td colspan="4" style="padding-bottom:0">
                <input type="radio" name="sort" value="byname" index="0" id="l_sortbyname" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['byname_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbyname">Cachename</label> &nbsp;
                <input type="radio" name="sort" value="bydistance" index="1" id="l_sortbydistance" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bydistance_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbydistance">Entfernung</label> &nbsp;
                <input type="radio" name="sort" value="bycreated" index="2" id="l_sortbycreated" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bycreated_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbycreated">Gelistet seit</label> &nbsp;
                <nobr><input type="radio" name="sort" value="bylastlog" index="3" id="l_sortbylastlog" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bylastlog_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbylastlog" >letztes Log</label> &nbsp;
                <input type="radio" name="sort" value="bymylastlog" index="4" id="l_sortbymylastlog" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bymylastlog_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_sortbymylastlog" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>mein letztes Log</label></nobr>
            </td>
        </tr>
        <tr>
            <td style="padding-top:0">
                ...
                <label for="orderRatingFirst">von anderen Benutzern empfohlene Caches zuerst anzeigen</label>
            </td>
        </tr>
    </table>
</div>
...
<div id="scriptwarning" style="margin:0 5px 0 5px;">
    <p><span class="errormsg">JavaScript ist bei dir deaktiviert, daher kannst du die obenstehenden Optionen (Caches ausblenden .. Sortierung) nicht nutzen - die Suche funktioniert aber trotzdem.</span></p>
</div>
...
" maxlength="4" class="input50" />&nbsp;
                <select name="unit" class="input100">
                    <option value="km" <?php if ($this->_tpl_vars['sel_km']): ?>selected="selected"<?php endif; ?>>Kilometer</option>
                    <option value="sm" <?php if ($this->_tpl_vars['sel_sm']): ?>selected="selected"<?php endif; ?>>Meilen</option>
                    <option value="nm" <?php if ($this->_tpl_vars['sel_nm']): ?>selected="selected"<?php endif; ?>>Seemeilen</option>
                </select>
            </td>
        </tr>
        <tr>
            <td class=""><input type="radio" id="sbortplz" name="searchto" value="searchbyortplz" <?php if ($this->_tpl_vars['dbyortplz_checked']): ?>checked="checked"<?php endif; ?>><label for="sbortplz">... von Stadt / PLZ:</label></td>
            <td><input type="text" name="ortplz" value="<?php echo $this->_tpl_vars['ortplz']; ?>
" class="input200" onfocus="textonfocus(0)"/> &nbsp;</td>
            <td></td>          </tr>
        <tr>
            <td class=""><input type="radio" id="sbwaypoint" name="searchto" value="searchbywaypoint" <?php if ($this->_tpl_vars['dbywaypoint_checked']): ?>checked="checked"<?php endif; ?>><label for="sbwaypoint">... vom Wegpunkt:</label></td>
...
" maxlength="7" class="input70" onfocus="textonfocus(1)"/></td>
        ...
        <tr>
            <td valign="top"><input type="radio" id="sbdis" name="searchto" value="searchbydistance" <?php if ($this->_tpl_vars['dbydistance_checked']): ?>checked="checked"<?php endif; ?>><label for="sbdis">... von Koordinaten:</label></td>
            <td valign="top">
...
" class="input50" onfocus="textonfocus(2)"/>&nbsp;'&nbsp;
                ...
                <select name="lonEW" onfocus="textonfocus(2)">
                    ...
                    <option value="W" <?php if ($this->_tpl_vars['lonW_sel']): ?>selected="selected"<?php endif; ?>>W</option>
                </select>&nbsp;
...
" class="input50" onfocus="textonfocus(2)"/>&nbsp;'&nbsp;
            ...
            <td><input type="submit" name="submit_dist" value="Suchen" class="formbutton" onclick="submitbutton('submit_dist')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Cachename<span></span>:</td>
            <td><input type="text" name="cachename" value="<?php echo $this->_tpl_vars['cachename']; ?>
" class="input200" /></td>
            <td><input type="submit" name="submit_cachename" value="Suchen" class="formbutton" onclick="submitbutton('submit_cachename')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Text<span></span>:</td>
            <td><input type="text" name="fulltext" value="<?php echo $this->_tpl_vars['fulltext']; ?>
" class="input200" /></td>
            <td><input type="submit" name="submit_ft" value="Suchen" class="formbutton" onclick="submitbutton('submit_ft')" /></td>
        </tr>
        <tr>
            <td>... in<span></span>:</td>
            <td colspan="4">
                <input type="checkbox" name="ft_desc" id="ft_desc" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_desc_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_desc">Beschreibung</label> &nbsp;
                <input type="checkbox" name="ft_name" id="ft_name" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_name_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_name">Cachename</label> &nbsp;
                <input type="checkbox" name="ft_pictures" id="ft_pictures" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_pictures_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_pictures">Bilder</label> &nbsp;
...
" />
        ...
        <tr>
            <td class="formlabel">Besitzer:</td>
            <td><input type="text" name="owner" value="<?php echo $this->_tpl_vars['owner']; ?>
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_owner" value="Suchen" class="formbutton" onclick="submitbutton('submit_owner')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Logeinträge:</td>
            <td colspan="2">
                <select name="logtype">
...
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_finder" value="Suchen" class="formbutton" onclick="submitbutton('submit_finder')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Alle Caches</td>
            <td></td>
            <td><input type="submit" name="submit_all" value="Suchen" class="formbutton" onclick="submitbutton('submit_all')" /></td>
        </tr>
    </form>
    <?php endif; ?>
