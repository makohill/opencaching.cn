...
<form name="change" action="change_statpic.php" method="post" enctype="application/x-www-form-urlencoded" style="display: inline;">
    <table class="table">
        ...
        <tr>
            <td colspan="2">
                <b>De volgende instellingen voor uw statistiekenweergave zijn opgeslagen:</b><br />
            </td>
        </tr>
        <tr><td class="spacer" colspan="2"></td></tr>

        <tr>
            <td>Getoonde tekst</td>
            <td>
...
" align="middle"></td>
        ...
        <tr>
            <td colspan="3">
                <br />After saving, you may need to press the reload button in your browser to see the selected picture in your profile.
            </td>
        </tr>
    </table>
</form>