...
<?php if ($this->_tpl_vars['cache']['userhasfound'] || $this->_tpl_vars['cache']['needs_maintenance'] || $this->_tpl_vars['cache']['listing_outdated'] || $this->_tpl_vars['cache']['status'] == 2 || $this->_tpl_vars['cache']['status'] == 3 || $this->_tpl_vars['cache']['status'] == 6 || $this->_tpl_vars['cache']['status'] == 7): ?>
    <div id="havefound">
        <?php echo '<p>'; ?><?php if ($this->_tpl_vars['cache']['status'] == 2): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/32x32-disabled.png" width="32" height="32" style="padding-right: 6px;" alt="temporalmente no disponible" title="temporalmente no disponible" />'; ?><?php elseif ($this->_tpl_vars['cache']['status'] == 3): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/32x32-archived.png" width="32" height="32" style="padding-right: 6px;" alt="archivado" title="archivado" />'; ?><?php elseif ($this->_tpl_vars['cache']['status'] == 6): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/32x32-locked.png" width="32" height="32" style="padding-right: 6px;" alt="cerrado" title="cerrado" />'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['needs_maintenance']): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/needs-maintenance.png" width="32" height="32" style="padding-right: 5px;" alt="The geocache needs maintenance." title="The geocache needs maintenance." />'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['listing_outdated']): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/listing-outdated.png" width="32" height="32" style="padding-right: 5px;" alt="The geocache description is outdated." title="The geocache description is outdated." />'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['userhasfound']): ?><?php echo '&nbsp;<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/viewcache/have-found.png" width="35" height="35" style="padding-right: 5px;" alt="'; ?><?php if ($this->_tpl_vars['cache']['type'] == 6): ?><?php echo '¡Has participado en este evento!'; ?><?php else: ?><?php echo 'Ya has encontrado esta cache'; ?><?php endif; ?><?php echo '" title="'; ?><?php if ($this->_tpl_vars['cache']['type'] == 6): ?><?php echo '¡Has participado en este evento!'; ?><?php else: ?><?php echo 'Ya has encontrado esta cache'; ?><?php endif; ?><?php echo '" />'; ?><?php endif; ?><?php echo '</p>'; ?>
...
<?php endif; ?>">Log de este cache</a></li>
                <?php endif; ?>
...
%26watchinfo=1">No observado</a></li>
                <?php else: ?>
...
&amp;action=removeignore">No ignorado</a></li>
                    <?php else: ?>
                        <li class="group"><a style="background-image: url(resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/ignore-18.png);background-repeat:no-repeat;background-position:left center;" href="ignore.php?cacheid=<?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['cacheid'])) ? $this->_run_mod_handler('urlencode', true, $_tmp) : smarty_modifier_urlencode($_tmp)); ?>
&amp;action=addignore">Ignorado</a></li>
                    <?php endif; ?>
                <?php endif; ?>
                <li class="group"><a style="background-image: url(resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
<?php endif; ?>">Informar sobre este cache</a></li>
            </ul>
        </div>
...
unset($_smarty_tpl_vars);
 ?></a></div>
        ...
        <div class="content2-container-2col-left" id="cache_name_block">
            ...
            <p>por&nbsp;<b><a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cache']['userid']; ?>
...
&popup=y','Lista','width=320,height=440,resizable=no,scrollbars=1')">Lista de participantes</a></span>
            <?php endif; ?>
        </div>
    </div>
</div>
...
/images/misc/hint.gif" border="0" width="15" height="11" alt="" align="middle" />
            "Spoiler" imágenes que muestran detalles del escondite no debe ser visible aquí. Si se encuentra con un spoiler visible abierto, puede comunicarse con el registrador en el botón de e-mail en su perfil y le pido que marcarlo como spoiler.<br />
        <?php endif; ?>
    </div>
...
','Coordenadas','width=280,height=550,resizable=no,scrollbars=1')">Convertir coordenadas</a><br />
            <!-- <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/box.png" class="icon16" alt="" title="" align="middle" />&nbsp;Cache type: <b>Traditional</b><br /> -->
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/package_green.png" class="icon16" alt="" title="" align="middle" />&nbsp;Tamaño: <b><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['sizeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b><br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/page.png" class="icon16" alt="" title="" align="middle" />
            <?php if ($this->_tpl_vars['cache']['status'] != 1): ?>                  Estado: <span class="errormsg"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
            <?php else: ?>
                Estado: <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

            <?php endif; ?><br />
            <?php if ($this->_tpl_vars['cache']['searchtime'] > 0): ?>
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/time.png" class="icon16" alt="" title="" align="middle" />&nbsp;Tiempo requerido: <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['searchtime'])) ? $this->_run_mod_handler('format_hour', true, $_tmp) : smarty_modifier_format_hour($_tmp)); ?>
 h&nbsp;
            <?php endif; ?>
...
/images/viewcache/arrow_roundtrip.png" class="icon16" alt="" title="" align="middle" />&nbsp;Distancia del camino: <?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km</span>
            <?php endif; ?>
            <?php if ($this->_tpl_vars['cache']['searchtime'] > 0 || $this->_tpl_vars['cache']['waylength'] > 0): ?><br /><?php endif; ?>
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/date.png" class="icon16" alt="" title="" align="middle" />&nbsp;<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>Fecha del Evento:<?php else: ?>Ocultos en:<?php endif; ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datehidden'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
<br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/date.png" class="icon16" alt="" title="" align="middle" />&nbsp;<?php if ($this->_tpl_vars['cache']['is_publishdate'] == 0): ?>Publicado desde:<?php else: ?>Publicado en:<?php endif; ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datecreated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
<br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/date.png" class="icon16" alt="" title="" align="middle" />&nbsp;Última actualización: <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['lastmodified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
<br />              <!-- Ocprop: <br /> Wegpunkt: <b><?php echo $this->_tpl_vars['cache']['wpoc']; ?>
</b><br /> -->
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/arrow_in.png" class="icon16" alt="" title="" align="middle" />&nbsp;Listado<span></span>: <?php if ($this->_tpl_vars['shortlink_url'] !== false): ?><?php echo $this->_tpl_vars['shortlink_url']; ?>
...
/images/viewcache/link.png" class="icon16" alt="" title="" align="middle" />
                También en la categoría de:                  <?php if ($this->_tpl_vars['cache']['wpgc'] != ''): ?>
...
/images/<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>log<?php else: ?>viewcache<?php endif; ?>/16x16-<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>attended<?php else: ?>found<?php endif; ?>.png" class="icon16" alt="" /> <?php echo $this->_tpl_vars['cache']['found']; ?>
 <?php if ($this->_tpl_vars['cache']['type'] == 6): ?> asistió<?php else: ?>encuentran<?php endif; ?><br />
                            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>log<?php else: ?>viewcache<?php endif; ?>/16x16-<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>will_attend<?php else: ?>dnf<?php endif; ?>.png" class="icon16" alt="" /> <?php if ($this->_tpl_vars['cache']['type'] == 6): ?> <?php echo $this->_tpl_vars['cache']['willattend']; ?>
 asistiré<?php else: ?> <?php echo $this->_tpl_vars['cache']['notfound']; ?>
 no encontrado<?php endif; ?><br />
                            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-note.png" class="icon16" alt="" /> <?php echo $this->_tpl_vars['cache']['note']; ?>
 <?php if ($this->_tpl_vars['cache']['note'] == 1): ?>Nota<?php else: ?>Notas<?php endif; ?><br />
...
/images/viewcache/16x16-watch.png" class="icon16" alt="" /> <?php echo $this->_tpl_vars['cache']['watcher']; ?>
 <?php if ($this->_tpl_vars['cache']['watcher'] == 1): ?>Watcher<?php else: ?>Observado<?php endif; ?><br />
                            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/ignore-16.png" class="icon16" alt="" /> <?php echo $this->_tpl_vars['cache']['ignorercount']; ?>
 <?php if ($this->_tpl_vars['cache']['ignorecount'] == 1): ?>Ignorer<?php else: ?>Ignorado<?php endif; ?><br />
                            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-visitors.png" class="icon16" alt="" /> <?php echo $this->_tpl_vars['cache']['visits']; ?>
 <?php if ($this->_tpl_vars['cache']['visits'] == 1): ?>Page visit<?php else: ?>Visitas<?php endif; ?><br />
                            <span style="white-space:nowrap;"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
&logpics=1"><?php endif; ?><?php if ($this->_tpl_vars['logpics'] == 1): ?>Log de la imagen<?php else: ?>Los de imagenes<?php endif; ?><?php if ($this->_tpl_vars['logpics'] > 0): ?></a><?php endif; ?></span><br />
                            <span style="white-space:nowrap;"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
" target="_blank">Historia Geokrety</a></span><br />
...
/images/viewcache/14x19-gps-device.png" class="icon16" alt="" />
                <input type="button" class="exportbutton" value="Enviar a dispositivo GPS" onclick="window.open('<?php echo $this->_tpl_vars['garmin_url']; ?>
...
','Enviar','width=640,height=320,resizable=no,scrollbars=1')" />
            </p></td>
        </tr>
    </table>
...
?>
                    ...
                    <?php if ($this->_tpl_vars['n'] == 5 && count($this->_tpl_vars['cachelists']) > 5): ?>
                        <p id="morelists" style="padding:0; line-height:1em"><a href="javascript:showalllists()">más ...</a></p>
                    <?php endif; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php if ($this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid'] || ( $this->_tpl_vars['cachelist']['visibility'] == 3 && $this->_tpl_vars['cache']['show_cachelists'] )): ?> por <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cachelist']['user_id']; ?>
...
<div class="content2-container bg-blue02">
    <p class="content-title-noshade-size2">
        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/description/22x22-description.png" style="margin-right: 10px;" width="22" height="22" alt="" /> Descripción&nbsp;&nbsp;&nbsp;
...
/images/description/20x20-compass.png" style="margin-right: 10px;" alt="" />
            Waypoints Adicionales <span id="convert_waypoints">&nbsp; <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/map.png" class="icon16" style="margin-right: 10px;" alt="" /><span class="content-title-link" ><a href="javascript:enable_wpt_conversion()">Convertir coordenadas</a></span></span>
        </p>
    </div>
...
&country=<?php echo $this->_tpl_vars['cache']['countryCode']; ?>
&desclang=<?php echo $this->_tpl_vars['cache']['desclanguage']; ?>
','Coordenadas','width=280,height=550,resizable=no,scrollbars=1')">convert</a></td>
...
<?php if ($this->_tpl_vars['cache']['hint'] != ''): ?>
    <div class="content2-container bg-blue02">
      <p class="content-title-noshade-size2">
          <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/description/22x22-encrypted.png" style="margin-right: 10px;" width="22" height="22" alt="" /> Ayuda adicional&nbsp;&nbsp;
...
#decrypt-info" <?php echo 'onclick="var ch = document.getElementById(\'decrypt-hints\').childNodes;for(var i=0;i < ch.length;++i) {var e = ch[i]; decrypt(e);}'; ?>
 document.getElementById('crypt-text').innerHTML = (bNoCrypt ? 'Descripción' : 'Encrypt');
                bNoCrypt = 1 - bNoCrypt;
                return false;"><span id="crypt-text">Descripción</span></a><?php endif; ?></span>
            </span>
        </p>
    </div>
...
/images/viewcache/npa.gif" align="left" style="margin-right: 25px;" width="32" height="32" alt="" />
                ¡Este geocache está probablemente situado dentro de una zona de protección de la naturaleza! Mira <?php echo $this->_tpl_vars['npahelplink']; ?>
aqui</a> para obtener más información, por favor.<br />
...
" target="_blank">Información</a>)<?php if (! ($this->_foreach['npaareas']['iteration'] == $this->_foreach['npaareas']['total'])): ?>,<?php endif; ?>
                <?php endforeach; endif; unset($_from); ?>
            </p>
        </div>
    <?php endif; ?>
    ...
    <?php if (count ( $this->_tpl_vars['npaareasNoWarning'] ) > 0): ?>
        <p style="line-height: 1.6em;">
            Este geocache está probablemente en las siguientes áreas protegidas (<?php echo $this->_tpl_vars['npahelplink']; ?>
Info</a>):
...
/images/viewcache/rating-star.gif" class="icon16" alt="" />
                Mostrar recomendaciones de los usuarios que recomiendan este geocaché: <a href="recommendations.php?cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
">all</a>
                <br />
            <?php endif; ?>
...
&distance=150&unit=km" rel="nofollow">todo</a> -
...
&distance=150&unit=km" rel="nofollow">búsqueda</a> -
            <a href="search.php?searchto=searchbywaypoint&showresult=1&expert=0&output=HTML&sort=bydistance&f_userowner=1&f_userfound=1&f_inactive=1&f_disabled=1&waypoint=<?php echo $this->_tpl_vars['cache']['wpoc']; ?>
&distance=150&unit=km&cachetype=<?php echo $this->_tpl_vars['cache']['type']; ?>
" rel="nofollow">mismo tipo</a>
            <br />

            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-search.png" class="icon16" alt="" /> Envia el waypoint al GPS: <a href="#" onclick="window.open('<?php echo $this->_tpl_vars['garmin_url']; ?>
garmin.php?&lat=<?php echo $this->_tpl_vars['cache']['latitude']; ?>
&lon=<?php echo $this->_tpl_vars['cache']['longitude']; ?>
&wp=<?php echo $this->_tpl_vars['cache']['wpoc']; ?>
&templocale=<?php echo $this->_tpl_vars['opt']['template']['locale']; ?>
','Enviar','width=640,height=320,resizable=no,scrollbars=1')">Garmin</a><br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-save.png" class="icon16" alt="" /> Descargar como archivo:
...
&output=gpx" rel="nofollow" title="Formato .gpx">GPX</a> -
            <a href="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&f_ignored=0&startat=0&cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
&output=loc" rel="nofollow" title="Fichero waypoint .loc">LOC</a> -
            <a href="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&f_ignored=0&startat=0&cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
...
&output=txt" rel="nofollow" title="Fichero de texto .txt">TXT</a>
            <br />

            <small>
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-info.png" class="icon16" alt="" />
                Al descargar este archivo, aceptas nuestros <a href="articles.php?page=impressum#tos">terminos de uso</a> y <a href="articles.php?page=impressum#datalicense" target="_blank">Licencia de Datos</a>.            </small>
            <br />
        </p>
    <?php endif; ?>
</div>
...
&log=A#logentries">Mostrar todas las entradas de logs</a>]</span>
            </p>
        </div>
