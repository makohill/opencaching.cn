...
/images/misc/32x32-home.png" style="margin-right: 10px;" width="32" height="32" />
    Profilo utente di <?php echo $this->_tpl_vars['username']; ?>
...
"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/16x16-email.png" width="16" height="16" border="0" alt="Invia email" align="middle" /></a>&nbsp;
    [<a href="mailto.php?userid=<?php echo $this->_tpl_vars['userid']; ?>
">Invia email</a>]
</div>
...
<table class="table">
    ...
    <tr>
        <td style="vertical-align:top"><b>Ultima&nbsp;autenticazione:</b></td>
        <?php if ($this->_tpl_vars['lastlogin'] == 1): ?>
            <td>Entro l'ultimo mese</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 2): ?>
            <td>Tra 1 e 6 mesi</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 3): ?>
            <td>Tra 6 e 12 mesi</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 4): ?>
            <td>Tra 1 e 2 anni</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 5): ?>
            <td>Più di 12 anni fa</td>
        <?php elseif ($this->_tpl_vars['lastlogin'] == 7): ?>
            <?php if ($this->_tpl_vars['license_actively_declined']): ?>
                <td>L'account utente è stato disabilitato perhcè l'utente ha rifiutato la <a href="articles.php?page=impressum#datalicense">licenza dati</a>. La descrizione della cache, i testi del log e le immagini sono state cancellate.</td>
            <?php elseif ($this->_tpl_vars['license_passively_declined']): ?>
                <td>L'utente è stato disabilitato. La descrizione della cache, i messaggi di log e le immagini sono state cancellate perché l'account è stato cancellato dopo il passaggio alla <a href="articles.php?page=impressum#datalicense">nuova licenza dati</a>.</td>
            <?php else: ?>
                <td>L'utente è stato disabilitato.</td>
            <?php endif; ?>
        <?php else: ?>
            <td>unknown</td>
        <?php endif; ?>
...
<span></span>:</b></td>
    ...
    <?php if ($this->_tpl_vars['pmr'] == 1): ?>
        <tr>
            <td style="vertical-align:top;"><b>Altro:</b></td>
            <td>
                Ho con me una radio PMR sul canale 2.<br />
            </td>
        </tr>
    <?php endif; ?>
    ...
    <?php else: ?>
        <tr>
            <td valign="middle" class="header-small" style="white-space:nowrap" width="1%">
                ...
                &nbsp;<b>Statistiche OConly-81:</b>
            </td>
            <td valign="middle">
                inactive (<a href="oconly81.php">Informazioni</a>)
            </td>
        </tr>
        <tr><td class="spacer"></td></tr>
        <tr><td class="spacer"></td></tr>
