...
<form name="change" action="change_statpic.php" method="post" enctype="application/x-www-form-urlencoded" style="display: inline;">
    <table class="table">
        ...
        <tr>
            <td colspan="2">
                <b>Folgende Einstellungen sind für dein Statistikbild gespeichert:</b><br />
            </td>
        </tr>
        <tr><td class="spacer" colspan="2"></td></tr>

        <tr>
            <td>Angezeigter Text:</td>
            <td>
...
" class="input200"/>
        ...
        <tr>
            <td colspan="2"><br /><b>Offizielle OC-Logos (up-to-date):</b></td>
            <td class="help"></td>
...
" align="middle"></td>
        ...
        <tr>
            <td colspan="2"><br /><b>Alternative Logos (teilweise veraltet):</b></td>
            <td class="help"></td>
            <td style="width:15%"></td>
            <td style="width:15%"></td>
        </tr>
...
" align="middle"></td>
        ...
        <tr>
            <td colspan="3">
                <br />Nach dem Speichern musst du evtl. auf den Seiten-Neuladeknopf deines Browsers drücken, um das gewählte Bild in deinem Profil zu sehen.
            </td>
        </tr>
    </table>
</form>