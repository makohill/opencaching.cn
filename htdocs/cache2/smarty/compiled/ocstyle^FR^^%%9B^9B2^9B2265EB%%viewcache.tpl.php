...
Charger d'autres logs ...<?php echo '";
...
<?php if ($this->_tpl_vars['cache']['userhasfound'] || $this->_tpl_vars['cache']['needs_maintenance'] || $this->_tpl_vars['cache']['listing_outdated'] || $this->_tpl_vars['cache']['status'] == 2 || $this->_tpl_vars['cache']['status'] == 3 || $this->_tpl_vars['cache']['status'] == 6 || $this->_tpl_vars['cache']['status'] == 7): ?>
    <div id="havefound">
        <?php echo '<p>'; ?><?php if ($this->_tpl_vars['cache']['status'] == 2): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/32x32-disabled.png" width="32" height="32" style="padding-right: 6px;" alt="temporairement non disponible" title="temporairement non disponible" />'; ?><?php elseif ($this->_tpl_vars['cache']['status'] == 3): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/32x32-archived.png" width="32" height="32" style="padding-right: 6px;" alt="archivé" title="archivé" />'; ?><?php elseif ($this->_tpl_vars['cache']['status'] == 6): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/32x32-locked.png" width="32" height="32" style="padding-right: 6px;" alt="fermé" title="fermé" />'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['needs_maintenance']): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/needs-maintenance.png" width="32" height="32" style="padding-right: 5px;" alt="La géocache a besoin de maintenance." title="La géocache a besoin de maintenance." />'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['listing_outdated']): ?><?php echo '<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/cachestatus/listing-outdated.png" width="32" height="32" style="padding-right: 5px;" alt="La description de géocache est obsolète." title="La description de géocache est obsolète." />'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['userhasfound']): ?><?php echo '&nbsp;<img src="resource2/'; ?><?php echo $this->_tpl_vars['opt']['template']['style']; ?><?php echo '/images/viewcache/have-found.png" width="35" height="35" style="padding-right: 5px;" alt="'; ?><?php if ($this->_tpl_vars['cache']['type'] == 6): ?><?php echo 'Vous avez assisté à cet événement&nbsp;!'; ?><?php else: ?><?php echo 'Vous avez déjà trouvé cette cache&nbsp;!'; ?><?php endif; ?><?php echo '" title="'; ?><?php if ($this->_tpl_vars['cache']['type'] == 6): ?><?php echo 'Vous avez assisté à cet événement&nbsp;!'; ?><?php else: ?><?php echo 'Vous avez déjà trouvé cette cache&nbsp;!'; ?><?php endif; ?><?php echo '" />'; ?><?php endif; ?><?php echo '</p>'; ?>
...
<?php endif; ?>">Enregistrer un log</a></li>
                <?php endif; ?>
...
%26watchinfo=1">Ne regardez pas</a></li>
                <?php else: ?>
...
&amp;action=removeignore">N'ignorez pas</a></li>
                    <?php else: ?>
                        <li class="group"><a style="background-image: url(resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/ignore-18.png);background-repeat:no-repeat;background-position:left center;" href="ignore.php?cacheid=<?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['cacheid'])) ? $this->_run_mod_handler('urlencode', true, $_tmp) : smarty_modifier_urlencode($_tmp)); ?>
&amp;action=addignore">Ignorer</a></li>
                    <?php endif; ?>
                <?php endif; ?>
                <li class="group"><a style="background-image: url(resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
/images/viewcache/16x16-info.png" class="icon16" alt="Info" />
                    Vous êtes toujours en train de regarder cette géocache via une ou plusieurs listes de cache.
                </p>
            </div>
        <?php endif; ?>
        <div class="buffer" style="width: 500px;">&nbsp;</div>
...
unset($_smarty_tpl_vars);
 ?></a></div>
        ...
        <div class="content2-container-2col-left" id="cache_name_block">
            ...
            <p>par&nbsp;<b><a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cache']['userid']; ?>
...
&popup=y','Liste','width=320,height=440,resizable=no,scrollbars=1')">Liste des participants</a></span>
            <?php endif; ?>
        </div>
    </div>
</div>
...
/images/misc/hint.gif" border="0" width="15" height="11" alt="" align="middle" />
            Des photos de spoiler qui montrent les détails de la cachette ne devraient pas être visibles ici. Si vous rencontrez un spoiler visible ouverte, vous pouvez communiquer avec l'enregistreur par le bouton e-mail dans son profil et lui demander de le marquer comme spoiler.<br />
        <?php endif; ?>
    </div>
...
','Coordonnées','width=280,height=550,resizable=no,scrollbars=1')">Autres systèmes de coordonnées</a><br />
            <!-- <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/box.png" class="icon16" alt="" title="" align="middle" />&nbsp;Cache type: <b>Traditional</b><br /> -->
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/package_green.png" class="icon16" alt="" title="" align="middle" />&nbsp;Taille&nbsp;: <b><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['sizeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</b><br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/page.png" class="icon16" alt="" title="" align="middle" />
            <?php if ($this->_tpl_vars['cache']['status'] != 1): ?>                  Statut&nbsp;: <span class="errormsg"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
            <?php else: ?>
                Statut&nbsp;: <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

            <?php endif; ?><br />
            <?php if ($this->_tpl_vars['cache']['searchtime'] > 0): ?>
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/time.png" class="icon16" alt="" title="" align="middle" />&nbsp;Temps nécessaire&nbsp;: <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['searchtime'])) ? $this->_run_mod_handler('format_hour', true, $_tmp) : smarty_modifier_format_hour($_tmp)); ?>
 h&nbsp;
            <?php endif; ?>
...
/images/viewcache/arrow_roundtrip.png" class="icon16" alt="" title="" align="middle" />&nbsp;Distance&nbsp;: <?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km</span>
            <?php endif; ?>
            <?php if ($this->_tpl_vars['cache']['searchtime'] > 0 || $this->_tpl_vars['cache']['waylength'] > 0): ?><br /><?php endif; ?>
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/date.png" class="icon16" alt="" title="" align="middle" />&nbsp;<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>Date de l'événement&nbsp;:<?php else: ?>Caché en&nbsp;:<?php endif; ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datehidden'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
<br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/date.png" class="icon16" alt="" title="" align="middle" />&nbsp;<?php if ($this->_tpl_vars['cache']['is_publishdate'] == 0): ?>Affiché depuis&nbsp;:<?php else: ?>Publié le&nbsp;:<?php endif; ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datecreated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
<br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/date.png" class="icon16" alt="" title="" align="middle" />&nbsp;Dernière mise à jour&nbsp;: <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['lastmodified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
<br />              <!-- Ocprop: <br /> Wegpunkt: <b><?php echo $this->_tpl_vars['cache']['wpoc']; ?>
</b><br /> -->
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/arrow_in.png" class="icon16" alt="" title="" align="middle" />&nbsp;Inscription&nbsp;: <?php if ($this->_tpl_vars['shortlink_url'] !== false): ?><?php echo $this->_tpl_vars['shortlink_url']; ?>
...
/images/viewcache/link.png" class="icon16" alt="" title="" align="middle" />
                Aussi listé au&nbsp;:                  <?php if ($this->_tpl_vars['cache']['wpgc'] != ''): ?>
...
&logpics=1"><?php endif; ?><?php if ($this->_tpl_vars['logpics'] == 1): ?>Image de log<?php else: ?>Images de log<?php endif; ?><?php if ($this->_tpl_vars['logpics'] > 0): ?></a><?php endif; ?></span><br />
                            <span style="white-space:nowrap;"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
" target="_blank">Histoire de Geokrety</a></span><br />
...
" target="_blank"><span style="line-height:1.5em">Grande carte</span></a></p>
            </td>
        </tr>
...
/images/viewcache/print-18.png" class="icon16" alt="" />
                <select class="exportlist" onchange="location.href=this.options[this.selectedIndex].value+'&nocrypt='+bNoCrypt">
                    <option value="#">Vue d'impression …</option>
...
&<?php endif; ?>print=y&log=N">sans logs</option>
                    <option value="viewcache.php?cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
&<?php if ($this->_tpl_vars['desclang']): ?>desclang=<?php echo $this->_tpl_vars['desclang']; ?>
&<?php endif; ?>print=y&log=5">avec 5 logs</option>
                    <option value="viewcache.php?cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
&<?php if ($this->_tpl_vars['desclang']): ?>desclang=<?php echo $this->_tpl_vars['desclang']; ?>
&<?php endif; ?>print=y&log=10">avec 10 logs</option>
                    <option value="viewcache.php?cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
&<?php if ($this->_tpl_vars['desclang']): ?>desclang=<?php echo $this->_tpl_vars['desclang']; ?>
&<?php endif; ?>print=y&log=A">avec tous les logs</option>
                </select>&nbsp;
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-save.png" class="icon16" alt="" />
                <select class="exportlist" onchange="location.href=this.options[this.selectedIndex].value">
                    <option value="#">Télécharger en tant que ...</option>
...
/images/viewcache/14x19-gps-device.png" class="icon16" alt="" />
                <input type="button" class="exportbutton" value="Envoyer à un appareil GPS" onclick="window.open('<?php echo $this->_tpl_vars['garmin_url']; ?>
...
','Envoyer','width=640,height=320,resizable=no,scrollbars=1')" />
            </p></td>
        </tr>
    </table>
...
/images/misc/16x16-list.png" title="Liste de cache" style="padding-right:1px"/></a> <b>Listes de cache</b></p>
                <?php $this->assign('n', '0'); ?>
...
?>
                    ...
                    <?php if ($this->_tpl_vars['n'] == 5 && count($this->_tpl_vars['cachelists']) > 5): ?>
                        <p id="morelists" style="padding:0; line-height:1em"><a href="javascript:showalllists()">plus ...</a></p>
                    <?php endif; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php if ($this->_tpl_vars['cachelist']['user_id'] != $this->_tpl_vars['login']['userid'] || ( $this->_tpl_vars['cachelist']['visibility'] == 3 && $this->_tpl_vars['cache']['show_cachelists'] )): ?> par <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['cachelist']['user_id']; ?>
...
</a><?php else: ?><span class="greytext"> (<?php if ($this->_tpl_vars['cachelist']['visibility'] == 3): ?>caché [cachelist]<?php elseif ($this->_tpl_vars['cachelist']['visibility'] == 2): ?>semi-public<?php else: ?>privé<?php endif; ?>)</span><?php endif; ?>
                    </p>
...
/images/description/20x20-compass.png" style="margin-right: 10px;" alt="" />
            Des waypoints supplémentaires <span id="convert_waypoints">&nbsp; <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/map.png" class="icon16" style="margin-right: 10px;" alt="" /><span class="content-title-link" ><a href="javascript:enable_wpt_conversion()">Autres systèmes de coordonnées</a></span></span>
        </p>
    </div>
...
&country=<?php echo $this->_tpl_vars['cache']['countryCode']; ?>
&desclang=<?php echo $this->_tpl_vars['cache']['desclanguage']; ?>
','Coordonnées','width=280,height=550,resizable=no,scrollbars=1')">convertir</a></td>
...
<?php if ($this->_tpl_vars['cache']['hint'] != ''): ?>
    <div class="content2-container bg-blue02">
      <p class="content-title-noshade-size2">
          <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/description/22x22-encrypted.png" style="margin-right: 10px;" width="22" height="22" alt="" /> Indice additionnels&nbsp;&nbsp;
...
#decrypt-info" <?php echo 'onclick="var ch = document.getElementById(\'decrypt-hints\').childNodes;for(var i=0;i < ch.length;++i) {var e = ch[i]; decrypt(e);}'; ?>
 document.getElementById('crypt-text').innerHTML = (bNoCrypt ? 'Déchiffrer' : 'Encrypt');
                bNoCrypt = 1 - bNoCrypt;
                return false;"><span id="crypt-text">Déchiffrer</span></a><?php endif; ?></span>
            </span>
        </p>
    </div>
...
/images/viewcache/npa.gif" align="left" style="margin-right: 25px;" width="32" height="32" alt="" />
                Cette géocache est probablement placé dans une zone de protection de la nature&nbsp;! Voir <a href="<?php echo $this->_tpl_vars['npahelplink']; ?>
...
" target="_blank">Infos</a>)<?php if (! ($this->_foreach['npaareas']['iteration'] == $this->_foreach['npaareas']['total'])): ?>,<?php endif; ?>
                <?php endforeach; endif; unset($_from); ?>
            </p>
        </div>
    <?php endif; ?>
    ...
    <?php if (count ( $this->_tpl_vars['npaareasNoWarning'] ) > 0): ?>
        <p style="line-height: 1.6em;">
            Cette géocache est probablement placé dans les zones de protection suivantes (<a href="<?php echo $this->_tpl_vars['npahelplink']; ?>
">Info</a>)&nbsp;:
...
/images/viewcache/rating-star.gif" class="icon16" alt="" />
                Montrer les recommandations de cache des utilisateurs qui ont recommandé ce géocache&nbsp;: <a href="recommendations.php?cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
">tout</a>
                <br />
            <?php endif; ?>
...
&distance=150&unit=km" rel="nofollow">tous</a> -
...
&distance=150&unit=km" rel="nofollow">trouvable</a> -
            <a href="search.php?searchto=searchbywaypoint&showresult=1&expert=0&output=HTML&sort=bydistance&f_userowner=1&f_userfound=1&f_inactive=1&f_disabled=1&waypoint=<?php echo $this->_tpl_vars['cache']['wpoc']; ?>
&distance=150&unit=km&cachetype=<?php echo $this->_tpl_vars['cache']['type']; ?>
" rel="nofollow">même type</a>
            <br />

            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-search.png" class="icon16" alt="" /> Envoyer cette waypoint à un appareil GPS&nbsp;: <a href="#" onclick="window.open('<?php echo $this->_tpl_vars['garmin_url']; ?>
garmin.php?&lat=<?php echo $this->_tpl_vars['cache']['latitude']; ?>
&lon=<?php echo $this->_tpl_vars['cache']['longitude']; ?>
&wp=<?php echo $this->_tpl_vars['cache']['wpoc']; ?>
&templocale=<?php echo $this->_tpl_vars['opt']['template']['locale']; ?>
','Envoyer','width=640,height=320,resizable=no,scrollbars=1')">Garmin</a><br />
            <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-save.png" class="icon16" alt="" /> Télécharger en fichier&nbsp;:
...
&output=gpx" rel="nofollow" title="GPS Exchange Format .gpx">GPX</a> -
            <a href="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&f_ignored=0&startat=0&cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
&output=loc" rel="nofollow" title="Fichier waypoint .loc">LOC</a> -
            <a href="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&f_ignored=0&startat=0&cacheid=<?php echo $this->_tpl_vars['cache']['cacheid']; ?>
...
&output=txt" rel="nofollow" title="Fichier text .txt">TXT</a>
            <br />

            <small>
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-info.png" class="icon16" alt="" />
                Lors du téléchargement de ce fichier, vous acceptez nos <a href="articles.php?page=impressum#tos">conditions d'utilisation</a> et <a href="articles.php?page=impressum#datalicense" target="_blank">la licence de données</a>.            </small>
            <br />
        </p>
    <?php endif; ?>
</div>
...
&log=A#logentries">Afficher tous les logs</a>]</span>
            </p>
        </div>
