...
function _radio_click(){
        ...
        {
            alert("'; ?>
¡La distancia máxima debe ser un número!<?php echo '");
        ...
        {
            alert("'; ?>
La distancia debe estar comprendida entre 0 y 9999<?php echo '");
            resetbutton(\'submit_dist\');
            return false;
        }
...
function _sbn_click()
{
    ...
    {
        alert("'; ?>
Insertar un nombre, Por favor.<?php echo '");
...
function _sbft_click()
{
    ...
    {
        alert("'; ?>
¡Completa el campo de texto, por favor!<?php echo '");
    ...
    {
        alert("'; ?>
¡Tienes que comprobar al menos un campo!<?php echo '");
        resetbutton(\'submit_ft\');
        return false;
    }
...
function _sbd_click()
{
    ...
    {
        alert("'; ?>
La longitud tiene que ser un número !\nFormato: hh° mm.mmm<?php echo '");
        resetbutton(\'submit_dist\');
        return false;
    }
    ...
    {
        alert("'; ?>
La latitud tiene que ser un número !\nFormato: hh° mm.mmm<?php echo '");
        resetbutton(\'submit_dist\');
        return false;
    }
    return true;
...
function _sbo_click()
{
    ...
    {
        alert("'; ?>
¡Insertar un propietario, por favor!<?php echo '");
...
function _sbf_click()
{
    ...
    {
        alert("'; ?>
¡Insertar un usuario, por favor!<?php echo '");
...
<div class="content2-pagetitle"><img src="resource2/ocstyle/images/misc/32x32-search.png" style="margin-right: 10px;" width="32" height="32" alt="" />Buscar por caches</div>
...
<div class="searchdiv2">
    <table class="table">
        <tr>
            <td class="formlabel">Ocultar los siguientes caches:</td>
            <td colspan="4">
                <input type="checkbox" name="f_userowner" value="1" id="l_userowner" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userowner_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userowner" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>Mís Escondidos</label> &nbsp;
                <input type="checkbox" name="f_userfound" value="1" id="l_userfound" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userfound_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userfound" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>Mis Encontrados</label> &nbsp;
                <input type="checkbox" name="f_ignored" value="1" id="l_ignored" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_ignored_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_ignored" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>Ignorados</label> &nbsp;
                ...
                <nobr><input type="checkbox" name="f_inactive" value="1" id="l_inactive" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_inactive_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_inactive">archivado</label></nobr> &nbsp;
                <br />
                <nobr><input type="checkbox" name="f_otherPlatforms" value="1" id="l_otherPlatforms" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_otherPlatforms_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_otherPlatforms">Registro multiple (waypoint presente en gc.com)</label></nobr> &nbsp;
        ...
        <tr>
            <td class="formlabel">Tipo de cache:</td>
            <td>
                <?php $_from = $this->_tpl_vars['cachetypes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ct']):
?>
...
unset($_smarty_tpl_vars);
 ?>&nbsp;
                <?php endforeach; endif; unset($_from); ?>
                &nbsp;&nbsp;<a href="javascript:alltypes(true)">todo</a>
        ...
        <tr>
            <td class="formlabel">Tamaño del cache:</td>
            <td colspan="4">
                ...
                <input type="checkbox" id="cachesize3" name="cachesize3" value="3" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['3']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize3" style="font-size:1.0em">pequeño</label> &nbsp;
                ...
                <nobr><input type="checkbox" id="cachesize6" name="cachesize6" value="6" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['6']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize6" style="font-size:1.42em">muy grande</label></nobr>
                <br />
                <input type="checkbox" id="cachesize1" name="cachesize1" value="1" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['1']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize1">otro tamaño</label> &nbsp; <input type="checkbox" id="cachesize7" name="cachesize7" value="7" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['7']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize7">sin contenedor</label>
                &nbsp;
                &nbsp;&nbsp;<a href="javascript:allsizes(true)">todo</a>
        ...
        <tr>
            <td class="formlabel">Dificultad:</td>
            <td colspan="4">
...
<?php endif; ?></option>
        ...
        <tr>
            <td class="formlabel">País:&nbsp;&nbsp;</td>
            <td>
                <select name="country" onchange="sync_options(this)">
                    <option value="" <?php if ($this->_tpl_vars['all_countries']): ?>selected="selected"<?php endif; ?>>Todos los paises</option>
...
" <?php if ($this->_tpl_vars['countryoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['countryoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;
                <span class="formlabel">Idioma:&nbsp;&nbsp;</span>
                <select name="language" onchange="sync_options(this)">
                    <option value="" <?php if ($this->_tpl_vars['all_languages']): ?>selected="selected"<?php endif; ?>>Todos los idiomas</option>
...
" <?php if ($this->_tpl_vars['languageoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['languageoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <tr>
            <td valign="top">
                <span class="formlabel">Atributos del cache:</span>&nbsp;<br />
                (<a href="javascript:switchAttributeCat2()"><span id="toggleAttributesCaption" style="white-space:nowrap">Mostrar todo</span></a>)
            </td>
...
<div class="searchdiv2">
    <table class="table">
        <tr>
            <td class="formlabel" rowspan="2">Ordenar los resultados por:</td>
            <td colspan="4" style="padding-bottom:0">
                <input type="radio" name="sort" value="byname" index="0" id="l_sortbyname" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['byname_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbyname">Nombre del caches</label> &nbsp;
                <input type="radio" name="sort" value="bydistance" index="1" id="l_sortbydistance" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bydistance_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbydistance">Distancia</label> &nbsp;
                <input type="radio" name="sort" value="bycreated" index="2" id="l_sortbycreated" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bycreated_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbycreated">Listado desde</label> &nbsp;
                <nobr><input type="radio" name="sort" value="bylastlog" index="3" id="l_sortbylastlog" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bylastlog_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbylastlog" >Último log</label> &nbsp;
        ...
        <tr>
            <td style="padding-top:0">
                ...
                <label for="orderRatingFirst">Mostar primero las recomendaciones de otros usuarios</label>
            </td>
        </tr>
    </table>
</div>
...
" maxlength="4" class="input50" />&nbsp;
                <select name="unit" class="input100">
                    <option value="km" <?php if ($this->_tpl_vars['sel_km']): ?>selected="selected"<?php endif; ?>>Kilómetros</option>
                    <option value="sm" <?php if ($this->_tpl_vars['sel_sm']): ?>selected="selected"<?php endif; ?>>Millas</option>
                    <option value="nm" <?php if ($this->_tpl_vars['sel_nm']): ?>selected="selected"<?php endif; ?>>Milla marítima</option>
                </select>
            </td>
        </tr>
        <tr>
...
" maxlength="7" class="input70" onfocus="textonfocus(1)"/></td>
        ...
        <tr>
            <td valign="top"><input type="radio" id="sbdis" name="searchto" value="searchbydistance" <?php if ($this->_tpl_vars['dbydistance_checked']): ?>checked="checked"<?php endif; ?>><label for="sbdis">... de las coordenadas:</label></td>
            <td valign="top">
...
" class="input50" onfocus="textonfocus(2)"/>&nbsp;'&nbsp;
            ...
            <td><input type="submit" name="submit_dist" value="Buscar" class="formbutton" onclick="submitbutton('submit_dist')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Nombre del caches<span></span>:</td>
            <td><input type="text" name="cachename" value="<?php echo $this->_tpl_vars['cachename']; ?>
" class="input200" /></td>
            <td><input type="submit" name="submit_cachename" value="Buscar" class="formbutton" onclick="submitbutton('submit_cachename')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Texto<span></span>:</td>
            <td><input type="text" name="fulltext" value="<?php echo $this->_tpl_vars['fulltext']; ?>
" class="input200" /></td>
            <td><input type="submit" name="submit_ft" value="Buscar" class="formbutton" onclick="submitbutton('submit_ft')" /></td>
        </tr>
        <tr>
            <td>... in<span></span>:</td>
            <td colspan="4">
                <input type="checkbox" name="ft_desc" id="ft_desc" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_desc_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_desc">Descripción</label> &nbsp;
                <input type="checkbox" name="ft_name" id="ft_name" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_name_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_name">Nombre del caches</label> &nbsp;
                <input type="checkbox" name="ft_pictures" id="ft_pictures" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_pictures_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_pictures">Imagenes</label> &nbsp;
...
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_owner" value="Buscar" class="formbutton" onclick="submitbutton('submit_owner')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Entradas de registro:</td>
            <td colspan="2">
                <select name="logtype">
...
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_finder" value="Buscar" class="formbutton" onclick="submitbutton('submit_finder')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            ...
            <td></td>
            <td><input type="submit" name="submit_all" value="Buscar" class="formbutton" onclick="submitbutton('submit_all')" /></td>
        </tr>
    </form>
    <?php endif; ?>
