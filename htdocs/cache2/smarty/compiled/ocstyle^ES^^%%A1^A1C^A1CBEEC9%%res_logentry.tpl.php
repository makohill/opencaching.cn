...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
            ...
            Log de entrada por <?php echo $this->_smarty_vars['capture']['cachename']; ?>

            <span style="font-weight: 400;">&nbsp;&nbsp;
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>attended<?php else: ?>found<?php endif; ?>.png" width="16" height="16" align="middle" border="0" alt="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>asistió<?php else: ?>encuentran<?php endif; ?>" title="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>asistió<?php else: ?>encuentran<?php endif; ?>" /> <?php echo $this->_tpl_vars['cache']['found']; ?>
x
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>will_attend<?php else: ?>dnf<?php endif; ?>.png" width="16" height="16" align="middle" border="0" alt="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>asistiré<?php else: ?>no encontrado<?php endif; ?>" title="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>asistiré<?php else: ?>no encontrado<?php endif; ?>" /> <?php if ($this->_tpl_vars['cache']['type'] == 6): ?><?php echo $this->_tpl_vars['cache']['willattend']; ?>
...
">Volver a la lista de geocache</a>]</span></p>
    <?php endif; ?>
    </div>
<?php endif; ?>
