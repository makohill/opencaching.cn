...
/images/misc/32x32-home.png" style="margin-right: 10px;" width="32" height="32" />
    Gebruikersprofiel van <?php echo $this->_tpl_vars['username']; ?>
...
"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/16x16-email.png" width="16" height="16" border="0" alt="E-Mail sturen" align="middle" /></a>&nbsp;
    [<a href="mailto.php?userid=<?php echo $this->_tpl_vars['userid']; ?>
">E-Mail sturen</a>]
</div>
...
<span></span>:</b></td>
    ...
    <?php if ($this->_tpl_vars['pmr'] == 1): ?>
        <tr>
            <td style="vertical-align:top;"><b>Anders:</b></td>
            <td>
                Ik neem een PMR zender mee op kanaal 2 met het cachen<br />
            </td>
        </tr>
    <?php endif; ?>
