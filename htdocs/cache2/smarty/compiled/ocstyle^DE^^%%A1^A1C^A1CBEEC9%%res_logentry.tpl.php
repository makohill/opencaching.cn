...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
            ...
            Logeinträge für <?php echo $this->_smarty_vars['capture']['cachename']; ?>

            <span style="font-weight: 400;">&nbsp;&nbsp;
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>attended<?php else: ?>found<?php endif; ?>.png" width="16" height="16" align="middle" border="0" alt="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>teilgenommen<?php else: ?>gefunden<?php endif; ?>" title="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>teilgenommen<?php else: ?>gefunden<?php endif; ?>" /> <?php echo $this->_tpl_vars['cache']['found']; ?>
x
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>will_attend<?php else: ?>dnf<?php endif; ?>.png" width="16" height="16" align="middle" border="0" alt="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>möchte teilnehmen<?php else: ?>nicht gefunden<?php endif; ?>" title="<?php if ($this->_tpl_vars['cache']['type'] == 6): ?>möchte teilnehmen<?php else: ?>nicht gefunden<?php endif; ?>" /> <?php if ($this->_tpl_vars['cache']['type'] == 6): ?><?php echo $this->_tpl_vars['cache']['willattend']; ?>
<?php else: ?><?php echo $this->_tpl_vars['cache']['notfound']; ?>
<?php endif; ?>x
                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-note.png" width="16" height="16" align="middle" border="0" alt="Hinweis" title="Hinweis" /> <?php echo $this->_tpl_vars['cache']['note']; ?>
x
                <?php if ($this->_tpl_vars['cache']['maintenance']): ?><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/viewcache/16x16-maintenance_shifted.png" width="16" height="16" align="middle" border="0" alt="Wartung" title="Wartung"> <?php echo $this->_tpl_vars['cache']['maintenance']; ?>
x<?php endif; ?>
                <br />
            </span>
        </p>
