...
</span></a></span> &nbsp;by <a href="viewprofile.php?userid=<?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['user_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
</a> by <a href="viewprofile.php?userid=<?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['user_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a> --></td>
...
" colspan="2" valign="top">
    <p class="truncate">
        <?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] < 4): ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 0): ?><?php echo '<img src="images/rating-star.gif" title="Recommendations" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 1): ?><?php echo '<img src="images/rating-star.gif" title="Recommendations" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 2): ?><?php echo '<img src="images/rating-star.gif" title="Recommendations" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['cache']['topratings'] > 3): ?><?php echo '<b><span class="txtblack" style="color:#02c602; font-size: 13px;">'; ?><?php echo $this->_tpl_vars['cache']['topratings']; ?><?php echo 'x</span></b><img src="images/rating-star.gif" title="Recommendations" width="14" height="13" style="margin-top: -3px;"/>'; ?><?php endif; ?><?php echo ''; ?>
