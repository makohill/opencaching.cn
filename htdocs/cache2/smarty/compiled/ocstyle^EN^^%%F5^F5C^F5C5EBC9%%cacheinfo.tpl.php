<?php /* Smarty version 2.6.29, created on 2016-06-04 03:37:20
         compiled from articles/EN/cacheinfo.tpl */ ?>

    <div class="content2-pagetitle">
        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/32x32-tools.png" style="margin-right: 10px;" width="32" height="32" alt="" />Information on cache descriptions
    </div>
    <div id="cachedescinfo" class="content-txtbox-noshade" style="padding-right: 25px;">
        ...
        <p>Indications for difficulty rating:
            <table  class="table">
                <tr>
                    <td></td>
                    <td valign="top" style="padding-top:5px;"><img src='./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-10.gif' border='0' width='19' height='16' hspace='2' /></td>
                    <td><b>1</b>: can be found within a few minutes, well suited for beginners</td>
                </tr>
                <tr>
                    <td></td>
                    <td valign="top" style="padding-top:5px;"><img src='./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-20.gif' border='0' width='19' height='16' hspace='2' /></td>
                    <td><b>2</b>: easy to find for experienced geocaches; may be demanding for beginners</td>
                </tr>
                <tr>
                    <td></td>
                    <td valign="top" style="padding-top:5px"><img src='./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-30.gif' border='0' width='19' height='16' hspace='2' /></td>
                ...
                <tr>
                    <td></td>
                    <td valign="top" style="padding-top:5px"><img src='./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-40.gif' border='0' width='19' height='16' hspace='2' /></td>
                ...
                <tr>
                    <td></td>
                    <td valign="top" style="padding-top:5px"><img src='./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-50.gif' border='0' width='19' height='16' hspace='2' /></td>
        ...
        <p>Indications for terrain rating:
            <table  class="table">
                <tr>
                    <td></td>
                    <td valign="top" style="padding-top:5px;"><img src='./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-10.gif' border='0' width='19' height='16' hspace='2' /></td>
                    <td><b>1</b>: flat area with evenly paved ways, maximum 0.8&nbsp;km (halve a mile) total route; suited for handicapped people</td>
                </tr>
                <tr>
                    <td></td>
                    <td valign="top" style="padding-top:5px;"><img src='./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-20.gif' border='0' width='19' height='16' hspace='2' /></td>
...
/images/difficulty/terr-50.gif' border='0' width='19' height='16' hspace='2' /></td>
        ...
        <div class="content2-container bg-blue02">
            <p class="content-title-noshade-size2" style="margin:0 !important">&nbsp;Cache attributes</p>
        </div>
        <p>
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "articles_res_attributes.tpl", 'smarty_include_vars' => array()));
