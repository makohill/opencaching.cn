...
<div class="nav4">
    <ul>
        <li class="group noicon <?php if ($this->_tpl_vars['countryCode'] == ''): ?>selected<?php endif; ?>"><a href="newcaches.php">Tous les caches</a></li>
...
">Caches à <?php echo $this->_tpl_vars['countryName']; ?>
</a></li>
        <li class="group noicon"><a href="newcachesrest.php?country=<?php echo $this->_tpl_vars['opt']['page']['main_country']; ?>
">Nouveaux caches sans <?php echo $this->_tpl_vars['mainCountryName']; ?>
</a></li>
    </ul>
</div>
...
.gif" alt="Géocache événementiel" border="0" width="22" height="22" align="left" style="margin-right: 5px;" /><?php else: ?><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?> par <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['newCache']['userid']; ?>
