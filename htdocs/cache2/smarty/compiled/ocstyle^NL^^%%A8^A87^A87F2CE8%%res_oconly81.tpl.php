...
<?php else: ?><a class="systemlink" href="oconly81.php"><?php endif; ?>OConly-81</a>&nbsp;&nbsp;&nbsp;</nobr><?php endif; ?></th>
        <th class="h1 nodatacell" colspan="11" style="line-height:1.8em">Terrein</th>
    </tr>
    <tr>
        <td></td>
...
?>
        <tr>
            <?php if (($this->_foreach['difficulty']['iteration'] <= 1)): ?>
                <th class="h1" rowspan="9">Moeilijkheid&nbsp;&nbsp;&nbsp;</th>
            <?php endif; ?>
...
<?php endif; ?></th>
    ...
    <?php if ($this->_tpl_vars['userid'] > 0): ?>
        <tr>
            <td colspan="12" style="padding-top:0.5em"><p>The user has found <b><?php echo $this->_tpl_vars['matrixfound']; ?>
</b> of <b>81</b> theoretically possible terrain/difficulty combinations.</p></td>
        </tr>
    <?php endif; ?>
</table>