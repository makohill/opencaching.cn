...
/images/description/20x20-compass.png" style="margin-right: 10px;" alt="" title="Waypoints supplémentaires" />
...
" /></td><td><?php echo $this->_tpl_vars['typeName']; ?>
  ...
  <table class="table">
    <tr>
      <td valign="top">Type de waypoint&nbsp;:</td>
      <td>
        <select name="wp_type" <?php if ($this->_tpl_vars['disabled']): ?>disabled=""<?php endif; ?>>
          <option value="0">Sélectionner le type s'il vous plaît</option>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr>
      <td></td>
      <td>
        <input type="submit" name="back" value="Annuler" class="formbutton" onclick="submitbutton('back')" />&nbsp;&nbsp;
