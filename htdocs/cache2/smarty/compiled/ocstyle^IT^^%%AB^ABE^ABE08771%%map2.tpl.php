<?php /* Smarty version 2.6.29, created on 2016-06-04 03:32:40
...
<?php if ($this->_tpl_vars['old_msie']): ?>
    ...
    function mapLoad()
    {
        document.getElementById(\'googlemap\').innerHTML =
            "<div style=\'position:relative; top:180px; left:10px\'><p>Il tuo Internet Explorer è troppo vecchio per visualizzare la mappa. Aggiorna almeno alla verione 7, meglio la 8.</p></div>";
    }
    -->'; ?>
...
var msSearchHint = "'; ?>
città, cache o waypoint<?php echo '";
...
function updateCopyrights()
{
    ...
    if (newMapType == "OSM" || newMapType == "MQ" || newMapType == "OCM")
    {
        ...
        if (newMapType == "OCM")
            copyrightDiv.innerHTML = 'Dati mappa &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a> e <a href="http://www.thunderforest.com/opencyclemap/" target="_blank">OpenCycleMap</a> contributori';
        else
            copyrightDiv.innerHTML = 'Dati mappa &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a> contributori';
        if (newMapType == "MQ")
            copyrightDiv.innerHTML += ', ' + 'quadri forniti da <a href="http://www.mapquest.com/" target="_blank">MapQuest</a>' + ' <img src="http://developer.mapquest.com/content/osm/mq_logo.png" />';
        <?php echo '
    }
    else
...
function data_mapreceive(data, responseCode)
{
    ...
    if (responseCode != 200)
    {
        var sMessage = \'Errore: Impossibile scaricare i risultati della ricerca (codice di errore HTTP %1)\';
    ...
    if (oXML.documentElement.getAttribute("available") +0 == 0)
    {
        ...
        {
            // alert(\'Errore: Impossibile scaricare i risultati della ricerca. I dati non sono disponibili sul server.\');
            error_no_data(true);
        }
        return;
    }
...
function show_cachepopup_url(sURL, sWaypoint, bAllowZoomChange)
{
    ...
    ajaxLoad(sURL, function(data, responseCode) {
        ...
        if (!oCoords)
        {
            if (sWaypoint != \'\')
            {
                var sMessage = \'Waypoint %1 non trovato!\';
...
function parseXML_GetHTML(xmlobject)
{
    ...
    sHtml += "<tr><td colspan='2' style='vertical-align:top;'>di <a href=" +apos+"viewprofile.php?userid="+encodeURI(nUserId)+apos+ " target='_blank'>" + xmlentities(sUsername) + "</a></td><td align='right'><a class='nooutline' href='articles.php?page=cacheinfo#difficulty' target='_blank'><img src=" + apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-"+String(nDifficulty*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Difficoltà: " + String(nDifficulty) + " di 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /><img src=" +apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-"+String(nTerrain*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Terreno: " + String(nTerrain) + " di 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /></a></td></tr>";
...
<img src='resource2/ocstyle/images/misc/is_oconly_small.png' alt='OConly' title='OConly' /></a>" : "") + "</td></tr>";
    sHtml += "<tr><td colspan='2'>" + (bIsPublishdate == true ? "Pubblicata il:" : "Pubblicata dal:") + " " + xmlentities(sListedSince) + "</td></tr>";

    sAddHtml = "";
    if (bOwner==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/misc/16x16-home.png' alt='' /> Questa cache è tua</td></tr>";

    if (bFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-found.png' alt='' /> Hai già trovato questa cache</td></tr>";

    if (bNotFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-dnf.png' alt='' /> Non hai ancora trovato questa cache</td></tr>";

    if (bAttended==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/log/16x16-attended.png' alt='' /> Hai partecipato a questo evento!</td></tr>";

    if (nGeoKreties>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/gk.png' alt='' /> In questa cache c'è un GeoKrety</td></tr>";

    if (nTopRating>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/rating-star.gif' alt='' /> Questa cache ha %1 raccomandazioni</td></tr>".replace(/%1/, nTopRating);
    ...
    if (oWaypoints.length)
    {
        ...
        if (oWaypoints.length > 1)
            sMsg = "La cache ha %1 %2waypoints addizionali%3.";
        else
            sMsg = "La cache ha un %2waypoints addizionale%3.";
...
function tmd_show(number)
{
    ...
    var sMessage = \'Sono state trovate %1 geocache nella regione selezionata che soddisfano le condizioni di filtro. Zoomare per visualizzare le cache.\';
...
function download_gpx()
{
    ...
    {
        alert('; ?>
"Devono essere visualizzate tra 1 e 500 cache per il download."<?php echo ');
        return;
    }
...
<?php if ($this->_tpl_vars['opt']['template']['locale'] == 'DE'): ?>
    ...
    moGeocoder.geocode( { \'address\': sSearchText },
        function(results, status)
        {
            ...
            {
                var oTempOption = new Option("Luoghi trovati con Google:", -1);
            ...
            ajaxLoad(msURLMapPHP + "?mode=" + searchpar,
                function(data, responseCode) {
                    ...
                    if (caches.length>0)
                    {
                        var oTempOption = new Option("Trovate geocaches, prima le più vicine:", -1);
                        oTempOption.style.color = "gray";
                        moSearchList.options[moSearchList.length] = oTempOption;
                        ...
                        {
                            var item = new Option("     '; ?>
Altri oggetti trovati...<?php echo '", -1);
                            item.style.marginLeft = "20px";
                    ...
                    if (moSearchList.length==0)
                    {
                        mapselectlist_hide();
                        alert("\'" + sSearchText + "\' '; ?>
non è stata trovata (con i settaggi selezionati)<?php echo '");
                        return;
                    }
...
function filter_changed()
{
    if (!bFilterChanged)
    {
        ...
        if (heading.style.color != "#f88c00")
        {
            ...
            heading.innerHTML = "'; ?>
La mappa si sta aggiornando<?php echo ' ...";
...
function save_filter()
{
    ...
    alert("I parametri del filtro corrente sono stati salvati permanentemente.");
    <?php echo '
}
...
').style.display = sShow;
    ...
    tas.innerHTML = (bShow ? "Meno" : "Mostra tutto");
    if (bFullscreen)
...
<div id="<?php if ($this->_tpl_vars['bFullscreen']): ?>fullmap<?php else: ?>smallmap<?php endif; ?>" class="mapframe">
    ...
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
            ...
            <div id="mapstat_caches" class="mapstat_fullscreen" style="z-index:5">Cache visualizzate: <span id="statCachesCount">0</span><span id="statLoadTime" style="display:none">0</span></div>
...
/images/misc/hint.gif" border="0" width="15" height="11" align="middle" />
                Le mappe visualizzate con Microsoft Internet Explorer è lenta e limitata a <?php echo $this->_tpl_vars['maxrecords']; ?>
 geocache. Usa un altro browser per prestazioni migliori.
            </p>
        <?php endif; ?>
    <?php endif; ?>
            ...
            <tr>
                <?php if ($this->_tpl_vars['bFullscreen']): ?>
                    ...
                    <td rowspan="2" class="maplogin">
                        <?php if ($this->_tpl_vars['username'] != ""): ?>Connesso come<br /><a href="myhome.php"><b><?php echo $this->_tpl_vars['username']; ?>
...
<?php endif; ?>"><img src="resource2/ocstyle/images/action/15x13-logout.png" style="margin-bottom:2px" alt="Disconnessione" title="Disconnessione" /></a><?php else: ?><a href="login.php?target=map2.php%3Fmode%3Dfullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>%26queryid%3D<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>">Accesso...</a><?php endif; ?>
                    </td>
                    <td rowspan="2">&nbsp;&nbsp;</td>
                <?php endif; ?>
...
/images/misc/32x32-home.png" alt="Vai alle coordinate home" title="Vai alle coordinate home" /></a></td>
                <?php endif; ?>
...
/images/map/35x35-gpx-download.png" style="margin-left:5px; margin-right:5px" height="35" width="35" alt="Scasica file GPX (max. 500)" title="Scasica file GPX (max. 500)" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="showPermlinkBox_click()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-star.png" style="margin-left:3px; margin-right:1px" height="35" width="35" alt="Visualizza link a questa mappa" title="Visualizza link a questa mappa" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="toggle_settings()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-configure.png" class="mapbutton" style="margin-left:0px; margin-right:2px" height="35" width="35" alt="Impostazioni" title="Impostazioni" /></a></td>

                                <?php if ($this->_tpl_vars['help_map'] != ""): ?>
                    <td rowspan="2"><?php echo $this->_tpl_vars['help_map']; ?>
<img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/32x32-help.png" class="mapbutton" style="margin-left:2px; margin-right:4px" height="32" width="32" alt="Istruzioni" title="Istruzioni" /></a></td>
                <?php endif; ?>
...
/images/map/35x35-normalscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="Passa alla mappa piccola" title="Passa alla mappa piccola" /></a>
                    <?php else: ?>
                        <a class="nooutline" href="map2.php?mode=fullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>&queryid=<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-fullscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="Visualizza a pieno schermo" title="Visualizza a pieno schermo" /></a>
                    <?php endif; ?>
                </td>
        ...
        <table>
            <tr><td><img src="resource2/ocstyle/images/viewcache/link.png" alt="" height="16" width="16" /> Collegamento alla vista della mappa:</td><td align="right"><a href="javascript:permalinkbox_hide()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></td></tr>
            <tr><td><input id="permalink_text" type="text" value="" size="55"/></td></tr>
            <tr id="permalink_addFavorites"><td align="right"><input type="button" value="Aggiungi ai favoriti..." onclick="addFavorites_click()" /></td></tr>
        </table>
    </div>
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
        </div></div>            <?php endif; ?>
    ...
    <?php endif; ?>
            ...
            <div class="maploading">Caricamento mappa ...</div>
...
<?php endif; ?>" method="post" style="display:inline;">
                    ...
                    <table>
                        <tr><td><span style="font-size:1.2em; font-weight:bold">Impostazioni</strong></td><td style="text-align:right"><a href="javascript:toggle_settings()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></tr>
                        <tr><td>Visualizza le opzioni di menù per 'Mappa'</td><td><select name="opt_menumap"><option id="opt_menumap0" value="0">mappa piccola</option><option id="opt_menumap1" value="1">mappa a schermo pieno</option></select></td></tr>
                        <tr><td>Visualizza sovrapposizione mappa:</td><td><input type="checkbox" id="opt_overview" name="opt_overview" value="1" /></td></tr>
                        <tr><td>Massimo numero di caches sulla mappa<br />(<?php echo $this->_tpl_vars['min_maxrecords']; ?>
-<?php echo $this->_tpl_vars['max_maxrecords']; ?>
, 0=automatico):</td><td><input type="text" id="opt_maxcaches" name="opt_maxcaches" size="6" /></td></tr>
                        <?php if ($this->_tpl_vars['msie']): ?>
                            <tr><td colspan="2" style="padding-top:0; white-space:normal">
                                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/hint.gif" alt="" />
                                <small>Al massimo <?php echo $this->_tpl_vars['maxrecords']; ?>
 cache possono essere visualizzate con Microsoft Internet Explorer.
                            </td></tr>
                        <?php endif; ?>
                        <tr><td>Icone cache:</td><td><select name="opt_cacheicons"><option id="opt_cacheicons1" value="1">OC classico<option id="opt_cacheicons2" value="2">stile OKAPI</option></select></td></tr>
                        <tr><td>Visualizza <?php echo $this->_tpl_vars['help_previewpics']; ?>
anteprima immagini</a><br />(% dell'area della mappa, 0=off):</td><td><input type="text" id="opt_pictures" name="opt_pictures" size="2" maxlength="2" /></td></tr>
                        <tr><td colspan="2"><?php if ($this->_tpl_vars['login']['userid'] > 0): ?><input type="button" class="formbutton" value="Cancella" onclick="toggle_settings()"/>&nbsp; <input type="submit" name="submitsettings" class="formbutton" value="OK" onclick="submitbutton('submitsettings')" /><?php else: ?><em>Devi essere autenticato per modificare i settaggi della mappa.</em><?php endif; ?></td></tr>
                    </table>
                </form>
            </div>
...
/images/misc/32x32-search.png" style="padding:2px" alt="Opzioni ricerca" title="Opzioni ricerca" /></a>
            </div>
        <?php endif; ?>
...
/images/map/32x32-left.png" /></a>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td id="filterboxtitle" class="content-title-noshade-size1">Visualizza solo le geocache con le seguenti proprietà:</td>
    ...
    <?php else: ?>
        ...
        <div style="width:770px;text-align:right;"><span id="mapstat_caches">Cache visualizzate: <span id="statCachesCount">0</span></span>, Tempo di caricamento: <span id="statLoadTime">0</span> sec</div>
        <div style="<?php if ($this->_tpl_vars['queryid'] > 0): ?>display:none<?php endif; ?>">
        <p id="filterboxtitle" class="content-title-noshade-size1">Visualizza solo le geocache con le seguenti proprietà:</p>
        ...
        <tr>
            <td class="mapfilter pad10" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>600<?php else: ?>752<?php endif; ?>">
                <table style="width:100%">
                    <tr>
                        <td>
                            <strong>Titolo:</strong>&nbsp; <input type="text" id="cachename" name="cachename" value="" onkeyup="filter_changed()" onchange="filter_changed()" class="input200" /></td>
                        </td>
                        <td style="text-align:right">
                            <input type="button" name="resetfilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Ripristino&nbsp;&nbsp;" onclick="reset_filter()" />&nbsp;
                            <input type="button" name="savefilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Salva&nbsp;&nbsp;" onclick="save_filter()" />&nbsp;
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table>
        <tr>
                ...
                <table>
                    <tr><td colspan="3" class="mapfiltertopic mft_withcheckbox"><input id="all_cachetypes" type="checkbox" checked="checked" onchange="alltypes_changed()" /> <label for="all_cachetypes">Tipo di cache</label></td></tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheTypeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic mft_withcheckbox"><input id="all_cachesizes" type="checkbox" checked="checked" onchange="allsizes_changed()" /> <label for="all_cachesizes">Contenitore</label></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <?php $_from = $this->_tpl_vars['aCacheSize']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheSizeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic">Nascosta</td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userowner" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Mie</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userfound" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Miei ritrovamenti</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                    ...
                    <tr <?php if ($this->_tpl_vars['nongc']): ?>style='display:none'<?php endif; ?>>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_otherPlatforms">GC listing</label>
                                                    </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                ...
                <table>
                    <tr>
                        <td colspan="2" class="mapfiltertopic">Valutazione</td>
                    <tr><td colspan="2"><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    </tr>
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Difficoltà:</td>
                    ...
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Terreno:</td>
                            <?php if ($this->_tpl_vars['bFullscreen']): ?></tr><tr><td colspan="2" style="white-space:nowrap; text-align:right"><?php else: ?><td><?php endif; ?>
        ...
        <tr>
            <td id="attribcell" valign="top" class="mapfilter pad10" style="padding-bottom:2px" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>675<?php else: ?>752<?php endif; ?>">
                <table>
                    <tr><td class="mapfiltertopic">Attribute &nbsp; <span class="mapfiltertopic_add">[<a id="toggle_attribselection" class="jslink" onclick='toggle_attribselection(true)'>Meno</a>]</span></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td>
