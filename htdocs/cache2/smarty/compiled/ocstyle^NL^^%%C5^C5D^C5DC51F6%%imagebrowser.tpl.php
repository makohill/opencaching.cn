...
/images/description/22x22-image.png" height="22px" width="22px" alt="" /> Afbeeldingselectie voor <?php echo ((is_array($_tmp=$this->_tpl_vars['cachename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
    </tr>
</table>
<table class="table">
...
" /></a></td>
        ...
        <?php endif; ?>
    <?php endforeach; else: ?>
        <tr><td>Voor deze cache zijn nog geen afbeeldingen verzonden.</td></tr>
    <?php endif; unset($_from); ?>
</table>
<p><input type="checkbox" id="insertthumb" style="border:0;" /> <label for="insertthumb">Voorbeeld afbeelding toevoegen</label></p>
<p><a href="javascript:CancelSelect();"><a href="javascript:CancelSelect();">Annuleren</a></p>