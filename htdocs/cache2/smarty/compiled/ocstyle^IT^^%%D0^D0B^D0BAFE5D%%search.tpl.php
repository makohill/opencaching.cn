...
function _radio_click(){
        ...
        {
            alert("'; ?>
La distanza massima deve essere un numero!<?php echo '");
        ...
        {
            alert("'; ?>
La distanza deve essere compresa tra 0 e 9999<?php echo '");
            resetbutton(\'submit_dist\');
            return false;
        }
...
function _sbn_click()
{
    ...
    {
        alert("'; ?>
Inserisci un nome, per favore!<?php echo '");
...
function _sbft_click()
{
    ...
    {
        alert("'; ?>
Completa il campo testo, per favore!<?php echo '");
    ...
    {
        alert("'; ?>
Devi selezionare almeno un campo!<?php echo '");
        resetbutton(\'submit_ft\');
        return false;
    }
...
function _sbo_click()
{
    ...
    {
        alert("'; ?>
Inserisci il proprietario, per favore!<?php echo '");
...
function _sbf_click()
{
    ...
    {
        alert("'; ?>
Inserisci l'utente, per favore!<?php echo '");
...
<div class="content2-pagetitle"><img src="resource2/ocstyle/images/misc/32x32-search.png" style="margin-right: 10px;" width="32" height="32" alt="" />Ricerca cache</div>
...
<div class="searchdiv2">
    <table class="table">
        <tr>
            <td class="formlabel">Nascondi le seguenti cache:</td>
            <td colspan="4">
                <input type="checkbox" name="f_userowner" value="1" id="l_userowner" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userowner_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userowner" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>Possedute da me</label> &nbsp;
                <input type="checkbox" name="f_userfound" value="1" id="l_userfound" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userfound_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userfound" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>Miei ritrovamenti</label> &nbsp;
                <input type="checkbox" name="f_ignored" value="1" id="l_ignored" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_ignored_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_ignored" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>Ignorate</label> &nbsp;
                <input type="checkbox" name="f_disabled" value="1" id="l_disabled" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_disabled_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_disabled">disabilitate</label> &nbsp;
                <nobr><input type="checkbox" name="f_inactive" value="1" id="l_inactive" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_inactive_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_inactive">archiviate</label></nobr> &nbsp;
                <br />
                <nobr><input type="checkbox" name="f_otherPlatforms" value="1" id="l_otherPlatforms" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_otherPlatforms_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_otherPlatforms">Registrate su più siti (waypoint presente in gc.com)</label></nobr> &nbsp;
                <nobr><input type="checkbox" name="f_geokrets" value="1" id="l_geokrets" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_geokrets_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_geokrets">without Geokrets</label></nobr>
            </td>
        </tr>
        ...
        <tr>
            <td class="formlabel">Tipo&nbsp;cache:</td>
            <td>
                <?php $_from = $this->_tpl_vars['cachetypes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ct']):
?>
...
unset($_smarty_tpl_vars);
 ?>&nbsp;
                <?php endforeach; endif; unset($_from); ?>
                &nbsp;&nbsp;<a href="javascript:alltypes(true)">tutte</a>
                &nbsp;&nbsp;<a href="javascript:alltypes(false)">nessun</a>
            </td>
        </tr>
        ...
        <tr>
            <td class="formlabel">Dimensioni cache</td>
            <td colspan="4">
                ...
                <input type="checkbox" id="cachesize3" name="cachesize3" value="3" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['3']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize3" style="font-size:1.0em">piccola</label> &nbsp;
                <input type="checkbox" id="cachesize4" name="cachesize4" value="4" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['4']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize4" style="font-size:1.14em">normale</label> &nbsp;
                <input type="checkbox" id="cachesize5" name="cachesize5" value="5" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['5']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize5" style="font-size:1.28em">grande</label> &nbsp;
                <nobr><input type="checkbox" id="cachesize6" name="cachesize6" value="6" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['6']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize6" style="font-size:1.42em">molto grande</label></nobr>
                <br />
                <input type="checkbox" id="cachesize1" name="cachesize1" value="1" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['1']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize1">altra dimensione</label> &nbsp; <input type="checkbox" id="cachesize7" name="cachesize7" value="7" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['7']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize7">nessun contenitore</label>
                &nbsp;
                &nbsp;&nbsp;<a href="javascript:allsizes(true)">tutte</a>
                &nbsp;&nbsp;<a href="javascript:allsizes(false)">nessun</a>
            </td>
        </tr>
        ...
        <tr>
            <td class="formlabel">Difficoltà:</td>
            <td colspan="4">
...
<?php endif; ?></option>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;
                <span class="formlabel">Terreno:</span> &nbsp;
        ...
        <tr>
            ...
            <td>
                <select name="country" onchange="sync_options(this)">
                    <option value="" <?php if ($this->_tpl_vars['all_countries']): ?>selected="selected"<?php endif; ?>>Tutte le nazioni</option>
...
" <?php if ($this->_tpl_vars['countryoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['countryoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;
                <span class="formlabel">Lingua:&nbsp;&nbsp;</span>
                <select name="language" onchange="sync_options(this)">
                    <option value="" <?php if ($this->_tpl_vars['all_languages']): ?>selected="selected"<?php endif; ?>>Tutte le linguaggi</option>
...
" <?php if ($this->_tpl_vars['languageoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['languageoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <tr>
            <td valign="top">
                <span class="formlabel">Attributi cache:</span>&nbsp;<br />
                (<a href="javascript:switchAttributeCat2()"><span id="toggleAttributesCaption" style="white-space:nowrap">Mostra tutto</span></a>)
            </td>
...
<div class="searchdiv2">
    <table class="table">
        <tr>
            <td class="formlabel" rowspan="2">Risultati ordinati per:</td>
            <td colspan="4" style="padding-bottom:0">
                <input type="radio" name="sort" value="byname" index="0" id="l_sortbyname" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['byname_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbyname">Nome cache</label> &nbsp;
                <input type="radio" name="sort" value="bydistance" index="1" id="l_sortbydistance" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bydistance_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbydistance">Distanza</label> &nbsp;
                <input type="radio" name="sort" value="bycreated" index="2" id="l_sortbycreated" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bycreated_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbycreated">Pubblicata dal</label> &nbsp;
                <nobr><input type="radio" name="sort" value="bylastlog" index="3" id="l_sortbylastlog" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bylastlog_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbylastlog" >Ultimo log</label> &nbsp;
                <input type="radio" name="sort" value="bymylastlog" index="4" id="l_sortbymylastlog" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bymylastlog_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_sortbymylastlog" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>Il mio ultimo log</label></nobr>
            </td>
        </tr>
        <tr>
            <td style="padding-top:0">
                ...
                <label for="orderRatingFirst">Visualizza prima le raccomandazioni di altri utenti</label>
            </td>
        </tr>
    </table>
</div>
...
<div id="scriptwarning" style="margin:0 5px 0 5px;">
    <p><span class="errormsg">JavaScript non è attivo, non puoi usare le opzioni precedenti - tuttavia è possibile la ricerca base.</span></p>
</div>
...
" />
        ...
        <tr>
            <td class="formlabel">Perimetro:</td>
            <td>
...
" maxlength="4" class="input50" />&nbsp;
                <select name="unit" class="input100">
                    <option value="km" <?php if ($this->_tpl_vars['sel_km']): ?>selected="selected"<?php endif; ?>>Chilometri</option>
                    <option value="sm" <?php if ($this->_tpl_vars['sel_sm']): ?>selected="selected"<?php endif; ?>>Miglia</option>
                    <option value="nm" <?php if ($this->_tpl_vars['sel_nm']): ?>selected="selected"<?php endif; ?>>Miglia marine</option>
                </select>
            </td>
        </tr>
        <tr>
...
" maxlength="7" class="input70" onfocus="textonfocus(1)"/></td>
        ...
        <tr>
            <td valign="top"><input type="radio" id="sbdis" name="searchto" value="searchbydistance" <?php if ($this->_tpl_vars['dbydistance_checked']): ?>checked="checked"<?php endif; ?>><label for="sbdis">... dalle coordinate:</label></td>
            <td valign="top">
...
" class="input50" onfocus="textonfocus(2)"/>&nbsp;'&nbsp;
            ...
            <td><input type="submit" name="submit_dist" value="Cerca" class="formbutton" onclick="submitbutton('submit_dist')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Nome cache<span></span>:</td>
            <td><input type="text" name="cachename" value="<?php echo $this->_tpl_vars['cachename']; ?>
" class="input200" /></td>
            <td><input type="submit" name="submit_cachename" value="Cerca" class="formbutton" onclick="submitbutton('submit_cachename')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Testo<span></span>:</td>
            <td><input type="text" name="fulltext" value="<?php echo $this->_tpl_vars['fulltext']; ?>
" class="input200" /></td>
            <td><input type="submit" name="submit_ft" value="Cerca" class="formbutton" onclick="submitbutton('submit_ft')" /></td>
        </tr>
        <tr>
            <td>... in<span></span>:</td>
            <td colspan="4">
                <input type="checkbox" name="ft_desc" id="ft_desc" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_desc_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_desc">Descrizione</label> &nbsp;
                <input type="checkbox" name="ft_name" id="ft_name" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_name_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_name">Nome cache</label> &nbsp;
                <input type="checkbox" name="ft_pictures" id="ft_pictures" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_pictures_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_pictures">Immagini</label> &nbsp;
                <input type="checkbox" name="ft_logs" id="ft_logs" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_logs_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_logs">Log</label>
            </td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Proprietario:</td>
            <td><input type="text" name="owner" value="<?php echo $this->_tpl_vars['owner']; ?>
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_owner" value="Cerca" class="formbutton" onclick="submitbutton('submit_owner')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Numero di log:</td>
            <td colspan="2">
                <select name="logtype">
...
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_finder" value="Cerca" class="formbutton" onclick="submitbutton('submit_finder')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Tutte le cache</td>
            <td></td>
            <td><input type="submit" name="submit_all" value="Cerca" class="formbutton" onclick="submitbutton('submit_all')" /></td>
        </tr>
    </form>
    <?php endif; ?>
