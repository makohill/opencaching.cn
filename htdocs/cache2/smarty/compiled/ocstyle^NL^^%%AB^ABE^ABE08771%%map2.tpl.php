...
function data_mapreceive(data, responseCode)
{
    ...
    if (responseCode != 200)
    {
        var sMessage = \'Fout: Het zoek resultaat kan niet weergegeven worden (HTTP fout code %1)\';
    ...
    if (oXML.documentElement.getAttribute("available") +0 == 0)
    {
        ...
        {
            // alert(\'Fout: Het zoek resultaat kan niet weergegeven worden. De gegevens zijn niet beschikbaar op de server.\');
            error_no_data(true);
        }
        return;
    }
...
function show_cachepopup_url(sURL, sWaypoint, bAllowZoomChange)
{
    ...
    ajaxLoad(sURL, function(data, responseCode) {
        ...
        if (!oCoords)
        {
            if (sWaypoint != \'\')
            {
                var sMessage = \'Waypoint %1 niet gevonden!\';
...
function parseXML_GetHTML(xmlobject)
{
    ...
    sHtml += "<tr><td colspan='2' style='vertical-align:top;'>door <a href=" +apos+"viewprofile.php?userid="+encodeURI(nUserId)+apos+ " target='_blank'>" + xmlentities(sUsername) + "</a></td><td align='right'><a class='nooutline' href='articles.php?page=cacheinfo#difficulty' target='_blank'><img src=" + apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-"+String(nDifficulty*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Moeilijkheid: " + String(nDifficulty) + " van 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /><img src=" +apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-"+String(nTerrain*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Terrein: " + String(nTerrain) + " van 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /></a></td></tr>";
...
<img src='resource2/ocstyle/images/misc/is_oconly_small.png' alt='OConly' title='OConly' /></a>" : "") + "</td></tr>";
    ...
    sAddHtml = "";
    if (bOwner==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/misc/16x16-home.png' alt='' /> Dit is jouw cache</td></tr>";

    if (bFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-found.png' alt='' /> Je hebt deze cache gevonden</td></tr>";

    if (bNotFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-dnf.png' alt='' /> Je hebt deze cache niet gevonden</td></tr>";

    if (bAttended==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/log/16x16-attended.png' alt='' /> U heeft dit evenement bezocht!</td></tr>";

    if (nGeoKreties>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/gk.png' alt='' /> In deze cache zit een GeoKrety</td></tr>";

    if (nTopRating>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/rating-star.gif' alt='' /> Deze cache heeft %1 aanbevelingen</td></tr>".replace(/%1/, nTopRating);
...
function tmd_show(number)
{
    ...
    var sMessage = \'Er zijn %1 caches gevonden. Vergroot de kaart om de caches te zien.\';
...
function mapsearch_click()
{
    ...
    {
        alert(\'Voer een zoektekst in, alstublieft!\');
        return;
    }
...
').style.display = sShow;
    ...
    tas.innerHTML = (bShow ? "Minder" : "Toon alle");
    if (bFullscreen)
...
<div id="<?php if ($this->_tpl_vars['bFullscreen']): ?>fullmap<?php else: ?>smallmap<?php endif; ?>" class="mapframe">
    ...
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
            ...
            <div id="mapstat_caches" class="mapstat_fullscreen" style="z-index:5">Getoonde caches: <span id="statCachesCount">0</span><span id="statLoadTime" style="display:none">0</span></div>
            ...
            <tr>
                <?php if ($this->_tpl_vars['bFullscreen']): ?>
                    ...
                    <td rowspan="2" class="maplogin">
                        <?php if ($this->_tpl_vars['username'] != ""): ?>Ingelogt als<br /><a href="myhome.php"><b><?php echo $this->_tpl_vars['username']; ?>
...
<?php endif; ?>"><img src="resource2/ocstyle/images/action/15x13-logout.png" style="margin-bottom:2px" alt="Uitloggen" title="Uitloggen" /></a><?php else: ?><a href="login.php?target=map2.php%3Fmode%3Dfullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>%26queryid%3D<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>">Inloggen...</a><?php endif; ?>
                    </td>
                    <td rowspan="2">&nbsp;&nbsp;</td>
                <?php endif; ?>
...
/images/map/35x35-configure.png" class="mapbutton" style="margin-left:0px; margin-right:2px" height="35" width="35" alt="Instellingen" title="Instellingen" /></a></td>
...
/images/map/35x35-fullscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="show fullscreen" title="show fullscreen" /></a>
        ...
        <table>
            ...
            <tr id="permalink_addFavorites"><td align="right"><input type="button" value="Aan favorieten toevoegen" onclick="addFavorites_click()" /></td></tr>
        </table>
    </div>
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
        </div></div>            <?php endif; ?>
...
<?php endif; ?>" method="post" style="display:inline;">
                    ...
                    <table>
                        <tr><td><span style="font-size:1.2em; font-weight:bold">Instellingen</strong></td><td style="text-align:right"><a href="javascript:toggle_settings()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></tr>
...
preview pictures</a><br />(% of map area, 0=off):</td><td><input type="text" id="opt_pictures" name="opt_pictures" size="2" maxlength="2" /></td></tr>
                        <tr><td colspan="2"><?php if ($this->_tpl_vars['login']['userid'] > 0): ?><input type="button" class="formbutton" value="Annuleren" onclick="toggle_settings()"/>&nbsp; <input type="submit" name="submitsettings" class="formbutton" value="OK" onclick="submitbutton('submitsettings')" /><?php else: ?><em>You must be logged in to change map settings.</em><?php endif; ?></td></tr>
                    </table>
                </form>
            </div>
...
/images/map/32x32-left.png" /></a>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td id="filterboxtitle" class="content-title-noshade-size1">Alleen caches met de volgende eigenschappen tonen:</td>
    ...
    <?php else: ?>
        ...
        <div style="width:770px;text-align:right;"><span id="mapstat_caches">Getoonde caches: <span id="statCachesCount">0</span></span>, Laadtijd: <span id="statLoadTime">0</span> sec.</div>
        <div style="<?php if ($this->_tpl_vars['queryid'] > 0): ?>display:none<?php endif; ?>">
        <p id="filterboxtitle" class="content-title-noshade-size1">Alleen caches met de volgende eigenschappen tonen:</p>
        ...
        <tr>
            <td class="mapfilter pad10" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>600<?php else: ?>752<?php endif; ?>">
                <table style="width:100%">
                    <tr>
                        <td>
                            <strong>Naam:</strong>&nbsp; <input type="text" id="cachename" name="cachename" value="" onkeyup="filter_changed()" onchange="filter_changed()" class="input200" /></td>
                        </td>
                        <td style="text-align:right">
                            <input type="button" name="resetfilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Herstellen&nbsp;&nbsp;" onclick="reset_filter()" />&nbsp;
                            <input type="button" name="savefilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Opslaan&nbsp;&nbsp;" onclick="save_filter()" />&nbsp;
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table>
        <tr>
                ...
                <table>
                    <tr><td colspan="3" class="mapfiltertopic mft_withcheckbox"><input id="all_cachetypes" type="checkbox" checked="checked" onchange="alltypes_changed()" /> <label for="all_cachetypes">Cache soort</label></td></tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheTypeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic mft_withcheckbox"><input id="all_cachesizes" type="checkbox" checked="checked" onchange="allsizes_changed()" /> <label for="all_cachesizes">Cache behuizing</label></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <?php $_from = $this->_tpl_vars['aCacheSize']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheSizeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic">Verbergen</td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userowner" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Mijn eigen</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userfound" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Mijn gevonden</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_ignored" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>Mijn genegeerde</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                ...
                <table>
                    <tr>
                        <td colspan="2" class="mapfiltertopic">Waardering</td>
                    <tr><td colspan="2"><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    </tr>
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Moeilijkheid:</td>
                    ...
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Terrein:</td>
                            <?php if ($this->_tpl_vars['bFullscreen']): ?></tr><tr><td colspan="2" style="white-space:nowrap; text-align:right"><?php else: ?><td><?php endif; ?>
        ...
        <tr>
            <td id="attribcell" valign="top" class="mapfilter pad10" style="padding-bottom:2px" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>675<?php else: ?>752<?php endif; ?>">
                <table>
                    <tr><td class="mapfiltertopic">Attribute &nbsp; <span class="mapfiltertopic_add">[<a id="toggle_attribselection" class="jslink" onclick='toggle_attribselection(true)'>Minder</a>]</span></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td>
