...
<form method="POST" action="adminhistory.php">
    <p>
        ...
        <input type="submit" name="submitform" value="Mostrar" class="formbutton" onclick="submitbutton('submitform')" />
    </p>
</form>
<?php endif; ?>
...
/images/misc/32x32-tools.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                <?php if ($this->_tpl_vars['reportdisplay']): ?>    Other reports for this cache<?php else: ?>Cache reports<?php endif; ?>
            </p>
        </div>
...
/images/description/22x22-logs.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                Deleted logs <small>since deletion date February 2012</small>
            </p>
        </div>
...
/images/viewcache/16x16-maintenance.png" style="margin-right: 10px;" width="16" height="16" alt="" />
                Status changes <small>since June 2013</small>
            </p>
        </div>
...
/images/profile/32x32-adopt.png" style="margin-right: 10px;" width="22" height="22" alt="" />
                Adoptions <small>since September 2012</small>
            </p>
        </div>
