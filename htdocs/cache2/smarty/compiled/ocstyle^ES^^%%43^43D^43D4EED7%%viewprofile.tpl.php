...
/images/misc/32x32-home.png" style="margin-right: 10px;" width="32" height="32" />
    Perfil de usuario de <?php echo $this->_tpl_vars['username']; ?>
...
"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/16x16-email.png" width="16" height="16" border="0" alt="Enviar email" align="middle" /></a>&nbsp;
    [<a href="mailto.php?userid=<?php echo $this->_tpl_vars['userid']; ?>
">Enviar email</a>]
</div>
    ...
    <tr>
        ...
        <?php elseif ($this->_tpl_vars['lastlogin'] == 7): ?>
            <?php if ($this->_tpl_vars['license_actively_declined']): ?>
                <td>La cuenta de usuario ha sido desactivado, ya que el usuario declinó la <a href="articles.php?page=impressum#datalicense">licencia de datos/a>. Descripciones del cache, textos logs e imagenes que han sido borradas.</td>
            <?php elseif ($this->_tpl_vars['license_passively_declined']): ?>
                <td>La cuenta de usuario ha sido desactivada. Cache descriptions, log texts and pictures have been deleted, because the account was disabled before transition to the <a href="articles.php?page=impressum#datalicense">new data license</a>.</td>
            <?php else: ?>
                <td>La cuenta de usuario ha sido desactivada.</td>
            <?php endif; ?>
        <?php else: ?>
            <td>unknown</td>
        <?php endif; ?>
...
<span></span>:</b></td>
    ...
    <?php if ($this->_tpl_vars['pmr'] == 1): ?>
        <tr>
            <td style="vertical-align:top;"><b>Otros:</b></td>
            <td>
                Voy a tener una radio PMR en el canal 2 conmigo.<br />
            </td>
        </tr>
    <?php endif; ?>
 ...
 ?>
    ...
    <?php else: ?>
        <tr>
            ...
            <td valign="middle">
                inactive (<a href="oconly81.php">Información</a>)
            </td>
        </tr>
        <tr><td class="spacer"></td></tr>
        <tr><td class="spacer"></td></tr>
