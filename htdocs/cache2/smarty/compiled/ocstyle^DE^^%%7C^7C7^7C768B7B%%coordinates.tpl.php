...
</b><?php if ($this->_tpl_vars['childwp']): ?>, Wegpunkt&nbsp;<?php echo $this->_tpl_vars['childwp']; ?>
<br />
            <p style="color: 5890a8">von <?php echo $this->_tpl_vars['owner']; ?>
<?php endif; ?>
            </p>
        </div>
    <?php endif; ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['coordUTM']['letter'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['coordUTM']['east'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
    ...
    <div style="margin-top:4px;">
        <p style="color: 5890a8"><b>Gauß-Krüger</b><?php if ($this->_tpl_vars['opt']['template']['locale'] == 'DE'): ?> <small>(Potsdam-Datum)</small><?php endif; ?><br />
