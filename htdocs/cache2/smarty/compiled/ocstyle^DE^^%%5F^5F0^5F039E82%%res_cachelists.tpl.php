            ...
            <td colspan="2">
                <table class="table">
                    <tr class="cachelistheader">
                        <th width="<?php if ($this->_tpl_vars['show_watchers']): ?>330px<?php else: ?>360px<?php endif; ?>"><?php if ($this->_tpl_vars['title_ownlists']): ?>Eigene Listen<?php elseif ($this->_tpl_vars['title_bookmarks']): ?>Gemerkte Listen (Favoriten)<?php else: ?>Cacheliste<?php endif; ?></th>
                        <?php if ($this->_tpl_vars['show_user']): ?><th width="<?php if ($this->_tpl_vars['show_watchers']): ?>130px<?php else: ?>160px<?php endif; ?>">von</th><?php endif; ?>
                        <?php if ($this->_tpl_vars['show_status']): ?><th width="70px">Status</th><?php endif; ?>
                        <th width="50px">Caches</th>
                        <?php if ($this->_tpl_vars['show_watchers']): ?><th width="60px">Beobachter</th><?php endif; ?>
...
"><nobr><?php if ($this->_tpl_vars['cachelist']['visibility'] >= 2): ?>öffentlich<?php if ($this->_tpl_vars['cachelist']['visibility'] == 3): ?> <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/action/16x16-adddesc.png" title="für Alle in Cachelistings sichtbar" /><?php endif; ?><?php else: ?><?php if ($this->_tpl_vars['cachelist']['password']): ?><a class="jslink" onclick="cl = getElementById('sharelist_<?php echo $this->_tpl_vars['cachelist']['id']; ?>
...
/images/action/18x16-offer.png" /></a><?php else: ?>privat<?php endif; ?><?php endif; ?></nobr>
...
">bearbeiten</a>]&nbsp;[<a class="systemlink" href="javascript:if(confirm('Möchtest du die Liste \'<?php echo ((is_array($_tmp=$this->_tpl_vars['cachelist']['name'])) ? $this->_run_mod_handler('escapejs', true, $_tmp) : smarty_modifier_escapejs($_tmp)); ?>
\' wirklich löschen?'))location.href='mylists.php?delete=<?php echo $this->_tpl_vars['cachelist']['id']; ?>
'">löschen</a>]<?php endif; ?>
                                <?php if ($this->_tpl_vars['show_unbookmark']): ?>[<a class="systemlink" href="javascript:if(confirm('Möchtest du die Cacheliste \'<?php echo ((is_array($_tmp=$this->_tpl_vars['cachelist']['name'])) ? $this->_run_mod_handler('escapejs', true, $_tmp) : smarty_modifier_escapejs($_tmp)); ?>
\' wirklich aus den Favoriten entfernen?'))location.href='mylists.php?unbookmark=<?php echo $this->_tpl_vars['cachelist']['id']; ?>
'">entfernen</a>]<?php endif; ?>
                                <?php if ($this->_tpl_vars['togglewatch']): ?><nobr>[<a href="<?php if ($this->_tpl_vars['cachelist']['watched_by_me'] && $this->_tpl_vars['removewatch_confirm']): ?>javascript:if(confirm('Möchtest du diesen Eintrag wirklich entfernen?'))location.href='<?php echo $this->_tpl_vars['togglewatch']; ?>
...
<?php endif; ?>"><?php if ($this->_tpl_vars['cachelist']['watched_by_me']): ?>nicht beobachten<?php else: ?>beobachten<?php endif; ?></a>]</nobr><?php endif; ?>
                            </td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; else: ?>
                        <tr><td colspan="<?php echo $this->_tpl_vars['show_user']; ?>
"><br />Noch keine Listen vorhanden.</td></tr>
