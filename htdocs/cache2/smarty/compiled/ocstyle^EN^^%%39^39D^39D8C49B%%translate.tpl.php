...
&action=scan">Scan source codes</a><br />
        <br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=listnew">Show new translations</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=listall">Show all translations</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=listfaults">Show translations no longer referenced</a><br />
        <br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=verify">Show inconsistencies</a> (EN)<br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=clearcache">Clear smarty cache</a><br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
&action=resetids">Reorder IDs</a> (before an export)<br />
        <a href="translate.php?translang=<?php echo $this->_tpl_vars['translang']; ?>
...
&action=copy_en">Copy EN</a><br />
    ...
    <?php if ($this->_tpl_vars['action'] == 'listnew' || $this->_tpl_vars['action'] == 'listfaults' || $this->_tpl_vars['action'] == 'listall'): ?>
        ...
        <?php elseif ($this->_tpl_vars['action'] == 'listfaults'): ?>
            <p>Translations no longer referenced:</p>
...
?>
 ...
 <?php echo $this->_tpl_vars['refItem']['line']; ?>
                ...
                <tr><td>Use existing translations:</td></tr>
                <tr>
                    <td>
                        <table class="table">
                            <?php $_from = $this->_tpl_vars['trans']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
</b> (old) <?php echo ((is_array($_tmp=$this->_tpl_vars['textItem'][$this->_tpl_vars['languageItem']]['old'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
                                </tr>
                            <?php endif; ?>
                            <tr>
...
of<?php echo ' \' + (nFileMax+1) + \' \' + sFilename;
