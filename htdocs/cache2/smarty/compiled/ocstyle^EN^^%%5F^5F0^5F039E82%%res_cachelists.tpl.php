            ...
            <td colspan="2">
                <table class="table">
                    <tr class="cachelistheader">
                        ...
                        <?php if ($this->_tpl_vars['show_user']): ?><th width="<?php if ($this->_tpl_vars['show_watchers']): ?>130px<?php else: ?>160px<?php endif; ?>">by</th><?php endif; ?>
                        <?php if ($this->_tpl_vars['show_status']): ?><th width="70px">Status</th><?php endif; ?>
                        <th width="50px">Caches</th>
                        <?php if ($this->_tpl_vars['show_watchers']): ?><th width="60px">Watchers</th><?php endif; ?>
...
'">remove</a>]<?php endif; ?>
                                <?php if ($this->_tpl_vars['togglewatch']): ?><nobr>[<a href="<?php if ($this->_tpl_vars['cachelist']['watched_by_me'] && $this->_tpl_vars['removewatch_confirm']): ?>javascript:if(confirm('Do you really want to delete this entry?'))location.href='<?php echo $this->_tpl_vars['togglewatch']; ?>
