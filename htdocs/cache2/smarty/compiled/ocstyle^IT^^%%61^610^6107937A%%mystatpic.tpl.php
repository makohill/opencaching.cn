...
<form action="change_statpic.php">
    ...
    <table class="table">
        ...
        <tr>
            <td style="vertical-align:top;">Statistiche<span></span>:</td>
...
.jpg" align="middle" /></td>
        ...
        <tr>
            <td style="vertical-align:top;">codice HTML:</td>
...
/<?php echo $this->_tpl_vars['login']['userid']; ?>
.jpg" alt="Statistiche <?php echo $this->_tpl_vars['opt']['page']['sitename']; ?>
 di <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['login']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" title="Statistiche <?php echo $this->_tpl_vars['opt']['page']['sitename']; ?>
 di <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['login']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /&gt;</td>
        </tr>
        <tr><td class="spacer" colspan="2"></td></tr>
        ...
        <tr>
            <td style="vertical-align:top;">BBCode per il forum web:</td>
...
.jpg[/img][/url]</td>
        ...
        <tr>
            <td class="header-small" colspan="3">
                <input type="submit" name="change" value="Cambio" class="formbutton" onclick="submitbutton('change')" />
            </td>
        </tr>
    </table>
