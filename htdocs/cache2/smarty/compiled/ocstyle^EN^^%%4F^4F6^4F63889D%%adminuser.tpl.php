...
" /></p>
        ...
        <?php if ($this->_tpl_vars['error'] == 'userunknown'): ?>
            <p style="line-height: 1.6em; color: red; font-weight: bold;">Username unknown</p>
        <?php endif; ?>
        ...
        <p style="line-height: 1.6em;"><input type="submit" name="find" value="Submit" class="formbutton" onclick="submitbutton('find')" /></p>
...
<?php endif; ?></td>
            ...
            <tr>
                <td>User active:</td>
                <td><?php if ($this->_tpl_vars['user']['is_active_flag']): ?>Yes<?php else: ?>No<?php endif; ?>
...
<?php else: ?>Unknown<?php endif; ?></td>
            ...
            <?php if ($this->_tpl_vars['candelete'] == true): ?>
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="checkbox" name="chkdelete" value="1" /> Delete</td>
                </tr>
            <?php endif; ?>
            ...
            <?php if ($this->_tpl_vars['licensefunctions'] == true || $this->_tpl_vars['candelete'] == true || $this->_tpl_vars['candisable'] == true || $this->_tpl_vars['cansetemail'] == true): ?>
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="checkbox" name="chkcommit" value="1" /> Sure?</td>
                </tr>
                <tr><td class="spacer" colspan="2"></td></tr>

                <tr>
                    <td>&nbsp;</td>
                    <td><input type="submit" name="execute" value="Submit" class="formbutton" onclick="submitbutton('execute')" /></td>
                </tr>
            <?php endif; ?>
        </table>
    </form>
