...
<table class="table">
    <tr>
        <td style="padding-bottom:20px;">
            Die Liste wird automatisch anhand der Empfehlungen unserer Benutzer aktualisiert. Mehr Informationen zur regionalen Einteilung kannst du im <?php echo $this->_tpl_vars['helppagelink']; ?>
Wiki</a> finden.<br />
<br />
...
<img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="Gefunden" /> Anzahl der Funde des Geocaches<br />
...
null"><i>(ohne Regionalbezug)</i><br /></a>
                                <?php else: ?>
                                    <a href="#<?php echo ((is_array($_tmp=$this->_tpl_vars['topItem']['adm1'])) ? $this->_run_mod_handler('urlencode', true, $_tmp) : smarty_modifier_urlencode($_tmp)); ?>
...
<?php endif; ?>"></a>
        ...
        <table class="table">
            <tr>
                ...
                <td style="text-align:right"><img src="images/rating-star.gif" border="0" alt="Empfehlungen" /></td>
                <td style="text-align:right"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="gefunden" /></td>
                <td></td>
                <td>&nbsp;</td>
            </tr>
    <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?> von <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['topItem']['userid']; ?>
