...
unset($_smarty_tpl_vars);
 ?>
                    ...
                    <td align="left" valign="top" width="397"><font size="3"><b><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                        ...
                        <span class="garmintext">par <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br />
...
.gif" border="0" width="19" height="16" hspace="2" alt="Difficulté&nbsp;:&nbsp;<?php echo $this->_tpl_vars['cache']['difficulty']*0.5; ?>
&nbsp;des&nbsp;5" /><br />
                        Terrain&nbsp;:
                        <img src="./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
&nbsp;des&nbsp;5" />
                ...
                <tr><td colspan="2" class="garmintext"><br />Téléchargement Waypoint</td></tr>
            </table>
        </td>
    </tr>
</table>
