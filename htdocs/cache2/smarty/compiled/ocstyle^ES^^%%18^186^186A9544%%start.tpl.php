...
/images/misc/32x32-news.png" style="margin-right: 10px;" width="24" height="24" alt="" />
                        <a href="http://blog.opencaching.de/" style="color:rgb(88,144,168); text-decoration: none;">Noticias</a>
                        &nbsp; <span class="content-title-link">[<a href="http://blog.opencaching.de/">más...</a>]</span>
                    </p>
                </td>
...
/images/cacheicon/event.gif" style="margin-right: 10px;" width="24" height="24" alt="" />
        El próximo evento en <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

        <?php if ($this->_tpl_vars['total_events'] > count($this->_tpl_vars['events'])): ?>
            &nbsp; <span class="content-title-link">[<a href="newcaches.php?cachetype=6">más...</a>]</span>
        <?php endif; ?>
    </p>
</div>
...
/images/misc/32x32-pictures.gif" style="margin-right: 10px;" width="24" height="24" />
        <a href="newlogpics.php" style="color:rgb(88,144,168); text-decoration: none;">Nuevas fotos de registro</a>
    &nbsp; <span class="content-title-link">[<a href="newlogpics.php">más...</a>]</span>
    </p>
</div>
...
/images/misc/32x32-winner.png" style="margin-right: 10px;" width="24" height="24" alt="" />
        <a href="tops.php" style="color:rgb(88,144,168); text-decoration: none;">Top de Recomendaciones</a>
    </p>
</div>
<p style="line-height: 1.6em;">Geocaches con mayor valoración en los últimos <?php echo $this->_tpl_vars['toprating_days']; ?>
 días en <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</p>
...
" style="color: rgb(88, 144, 168); text-decoration: none;">Nuevo topcis en el foro(<?php echo ((is_array($_tmp=$this->_tpl_vars['phpbb_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)</a>
        </p>
    </div>
    <div id="forum">
...
" style="color:rgb(88,144,168); text-decoration: none;">Últimos caches en <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>
    &nbsp; <span class="content-title-link">[<a href="newcaches.php">más...</a>]</span>
    </p>
</div>
<p style="line-height: 1.6em;">(Total de <?php echo $this->_tpl_vars['count_hiddens']; ?>
 caches activos y <?php echo $this->_tpl_vars['count_founds']; ?>
 encontrados por <?php echo $this->_tpl_vars['count_users']; ?>
 usuarios)</p>
<div class="content2-section-no-p">
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
