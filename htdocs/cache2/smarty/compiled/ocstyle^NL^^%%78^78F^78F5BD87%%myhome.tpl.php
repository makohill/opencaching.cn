...
/images/misc/32x32-home.png" border="0" width="32px" height="32px" style="margin-right: 10px;" />
    Welkom <?php echo $this->_tpl_vars['login']['username']; ?>
...
/images/description/22x22-logs.png" width="22" height="22"  style="margin-right: 10px;" />&nbsp;
            Gevonden caches: <?php echo $this->_tpl_vars['found']; ?>
 &nbsp;
...
&amp;searchbyfinder=&amp;f_inactive=0&amp;logtype=1,7&amp;calledbysearch=0">Geocaches found</a>]&nbsp; [<a href="search.php?showresult=1&amp;expert=0&amp;output=HTML&amp;sort=bymylastlog&amp;finderid=<?php echo $this->_tpl_vars['login']['userid']; ?>
&amp;searchbyfinder=&amp;f_inactive=0&amp;logtype=0&amp;calledbysearch=0">Geocaches logged</a>]</span><?php endif; ?>
        </p>
    </div>

        <p style="line-height: 1.6em;"><b>Je laatste logjes<?php if ($this->_tpl_vars['morelogs']): ?> </b>(<a class="systemlink" href="ownlogs.php">more</a>)<span></span>:<?php else: ?><span></span>:</b><?php endif; ?></p>
...
unset($_smarty_tpl_vars);
 ?>
                    door <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['logItem']['userid']; ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php endforeach; else: ?>
            <tr><td>Geen items gevonden</td></tr>
...
/images/misc/32x32-pictures.gif" width="24" height="24"  style="margin-right: 10px;" />&nbsp;
        Log pictures: <?php echo $this->_tpl_vars['total_pictures']; ?>
 &nbsp;
        <?php if (count($this->_tpl_vars['pictures']) > 0 && ! $this->_tpl_vars['allpics']): ?><span class="content-title-link">[<a href="myhome.php?allpics=1">Toon alle</a>]</span><?php endif; ?>
    </p>
</div>

<?php if (count($this->_tpl_vars['pictures']) == 0): ?>
    <p>You did not upload any log pictures yet.</p>
    <br />
<?php else: ?>
    <p style="line-height: 1.6em;">
        <?php if (! $this->_tpl_vars['allpics']): ?>
             <b>Your latest log pictures:</b></p>
            <?php $this->assign('maxlines', 1); ?>
        <?php else: ?>
            <?php $this->assign('subtitle', "Your log pictures:"); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if ($this->_tpl_vars['allpics']): ?>
        <p>In your <a href="mydetails.php">profile settings</a> you can choose if your log pictures stat and gallery is visible for other users.</p>
    <?php endif; ?>
<?php endif; ?>
...
/images/cacheicon/22x20-traditional.png" width="22" height="20"  style="margin-right: 10px;" />&nbsp;
            Geplaatste caches: <?php echo $this->_tpl_vars['hidden']; ?>
 &nbsp;
...
&amp;searchbyowner=&amp;f_inactive=1&calledbysearch=0">... only active caches</a>]<?php endif; ?></span><?php endif; ?>
    ...
    <table class="table" style="max-width:97%">
        <?php if (count($this->_tpl_vars['caches']) == 0): ?>
            <tr><td colspan="4"><p style="margin-bottom:24px">Geen geplaatste caches gevonden</p></td></tr>
        <?php else: ?>
...
?>
            ...
            <tr>
                <td colspan="4"><b><span style="line-height:2em">Jouw geplaatste caches</b><span id="toggle_archived_option" style="display:none"><?php if ($this->_tpl_vars['archived'] > 0): ?> (<a href="javascript:toggle_archived()" style="outline:none"><span id="hide_archived">hide archived</span><span id="show_archived" style="display:none">show archived</span></a>)<?php endif; ?></span><span></span>:</span></td>
...
/images/log/16x16-found.png" alt="Gevonden" title="Gevonden"  /></td>
                <td style="text-align:left"><span style="line-height:2em"><b>Laatste log</b></span></td>
            </tr>
            <?php $_from = $this->_tpl_vars['caches']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cacheItem']):
?>
...
unset($_smarty_tpl_vars);
 ?></nobr></td>
        ...
        <?php endif; ?>
            ...
            <tr>
                <td colspan="4">
                    <p style="margin-top:16px"><b>Jouw nog niet gepubliceerde caches:</b></p>
                </td>
            </tr>
