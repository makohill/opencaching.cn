        ...
        <p style="line-height: 1.6em;" <?php if ($this->_tpl_vars['error'] != LOGIN_OK && $this->_tpl_vars['error'] != LOGIN_LOGOUT_OK): ?>class="errormsg"<?php endif; ?>>
            <?php if ($this->_tpl_vars['error'] != LOGIN_OK): ?>
                <?php if ($this->_tpl_vars['error'] == LOGIN_BADUSERPW): ?>
                    ...
                    Der eingegebene Benutzername oder das Passwort war ungültig.<br />
                <?php elseif ($this->_tpl_vars['error'] == LOGIN_TOOMUCHLOGINS): ?>
                    Der Login war nicht erfolgreich.<br />
                    Du hast versucht, dich in der letzten Stunde <?php echo $this->_tpl_vars['opt']['page']['max_logins_per_hour']; ?>
 mal einzuloggen. Weitere Loginversuche sind erst wieder möglich, wenn eine Stunde seit dem ersten Login vergangen ist.<br />
                <?php elseif ($this->_tpl_vars['error'] == LOGIN_USERNOTACTIVE): ?>
                    Dein Account wurde noch nicht aktiviert oder wieder deaktiviert.<br />
                    Du kannst deinen Account &gt;<a href="activation.php">hier</a>&lt; aktivieren.<br />
                <?php elseif ($this->_tpl_vars['error'] == LOGIN_EMPTY_USERPASSWORD): ?>
                    Bitte die Felder Benutzername und Passwort ausfüllen!
                <?php elseif ($this->_tpl_vars['error'] == LOGIN_LOGOUT_OK): ?>
                    Logout war erfolgreich.
                <?php else: ?>
                    登陆失败。<br />
                    Sollte das Problem längere Zeit bestehen, wende dich bitte an <a href="mailto:<?php echo $this->_tpl_vars['opt']['mail']['contact']; ?>
