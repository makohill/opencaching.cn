...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
            ...
            Los usuarios que recomiendan al <?php echo $this->_smarty_vars['capture']['cache']; ?>
 al <?php echo $this->_smarty_vars['capture']['user']; ?>
 también recomendó los geocaches siguientes:
        </td>
    </tr>
    ...
    <tr>
        <td colspan="2">
            <table class="table" border="0" cellspacing="0" width="100%">
                <tr>
                    <th width="50px">Tasa de acierto</th>
                    <th width="10px">&nbsp;</th>
                    <th>Nombre</th>
                </tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheRatingsItem']['cacheusername'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <?php endforeach; else: ?>
                    <tr><td colspan="3">No puede haber ninguna recomendación porque no hay otras calificaciones.</td></tr>
