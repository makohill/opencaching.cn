...
<form action="change_statpic.php">
    ...
    <table class="table">
        ...
        <tr>
            <td style="vertical-align:top;">Statistics picture<span></span>:</td>
...
.jpg" alt="<?php echo $this->_tpl_vars['opt']['page']['sitename']; ?>
 statstics of <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['login']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
" /&gt;</td>
        ...
        <tr>
            <td style="vertical-align:top;">BBCode for web forums:</td>
...
.jpg[/img][/url]</td>
        ...
        <tr>
            <td class="header-small" colspan="3">
                <input type="submit" name="change" value="Change" class="formbutton" onclick="submitbutton('change')" />
            </td>
        </tr>
    </table>
