...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['ownername'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                Neueste Logeinträge für Caches von <?php echo $this->_smarty_vars['capture']['ownerlink']; ?>
...
<?php else: ?>
    ...
    <table cellspacing="0" cellpadding="0" style="width:98.1%">
        <tr>
            <td class="nav4">
                <ul>
                    <li class="group noicon <?php if ($this->_tpl_vars['countryCode'] === ''): ?>selected<?php endif; ?>"><a href="newlogs.php">Alle neuen Logs</a></li>
...
">Neue Logs in <?php echo $this->_tpl_vars['countryName']; ?>
</a>
                    <li class="group noicon <?php if ($this->_tpl_vars['rest']): ?>selected<?php endif; ?>"><a href="newlogsrest.php">Neue Logs ohne <?php echo $this->_tpl_vars['mainCountryName']; ?>
</a></li>
                </ul>
            </td>
            <td class="default" style="text-align:right; vertical-align:top; padding-top:0.2em">
                <select id="logselection" onchange="logSelectionChanged()" >
                    <option value="1" <?php if ($this->_tpl_vars['logselection'] == 1): ?>selected="selected"<?php endif; ?>>Aktuelle Neueinträge</option>
                    <option value="2" <?php if ($this->_tpl_vars['logselection'] == 2): ?>selected="selected"<?php endif; ?>>Alle Neueinträge</option>
                    <option value="3" <?php if ($this->_tpl_vars['logselection'] == 3): ?>selected="selected"<?php endif; ?>>... nach Logdatum</option>
                </select>
            </td>
        </tr>
    </table>
...
<?php if ($this->_tpl_vars['total_found'] + $this->_tpl_vars['total_attended'] + $this->_tpl_vars['total_dnf'] + $this->_tpl_vars['total_recommended']): ?>
  ...
  <img src="images/rating-star.gif" width="17" height="16" title="empfohlen" />&nbsp;
            <?php endif; ?>
            <?php if ($this->_tpl_vars['total_found']): ?>
                <?php echo $this->_tpl_vars['total_found']; ?>
 <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" alt="gefunden" title="gefunden"  />&nbsp;
            <?php endif; ?>
            <?php if ($this->_tpl_vars['total_dnf']): ?>
                <?php echo $this->_tpl_vars['total_dnf']; ?>
 <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-dnf.png" alt="nicht&nbsp;gefunden" title="nicht&nbsp;gefunden"  />&nbsp;
            <?php endif; ?>
            <?php if ($this->_tpl_vars['total_attended']): ?>
                <?php echo $this->_tpl_vars['total_attended']; ?>
 <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-attended.png" alt="teilgenommen" title="teilgenommen"  />&nbsp;
            <?php endif; ?>
        </p>
    </div>
<?php endif; ?>
 ...
 ?>
    ...
    <?php if ($this->_tpl_vars['ownerlogs'] && $this->_tpl_vars['ownlogs']): ?>
        <?php if ($this->_tpl_vars['show_own_logs']): ?>
            <a class="systemlink" href="ownerlogs.php?ownlogs=0">eigene Logs ausblenden</a>
        <?php else: ?>
            <a class="systemlink" href="ownerlogs.php?ownlogs=1">eigene Logs einblenden</a>
        <?php endif; ?>
    <?php endif; ?>
</p>
...
/images/oclogo/oc-team-comment.png" alt="OC-Team" title="OC-Team-Kommentar" /><?php endif; ?>
                <?php ob_start(); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['newLog']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 hat <?php echo $this->_smarty_vars['capture']['cachename']; ?>
 gefunden
                <?php elseif ($this->_tpl_vars['newLog']['type'] == 2): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 hat <?php echo $this->_smarty_vars['capture']['cachename']; ?>
 ...
 besucht
                <?php elseif ($this->_tpl_vars['newLog']['type'] == 8): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 möchte <?php echo $this->_smarty_vars['capture']['cachename']; ?>
 besuchen
                <?php elseif ($this->_tpl_vars['newLog']['type'] == 9): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 hat <?php echo $this->_smarty_vars['capture']['cachename']; ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php endforeach; else: ?>
        <?php if ($this->_tpl_vars['ownerlogs']): ?>
            <p>Es gibt noch keine Logeinträge für deine Caches.</p>
        <?php endif; ?>
