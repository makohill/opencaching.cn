...
<div class="nav4">
    <ul>
        <li class="group noicon <?php if ($this->_tpl_vars['countryCode'] == ''): ?>selected<?php endif; ?>"><a href="newcaches.php">All caches</a></li>
...
">New caches without <?php echo $this->_tpl_vars['mainCountryName']; ?>
</a></li>
    </ul>
</div>
...
.gif" alt="Event Geocache" border="0" width="22" height="22" align="left" style="margin-right: 5px;" /><?php else: ?><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?> by <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['newCache']['userid']; ?>
