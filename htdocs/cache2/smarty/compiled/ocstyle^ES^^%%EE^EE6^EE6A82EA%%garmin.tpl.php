...
unset($_smarty_tpl_vars);
 ?>
                    ...
                    <td align="left" valign="top" width="397"><font size="3"><b><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                        ...
                        <span class="garmintext">por <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br />
...
.gif" border="0" width="19" height="16" hspace="2" alt="Dificultad:&nbsp;<?php echo $this->_tpl_vars['cache']['difficulty']*0.5; ?>
&nbsp;de&nbsp;5" /><br />
                        Terreno:
                        <img src="./resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-<?php echo $this->_tpl_vars['cache']['terrain']*5; ?>
.gif" border="0" width="19" height="16" hspace="2" alt="Terrno:&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['terrain']*0.5)) ? $this->_run_mod_handler('sprintf', true, $_tmp, '%01.1f') : smarty_modifier_sprintf($_tmp, '%01.1f')); ?>
&nbsp;de&nbsp;5" />
                    </td>
                </tr>
                <tr><td colspan="2" class="garmintext"><br />Descarga waypoint</td></tr>
            </table>
        </td>
    </tr>
</table>
