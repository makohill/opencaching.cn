...
/images/description/20x20-compass.png" style="margin-right: 10px;" alt="" title="Zusätzliche Wegpunkte" />
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr>
      <td></td>
      <td>
        <input type="submit" name="back" value="Abbrechen" class="formbutton" onclick="submitbutton('back')" />&nbsp;&nbsp;
