...
<div class="searchdiv2">
    <table class="table">
        <tr>
            ...
            <td colspan="4">
                <input type="checkbox" name="f_userowner" value="1" id="l_userowner" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userowner_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userowner" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>My owned</label> &nbsp;
                <input type="checkbox" name="f_userfound" value="1" id="l_userfound" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_userfound_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_userfound" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>My finds</label> &nbsp;
                <input type="checkbox" name="f_ignored" value="1" id="l_ignored" class="checkbox" onclick="sync_options(this)" <?php if ($this->_tpl_vars['f_ignored_checked']): ?>checked="checked"<?php endif; ?> <?php if (! $this->_tpl_vars['logged_in']): ?>disabled="disabled"<?php endif; ?> /> <label for="l_ignored" <?php if (! $this->_tpl_vars['logged_in']): ?>class="disabled"<?php endif; ?>>My ignored</label> &nbsp;
        ...
        <tr>
            <td class="formlabel">Cache&nbsp;type:</td>
            <td>
                <?php $_from = $this->_tpl_vars['cachetypes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ct']):
?>
...
unset($_smarty_tpl_vars);
 ?>&nbsp;
                <?php endforeach; endif; unset($_from); ?>
                &nbsp;&nbsp;<a href="javascript:alltypes(true)">all</a>
        ...
        <tr>
            <td class="formlabel">Cache&nbsp;size:</td>
            <td colspan="4">
                ...
                <input type="checkbox" id="cachesize3" name="cachesize3" value="3" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['3']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize3" style="font-size:1.0em">small</label> &nbsp;
                ...
                <input type="checkbox" id="cachesize5" name="cachesize5" value="5" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['5']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize5" style="font-size:1.28em">large</label> &nbsp;
                <nobr><input type="checkbox" id="cachesize6" name="cachesize6" value="6" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['6']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize6" style="font-size:1.42em">very large</label></nobr>
                <br />
                <input type="checkbox" id="cachesize1" name="cachesize1" value="1" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['1']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize1">other size</label> &nbsp; <input type="checkbox" id="cachesize7" name="cachesize7" value="7" onclick="sync_options(this)" class="checkbox" <?php if ($this->_tpl_vars['cachesizes']['7']['checked']): ?>checked="checked"<?php endif; ?> /> <label for="cachesize7">no container</label>
                &nbsp;
                &nbsp;&nbsp;<a href="javascript:allsizes(true)">all</a>
        ...
        <tr>
            <td class="formlabel">Difficulty:</td>
            <td colspan="4">
...
" <?php if ($this->_tpl_vars['countryoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['countryoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;
                <span class="formlabel">Language:&nbsp;&nbsp;</span>
...
" <?php if ($this->_tpl_vars['languageoption']['selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['languageoption']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <tr>
            <td valign="top">
                ...
                (<a href="javascript:switchAttributeCat2()"><span id="toggleAttributesCaption" style="white-space:nowrap">Show all</span></a>)
            </td>
    ...
    <table class="table">
        <tr>
            ...
            <td colspan="4" style="padding-bottom:0">
                <input type="radio" name="sort" value="byname" index="0" id="l_sortbyname" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['byname_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbyname">Cache&nbsp;name</label> &nbsp;
                ...
                <input type="radio" name="sort" value="bycreated" index="2" id="l_sortbycreated" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bycreated_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbycreated">Listed since</label> &nbsp;
                <nobr><input type="radio" name="sort" value="bylastlog" index="3" id="l_sortbylastlog" class="radio" onclick="sync_options(this)" <?php if ($this->_tpl_vars['bylastlog_checked']): ?>checked="checked"<?php endif; ?> /> <label for="l_sortbylastlog" >Last logs</label> &nbsp;
...
" maxlength="4" class="input50" />&nbsp;
                <select name="unit" class="input100">
                    ...
                    <option value="sm" <?php if ($this->_tpl_vars['sel_sm']): ?>selected="selected"<?php endif; ?>>Miles</option>
                    <option value="nm" <?php if ($this->_tpl_vars['sel_nm']): ?>selected="selected"<?php endif; ?>>Seamiles</option>
                </select>
            </td>
        </tr>
        <tr>
...
" class="input50" onfocus="textonfocus(2)"/>&nbsp;'&nbsp;
            ...
            <td><input type="submit" name="submit_dist" value="Search" class="formbutton" onclick="submitbutton('submit_dist')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            <td class="formlabel">Cache&nbsp;name<span></span>:</td>
            <td><input type="text" name="cachename" value="<?php echo $this->_tpl_vars['cachename']; ?>
" class="input200" /></td>
            <td><input type="submit" name="submit_cachename" value="Search" class="formbutton" onclick="submitbutton('submit_cachename')" /></td>
        </tr>
    </form>
...
" class="input200" /></td>
            <td><input type="submit" name="submit_ft" value="Search" class="formbutton" onclick="submitbutton('submit_ft')" /></td>
        </tr>
        <tr>
            <td>... in<span></span>:</td>
            <td colspan="4">
                ...
                <input type="checkbox" name="ft_name" id="ft_name" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_name_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_name">Cache&nbsp;name</label> &nbsp;
                <input type="checkbox" name="ft_pictures" id="ft_pictures" class="checkbox" value="1" <?php if ($this->_tpl_vars['ft_pictures_checked']): ?>checked="checked"<?php endif; ?> /> <label for="ft_pictures">Pictures</label> &nbsp;
...
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_owner" value="Search" class="formbutton" onclick="submitbutton('submit_owner')" /></td>
        </tr>
    </form>
...
" maxlength="40" class="input200" /></td>
            <td><input type="submit" name="submit_finder" value="Search" class="formbutton" onclick="submitbutton('submit_finder')" /></td>
        </tr>
    </form>
...
" />
        ...
        <tr>
            ...
            <td></td>
            <td><input type="submit" name="submit_all" value="Search" class="formbutton" onclick="submitbutton('submit_all')" /></td>
        </tr>
    </form>
    <?php endif; ?>
