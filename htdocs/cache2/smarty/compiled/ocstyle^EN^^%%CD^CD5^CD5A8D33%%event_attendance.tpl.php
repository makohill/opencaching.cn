...
<p>
    <div style="margin-top:4px;">
        ...
        by <?php echo ((is_array($_tmp=$this->_tpl_vars['owner'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</p>
    </div>
    <div style="margin-top:16px;">
        <p style="color: 5890a8"><b>Will attend</b></p>
...
<br />
    ...
    <div style="margin-top:16px;">
        <p style="color: 5890a8"><b>Attended</b></p>
