...
/images/misc/32x32-news.png" style="margin-right: 10px;" width="24" height="24" alt="" />
                        <a href="http://blog.opencaching.de/" style="color:rgb(88,144,168); text-decoration: none;">Nouvelles</a>
                        &nbsp; <span class="content-title-link">[<a href="http://blog.opencaching.de/">plus...</a>]</span>
                    </p>
                </td>
...
unset($_smarty_tpl_vars);
 ?>
<?php else: ?>
        <p><em>actuellement indisponible</em></p>
<?php endif; ?>
    </div>
    <div class="buffer" style="width: 500px;">&nbsp;</div>
<?php endif; ?>
...
/images/cacheicon/event.gif" style="margin-right: 10px;" width="24" height="24" alt="" />
        Les prochains événements dans <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

        <?php if ($this->_tpl_vars['total_events'] > count($this->_tpl_vars['events'])): ?>
            &nbsp; <span class="content-title-link">[<a href="newcaches.php?cachetype=6">plus...</a>]</span>
        <?php endif; ?>
    </p>
</div>
...
/images/misc/32x32-pictures.gif" style="margin-right: 10px;" width="24" height="24" />
        <a href="newlogpics.php" style="color:rgb(88,144,168); text-decoration: none;">Nouveaux log images</a>
    &nbsp; <span class="content-title-link">[<a href="newlogpics.php">plus...</a>]</span>
    </p>
</div>
...
/images/misc/32x32-winner.png" style="margin-right: 10px;" width="24" height="24" alt="" />
        <a href="tops.php" style="color:rgb(88,144,168); text-decoration: none;">Meilleures notes actuelles</a>
    </p>
</div>
<p style="line-height: 1.6em;">Géocaches avec les plus récommendations dans les derniers <?php echo $this->_tpl_vars['toprating_days']; ?>
 jours à <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
.</p>
...
" style="color: rgb(88, 144, 168); text-decoration: none;">Nouvelles topcis de forum (<?php echo ((is_array($_tmp=$this->_tpl_vars['phpbb_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)</a>
        </p>
    </div>
    <div id="forum">
...
" style="color:rgb(88,144,168); text-decoration: none;">Derniers caches en <?php echo ((is_array($_tmp=$this->_tpl_vars['usercountry'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>
    &nbsp; <span class="content-title-link">[<a href="newcaches.php">plus...</a>]</span>
    </p>
</div>
<p style="line-height: 1.6em;">(<?php echo $this->_tpl_vars['count_hiddens']; ?>
 caches actives et <?php echo $this->_tpl_vars['count_founds']; ?>
 trouvés par <?php echo $this->_tpl_vars['count_users']; ?>
 utilisateurs)</p>
<div class="content2-section-no-p">
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
