...
unset($_smarty_tpl_vars);
 ?>
                    ...
                    <td align="left" valign="top" width="99%">
                        ...
                        <span style="font-weight:400">&nbsp;door <?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span><br />
...
/images/description/22x22-location.png"  width="22" height="22" border="0" alt="" title="" align="left" />&nbsp;
                        ...
                        <table class="print-cachemeta" cellspacing="0" cellpadding="0">
                            <tr><td>Grootte:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['sizeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br /></td></tr>
                        <?php if ($this->_tpl_vars['cache']['searchtime'] > 0): ?>
                            <tr><td><nobr>Benodigde tijd:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['searchtime'])) ? $this->_run_mod_handler('format_hour', true, $_tmp) : smarty_modifier_format_hour($_tmp)); ?>
 ...
 km<?php endif; ?>
                        ...
                        <?php elseif ($this->_tpl_vars['cache']['waylength'] > 0): ?>
                            <tr><td><nobr>Lengte:</td><td><?php echo $this->_tpl_vars['cache']['waylength']; ?>
 km</nobr></td></tr>
                        <?php endif; ?>
                        <?php if ($this->_tpl_vars['cache']['status'] != 1): ?>
                            <tr><td>Status:</td><td><span class="errormsg"><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span></td></tr>
                        <?php else: ?>
                            <tr><td>Status:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['statusName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td></tr>
                        <?php endif; ?>
                        <tr><td>Verborgen op:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datehidden'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td><?php if ($this->_tpl_vars['cache']['is_publishdate'] == 0): ?>Listed since:<?php else: ?>Published on:<?php endif; ?></td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['datecreated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
                        <tr><td>Laatste verandering:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['cache']['lastmodified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['opt']['format']['datelong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['opt']['format']['datelong'])); ?>
</td></tr>
...
/images/log/16x16-dnf.png" width="16" height="16" border="0" /><?php if ($this->_tpl_vars['cache']['type'] == 6): ?> <?php echo $this->_tpl_vars['cache']['willattend']; ?>
 ...
 Niet gevonden<?php endif; ?></nobr><br />
                        <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FEFEFE;border:solid 1px black;">
                        <tr>
                            ...
                            <td style="text-align:left; vertical-align:top">
                                This geocache is probably placed within a nature reserve! Please see <?php echo $this->_tpl_vars['opt']['cms']['npa']; ?>
...
<?php if (! ($this->_foreach['npaareas']['iteration'] == $this->_foreach['npaareas']['total'])): ?>,<?php endif; ?>
    ...
    <?php if (count ( $this->_tpl_vars['npaareasNoWarning'] ) > 0): ?>
        <tr>
            <td>
                <font size="2">
                    This geocache is probably placed within the following protection areas:
