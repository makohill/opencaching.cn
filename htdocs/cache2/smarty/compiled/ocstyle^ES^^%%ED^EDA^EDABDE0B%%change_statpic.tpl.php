...
<form name="change" action="change_statpic.php" method="post" enctype="application/x-www-form-urlencoded" style="display: inline;">
    <table class="table">
        ...
        <tr>
            <td colspan="2">
                <b>Las siguientes configuraciones se almacenan para su logo:</b><br />
            </td>
        </tr>
        <tr><td class="spacer" colspan="2"></td></tr>

        <tr>
            <td>Texto visualizado:</td>
            <td>
...
" class="input200"/>
                <?php if ($this->_tpl_vars['statpic_text_error'] == 1): ?>
                    <span class="errormsg">
                        ¡El texto contiene caracteres no validos!
                    </span>
                <?php endif; ?>
            </td>
        </tr>
...
" align="middle"></td>
        ...
        <tr>
            <td colspan="3">
                <br />Después de guardar, es posible que tengas que pulsar el botón de recarga en tu navegador para ver la imagen seleccionada en tu perfil.
            </td>
        </tr>
    </table>
</form>