...
?>
 ...
 sek (<?php echo $this->_tpl_vars['user_count']; ?>
 Befehle)</td>
                </tr>
                <tr>
                    <td>Framework:</td>
 ...
 sek (<?php echo $this->_tpl_vars['framwork_count']; ?>
 Befehle)</td>
                </tr>
                <tr>
                    <td style="border-bottom:1px black solid">Businesslayer:</td>
 ...
 sek (<?php echo $this->_tpl_vars['businesslayer_count']; ?>
 Befehle)</td>
                </tr>
                <tr>
                    <td>Gesamt:</td>
 ...
 sek (<?php echo $this->_tpl_vars['total_count']; ?>
 Befehle)</td>
                </tr>
                <tr>
                    <td>Erstellt am:</td>
