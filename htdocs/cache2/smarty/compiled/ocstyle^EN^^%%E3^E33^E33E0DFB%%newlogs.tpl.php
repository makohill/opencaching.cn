...
<?php else: ?>
    ...
    <table cellspacing="0" cellpadding="0" style="width:98.1%">
        <tr>
            <td class="nav4">
                <ul>
                    <li class="group noicon <?php if ($this->_tpl_vars['countryCode'] === ''): ?>selected<?php endif; ?>"><a href="newlogs.php">All new logs</a></li>
...
">New logs in <?php echo $this->_tpl_vars['countryName']; ?>
</a>
                    <li class="group noicon <?php if ($this->_tpl_vars['rest']): ?>selected<?php endif; ?>"><a href="newlogsrest.php">New logs without <?php echo $this->_tpl_vars['mainCountryName']; ?>
</a></li>
                </ul>
            </td>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['newLog']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 ...
 found <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 2): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 didn't find <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 3): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 wrote a note for <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 7): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 visited <?php echo $this->_smarty_vars['capture']['cachename']; ?>

                <?php elseif ($this->_tpl_vars['newLog']['type'] == 8): ?>
                    <?php echo $this->_smarty_vars['capture']['username']; ?>
 wants to visit <?php echo $this->_smarty_vars['capture']['cachename']; ?>
