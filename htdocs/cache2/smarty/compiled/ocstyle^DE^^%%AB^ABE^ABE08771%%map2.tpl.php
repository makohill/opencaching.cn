...
<?php if ($this->_tpl_vars['old_msie']): ?>
    ...
    function mapLoad()
    {
        document.getElementById(\'googlemap\').innerHTML =
            "<div style=\'position:relative; top:180px; left:10px\'><p>Dein Internet Explorer ist zu alt, um die Karte darzustellen. Bitte installiere mindestens Version 7, besser Version 8.</p></div>";
    }
    -->'; ?>
...
var msSearchHint = "'; ?>
Ort, Cachename oder Wegpunkt<?php echo '";
...
function updateCopyrights()
{
    ...
    if (newMapType == "OSM" || newMapType == "MQ" || newMapType == "OCM")
    {
        ...
        if (newMapType == "OCM")
            copyrightDiv.innerHTML = 'Kartendaten &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a>- und <a href="http://www.thunderforest.com/opencyclemap/" target="_blank">OpenCycleMap</a>-Mitwirkende';
        else
            copyrightDiv.innerHTML = 'Kartendaten &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a>-Mitwirkende';
        if (newMapType == "MQ")
            copyrightDiv.innerHTML += ', ' + 'Kacheln bereitgestellt von <a href="http://www.mapquest.com/" target="_blank">MapQuest</a>' + ' <img src="http://developer.mapquest.com/content/osm/mq_logo.png" />';
        <?php echo '
    }
    else
...
function data_mapreceive(data, responseCode)
{
    ...
    if (responseCode != 200)
    {
        var sMessage = \'Fehler: Das Suchergebnis konnte nicht heruntergeladen werden (HTTP-Fehlercode %1)\';
...
function parseXML_GetHTML(xmlobject)
{
    ...
    sHtml += "<tr><td colspan='2' style='vertical-align:top;'>von <a href=" +apos+"viewprofile.php?userid="+encodeURI(nUserId)+apos+ " target='_blank'>" + xmlentities(sUsername) + "</a></td><td align='right'><a class='nooutline' href='articles.php?page=cacheinfo#difficulty' target='_blank'><img src=" + apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/diff-"+String(nDifficulty*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Schwierigkeit: " + String(nDifficulty) + " von 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /><img src=" +apos+"resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/difficulty/terr-"+String(nTerrain*10)+".gif"+apos + " border='0' width='19' height='16' hspace='2' onmouseover=" +apos+"Tip(\"Gel&auml;nde: " + String(nTerrain) + " von 5\", DELAY, 0, FADEIN, false, FADEOUT, false, BGCOLOR, \"#fffedf\", BORDERCOLOR, \"grey\")"+apos+ " onmouseout='UnTip()' /></a></td></tr>";
...
<img src='resource2/ocstyle/images/misc/is_oconly_small.png' alt='OConly' title='OConly' /></a>" : "") + "</td></tr>";
    sHtml += "<tr><td colspan='2'>" + (bIsPublishdate == true ? "Veröffentlicht am:" : "Gelistet seit:") + " " + xmlentities(sListedSince) + "</td></tr>";

    sAddHtml = "";
    if (bOwner==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/misc/16x16-home.png' alt='' /> Dies ist dein Cache</td></tr>";

    if (bFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-found.png' alt='' /> Du hast diesen Cache gefunden</td></tr>";

    if (bNotFound==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/16x16-dnf.png' alt='' /> Du hast diesen Cache nicht gefunden</td></tr>";

    if (bAttended==1)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/log/16x16-attended.png' alt='' /> Du hast dieses Event besucht!</td></tr>";

    if (nGeoKreties>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/gk.png' alt='' /> In diesem Cache ist ein GeoKrety</td></tr>";

    if (nTopRating>0)
        sAddHtml += "<tr><td colspan='3'><img src='resource2/ocstyle/images/viewcache/rating-star.gif' alt='' /> Dieser Cache hat %1 Empfehlung(en)</td></tr>".replace(/%1/, nTopRating);
    ...
    if (oWaypoints.length)
    {
        ...
        if (oWaypoints.length > 1)
            sMsg = "Der Cache hat %1 %2zusätzliche Wegpunkte%3.";
        else
            sMsg = "Der Cache hat einen %2zusätzlichen Wegpunkt%3.";
...
function tmd_show(number)
{
    ...
    var sMessage = \'Es sind %1 Geocaches auf dem Kartenausschnitt. Bitte vergrößere die Ansicht, um die Geocaches anzuzeigen.\';
...
function download_gpx()
{
    ...
    {
        alert('; ?>
"1-500 Caches müssen sichtbar sein, um den Download zu starten."<?php echo ');
        return;
    }
...
<?php if ($this->_tpl_vars['opt']['template']['locale'] == 'DE'): ?>
    ...
    moGeocoder.geocode( { \'address\': sSearchText },
        function(results, status)
        {
            ...
            {
                var oTempOption = new Option("Gefundene Orte (Google):", -1);
            ...
            ajaxLoad(msURLMapPHP + "?mode=" + searchpar,
                function(data, responseCode) {
                    ...
                    if (caches.length>0)
                    {
                        var oTempOption = new Option("Gefundene Caches, geordnet nach Entfernung:", -1);
                        oTempOption.style.color = "gray";
                        moSearchList.options[moSearchList.length] = oTempOption;
                        ...
                        {
                            var item = new Option("     '; ?>
Weitere Einträge gefunden...<?php echo '", -1);
                            item.style.marginLeft = "20px";
                    ...
                    if (moSearchList.length==0)
                    {
                        mapselectlist_hide();
                        alert("\'" + sSearchText + "\' '; ?>
wurde (mit den gewählten Einstellungen) nicht gefunden<?php echo '");
                        return;
                    }
...
function filter_changed()
{
    if (!bFilterChanged)
    {
        ...
        if (heading.style.color != "#f88c00")
        {
            ...
            heading.innerHTML = "'; ?>
Karte wird aktualisiert<?php echo ' ...";
...
function save_filter()
{
    ...
    alert("Die aktuellen Filtereinstellungen wurden dauerhaft gespeichert.");
    <?php echo '
}
...
').style.display = sShow;
    ...
    tas.innerHTML = (bShow ? "weniger" : "alle anzeigen");
    if (bFullscreen)
...
<div id="<?php if ($this->_tpl_vars['bFullscreen']): ?>fullmap<?php else: ?>smallmap<?php endif; ?>" class="mapframe">
    ...
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
            ...
            <div id="mapstat_caches" class="mapstat_fullscreen" style="z-index:5">angezeigte Geocaches: <span id="statCachesCount">0</span><span id="statLoadTime" style="display:none">0</span></div>
...
/images/misc/hint.gif" border="0" width="15" height="11" align="middle" />
                Die Kartendarstellung mit dem Microsoft Internet Explorer ist relativ langsam und auf <?php echo $this->_tpl_vars['maxrecords']; ?>
 Geocaches beschränkt.<br />Verwende einen anderen Browser, um die Karte voll nutzen zu können!
            </p>
        <?php endif; ?>
    <?php endif; ?>
            ...
            <tr>
                <?php if ($this->_tpl_vars['bFullscreen']): ?>
                    ...
                    <td rowspan="2" class="maplogin">
                        <?php if ($this->_tpl_vars['username'] != ""): ?>Eingeloggt als<br /><a href="myhome.php"><b><?php echo $this->_tpl_vars['username']; ?>
...
<?php endif; ?>"><img src="resource2/ocstyle/images/action/15x13-logout.png" style="margin-bottom:2px" alt="Abmelden" title="Abmelden" /></a><?php else: ?><a href="login.php?target=map2.php%3Fmode%3Dfullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>%26queryid%3D<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>">Anmelden...</a><?php endif; ?>
                    </td>
                    <td rowspan="2">&nbsp;&nbsp;</td>
                <?php endif; ?>
...
/images/misc/32x32-home.png" alt="zu den den Heimatkoordinaten springen" title="zu den den Heimatkoordinaten springen" /></a></td>
                <?php endif; ?>
...
/images/map/35x35-gpx-download.png" style="margin-left:5px; margin-right:5px" height="35" width="35" alt="Download GPX-Datei (max. 500 Caches)" title="Download GPX-Datei (max. 500 Caches)" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="showPermlinkBox_click()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-star.png" style="margin-left:3px; margin-right:1px" height="35" width="35" alt="Link zu dieser Ansicht anzeigen" title="Link zu dieser Ansicht anzeigen" /></a></td>

                                <td rowspan="2"><a class="jslink" onclick="toggle_settings()"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-configure.png" class="mapbutton" style="margin-left:0px; margin-right:2px" height="35" width="35" alt="Einstellungen" title="Einstellungen" /></a></td>

                                <?php if ($this->_tpl_vars['help_map'] != ""): ?>
                    <td rowspan="2"><?php echo $this->_tpl_vars['help_map']; ?>
<img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/32x32-help.png" class="mapbutton" style="margin-left:2px; margin-right:4px" height="32" width="32" alt="Anleitung" title="Anleitung" /></a></td>
                <?php endif; ?>
...
/images/map/35x35-normalscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="zurück zur kleinen Kartenansicht" title="zurück zur kleinen Kartenansicht" /></a>
                    <?php else: ?>
                        <a class="nooutline" href="map2.php?mode=fullscreen<?php if ($this->_tpl_vars['queryid'] > 0): ?>&queryid=<?php echo $this->_tpl_vars['queryid']; ?>
<?php endif; ?>"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/map/35x35-fullscreen.png" align="right" style="margin-left:4px; margin-right:4px" height="35" width="35" alt="Vollbild anzeigen" title="Vollbild anzeigen" /></a>
                    <?php endif; ?>
                </td>
        ...
        <table>
            <tr><td><img src="resource2/ocstyle/images/viewcache/link.png" alt="" height="16" width="16" /> Link für diese Kartenansicht:</td><td align="right"><a href="javascript:permalinkbox_hide()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></td></tr>
            <tr><td><input id="permalink_text" type="text" value="" size="55"/></td></tr>
            <tr id="permalink_addFavorites"><td align="right"><input type="button" value="Zu den Favoriten hinzufügen..." onclick="addFavorites_click()" /></td></tr>
        </table>
    </div>
    <?php if ($this->_tpl_vars['bFullscreen']): ?>
        </div></div>            <?php endif; ?>
    ...
    <?php endif; ?>
            ...
            <div class="maploading">Karte wird geladen ...</div>
...
<?php endif; ?>" method="post" style="display:inline;">
                    ...
                    <table>
                        <tr><td><span style="font-size:1.2em; font-weight:bold">Einstellungen</strong></td><td style="text-align:right"><a href="javascript:toggle_settings()"><img src="resource2/ocstyle/images/navigation/19x19-close.png" style="opacity:0.7" /></a></tr>
                        <tr><td>Menüpunkt 'Karte' zeigt:</td><td><select name="opt_menumap"><option id="opt_menumap0" value="0">kleine Karte</option><option id="opt_menumap1" value="1">Vollbildkarte</option></select></td></tr>
                        <tr><td>Übersichtskarte anzeigen:</td><td><input type="checkbox" id="opt_overview" name="opt_overview" value="1" /></td></tr>
                        <tr><td>max. Caches auf der Karte<br />(<?php echo $this->_tpl_vars['min_maxrecords']; ?>
-<?php echo $this->_tpl_vars['max_maxrecords']; ?>
, 0=automatisch):</td><td><input type="text" id="opt_maxcaches" name="opt_maxcaches" size="6" /></td></tr>
                        <?php if ($this->_tpl_vars['msie']): ?>
                            <tr><td colspan="2" style="padding-top:0; white-space:normal">
                                <img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/misc/hint.gif" alt="" />
                                <small>Mit dem Microsoft Internet Explorer werden<br />maximal <?php echo $this->_tpl_vars['maxrecords']; ?>
 Caches angezeigt.
                            </td></tr>
                        <?php endif; ?>
                        <tr><td>Cachesymbole:</td><td><select name="opt_cacheicons"><option id="opt_cacheicons1" value="1">OC klassisch<option id="opt_cacheicons2" value="2">OKAPI-Stil</option></select></td></tr>
                        <tr><td><?php echo $this->_tpl_vars['help_previewpics']; ?>
Vorschaubilder</a> anzeigen<br />(% der Kartenfläche, 0=aus):</td><td><input type="text" id="opt_pictures" name="opt_pictures" size="2" maxlength="2" /></td></tr>
                        <tr><td colspan="2"><?php if ($this->_tpl_vars['login']['userid'] > 0): ?><input type="button" class="formbutton" value="Abbrechen" onclick="toggle_settings()"/>&nbsp; <input type="submit" name="submitsettings" class="formbutton" value="OK" onclick="submitbutton('submitsettings')" /><?php else: ?><em>Du musst eingeloggt sein, um die Einstellungen zu ändern.</em><?php endif; ?></td></tr>
                    </table>
                </form>
            </div>
...
/images/misc/32x32-search.png" style="padding:2px" alt="Suchoptionen" title="Suchoptionen" /></a>
            </div>
        <?php endif; ?>
...
/images/map/32x32-left.png" /></a>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td id="filterboxtitle" class="content-title-noshade-size1">Nur Geocaches mit folgenden Eigenschaften anzeigen:</td>
    ...
    <?php else: ?>
        ...
        <div style="width:770px;text-align:right;"><span id="mapstat_caches">angezeigte Geocaches: <span id="statCachesCount">0</span></span>, Ladezeit: <span id="statLoadTime">0</span> Sek.</div>
        <div style="<?php if ($this->_tpl_vars['queryid'] > 0): ?>display:none<?php endif; ?>">
        <p id="filterboxtitle" class="content-title-noshade-size1">Nur Geocaches mit folgenden Eigenschaften anzeigen:</p>
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td style="text-align:right">
                            <input type="button" name="resetfilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Zurücksetzen&nbsp;&nbsp;" onclick="reset_filter()" />&nbsp;
                            <input type="button" name="savefilter" class="formbutton" style="width:auto" value="&nbsp;&nbsp;Speichern&nbsp;&nbsp;" onclick="save_filter()" />&nbsp;
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table>
        <tr>
                ...
                <table>
                    <tr><td colspan="3" class="mapfiltertopic mft_withcheckbox"><input id="all_cachetypes" type="checkbox" checked="checked" onchange="alltypes_changed()" /> <label for="all_cachetypes">Cacheart</label></td></tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheTypeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic mft_withcheckbox"><input id="all_cachesizes" type="checkbox" checked="checked" onchange="allsizes_changed()" /> <label for="all_cachesizes">Behälter</label></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <?php $_from = $this->_tpl_vars['aCacheSize']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cacheSizeItem']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <table>
                    <tr><td class="mapfiltertopic">Ausblenden</td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userowner" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>meine eigenen</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                            ...
                            <label for="f_userfound" <?php if ($this->_tpl_vars['username'] == ""): ?>style="color:grey"<?php endif; ?>>gefundene</label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap">
                ...
                <table>
                    <tr>
                        <td colspan="2" class="mapfiltertopic">Bewertung</td>
                    <tr><td colspan="2"><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    </tr>
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Schwierigkeit:</td>
                    ...
                    <tr>
                        <td <?php if ($this->_tpl_vars['bFullscreen']): ?>colspan="2"<?php endif; ?>>Gel&auml;nde:</td>
                            <?php if ($this->_tpl_vars['bFullscreen']): ?></tr><tr><td colspan="2" style="white-space:nowrap; text-align:right"><?php else: ?><td><?php endif; ?>
        ...
        <tr>
            <td id="attribcell" valign="top" class="mapfilter pad10" style="padding-bottom:2px" width="<?php if ($this->_tpl_vars['bFullscreen']): ?>675<?php else: ?>752<?php endif; ?>">
                <table>
                    <tr><td class="mapfiltertopic">Attribute &nbsp; <span class="mapfiltertopic_add">[<a id="toggle_attribselection" class="jslink" onclick='toggle_attribselection(true)'>weniger</a>]</span></td></tr>
                    <tr><td><span style="line-height: 5px;">&nbsp;</span></td></tr>
                    <tr>
                        <td>
...
/images/attributes/safari.png" title="Safari-Cache-Liste" /></a>
        </div>
    <?php endif; ?>
