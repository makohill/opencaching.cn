...
<form action="change_statpic.php">
    ...
    <table class="table">
        ...
        <tr>
            <td style="vertical-align:top;">Image de la statistique&nbsp;:</td>
...
.jpg" align="middle" /></td>
        ...
        <tr>
            <td style="vertical-align:top;">HTML-Code&nbsp;:</td>
...
/<?php echo $this->_tpl_vars['login']['userid']; ?>
.jpg" alt="<?php echo $this->_tpl_vars['opt']['page']['sitename']; ?>
-statstic de <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['login']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" title="<?php echo $this->_tpl_vars['opt']['page']['sitename']; ?>
-statstic de <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['login']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /&gt;</td>
        </tr>
        <tr><td class="spacer" colspan="2"></td></tr>
        ...
        <tr>
            <td style="vertical-align:top;">BBCode pour webforums&nbsp;:</td>
...
.jpg[/img][/url]</td>
        ...
        <tr>
            <td class="header-small" colspan="3">
                <input type="submit" name="change" value="Changement" class="formbutton" onclick="submitbutton('change')" />
            </td>
        </tr>
    </table>
