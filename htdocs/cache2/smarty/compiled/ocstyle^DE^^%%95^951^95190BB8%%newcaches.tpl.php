...
<div class="nav4">
    <ul>
        <li class="group noicon <?php if ($this->_tpl_vars['countryCode'] == ''): ?>selected<?php endif; ?>"><a href="newcaches.php">Alle Caches</a></li>
...
">Neue Caches ohne <?php echo $this->_tpl_vars['mainCountryName']; ?>
</a></li>
    </ul>
</div>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?> von <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['newCache']['userid']; ?>
