...
" />
  ...
  <table class="table">
    <tr valign="top">
      ...
      <td>
        <input type="checkbox" class="checkbox" name="incl_coord" value="true" <?php if ($this->_tpl_vars['inclCoord']): ?>checked="checked"<?php endif; ?>/> Coordonnées&nbsp;<br />
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr>
      <td></td>
      <td colspan="2">
        <input type="submit" name="submit_cache_note" value="Sauvegarder" class="formbutton" onclick="submitbutton('submit_cache_note')" />
      </td>
    </tr>
    <tr>
      <td colspan="3">
...
/images/viewcache/16x16-info.png" class="icon16" alt="Info" />
        <small style="line-height:1em">
          La note n'est pas visible aux autres utilisateurs. La note et les coordonnées facultatives seront inclus dans les téléchargements de fichiers GPX-et envoyés à l'appareil GPS.
        </small>
      </td>
    </tr>
  </table>