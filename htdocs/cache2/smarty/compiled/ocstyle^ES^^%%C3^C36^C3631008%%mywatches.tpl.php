...
/images/misc/32x32-watched.png" style="margin-right: 10px;" width="32" height="32" alt="" />
            Geocache observado - configuración
        </div>
            ...
            <tr>
                ...
                <td>
                    <select id="interval" name="interval" onchange="intervalChanged();">
                        <option value="0" <?php if ($this->_tpl_vars['interval'] == 0): ?>selected="selected"<?php endif; ?>>Inmediato</option>
                        <option value="1" <?php if ($this->_tpl_vars['interval'] == 1): ?>selected="selected"<?php endif; ?>>Diario</option>
                        <option value="2" <?php if ($this->_tpl_vars['interval'] == 2): ?>selected="selected"<?php endif; ?>>Semanal</option>
                    </select>
                </td>
            </tr>
...
/images/misc/hint.gif" border="0" width="15" height="11" /> tiempo de envío y de día sólo se utilizará para la entrega diaria o semanal.</td>
            </tr>
            <tr><td class="spacer" colspan="2"></td></tr>
            <?php if ($this->_tpl_vars['error'] == true): ?>
                <tr><td colspan="2" class="errormsg">¡Error al guardar!</td></tr>
            <?php elseif ($this->_tpl_vars['saved'] == true): ?>
                <tr><td colspan="2" class="okmsg">Los ajustes se han guardado.</td></tr>
            <?php endif; ?>
            <tr><td class="spacer" colspan="2"></td></tr>
            ...
            <tr>
                <td class="header-small" colspan="2">
                    ...
                    <input type="submit" name="ok" value="Guardar" class="formbutton" onclick="submitbutton('ok')" />
                </td>
            </tr>
        </table>
    </form>
            ...
            <td colspan="2">
                <table class="table">
                    <tr class="cachelistheader">
                        ...
                        <th width="100px"><nobr>Últimos encontrados</nobr></th>
                        <th></th>
                    </tr>
...
" style="text-align:center">
                            ...
                            <td class="<?php echo $this->_tpl_vars['listcolor']; ?>
"><nobr>[<a href="javascript:if(confirm('¿Estás seguro que quieres eliminar esta entrada?'))location.href='mywatches.php?action=remove&cacheid=<?php echo $this->_tpl_vars['watchItem']['cacheid']; ?>
&target=mywatches.php'">do not watch</a>]</nobr></td>
                        </tr>
                    <?php endforeach; else: ?>
                        <tr><td colspan="5"><br />Geocaches no observados</td></tr>
