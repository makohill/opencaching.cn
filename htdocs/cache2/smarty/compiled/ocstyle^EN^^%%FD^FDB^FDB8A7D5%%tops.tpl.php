...
<?php endif; ?>"></a>
        ...
        <table class="table">
            <tr>
                ...
                <td style="text-align:right"><img src="images/rating-star.gif" border="0" alt="Recommendations" /></td>
                <td style="text-align:right"><img src="resource2/<?php echo $this->_tpl_vars['opt']['template']['style']; ?>
/images/log/16x16-found.png" width="16" height="16" border="0" alt="Found" /></td>
                <td></td>
                <td>&nbsp;</td>
            </tr>
    <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?> by <a href="viewprofile.php?userid=<?php echo $this->_tpl_vars['topItem']['userid']; ?>
